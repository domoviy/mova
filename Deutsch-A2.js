...
var AUDIO_CONFIG = {
  "de": ["095","080"], //аудіо генерується зі швидкістю 95% і 80%.  "de": ["095","080"],
//  "en": ["100"],
  "uk": ["100"]
//  "ru": ["100"]
};
...
var GRAMMAR = [
  {
    ...
    "explanation": {
      "de": "Das Perfekt nutzen wir für Aktionen in der Vergangenheit. Es besteht aus <g>haben</g> oder <g>sein</g> an Position 2 und dem <g>Partizip II</g> am Ende des Satzes.<br>Beispiel: Ich <g>habe</g> Deutsch <g>gelernt</g>. Er <g>ist</g> nach Berlin <g>geflogen</g>.",
    ...
    "rule": {
      ...
      "en": "<b>Formation:</b> <g>haben</g> or <g>sein</g> in position 2 + <g>Partizip II</g> (past participle) at the end of the sentence.<br><br><table><tr><th>ich</th><td>habe / bin</td></tr><tr><th>du</th><td>hast / bist</td></tr><tr><th>er/sie/es</th><td>hat / ist</td></tr><tr><th>wir</th><td>haben / sind</td></tr><tr><th>ihr</th><td>habt / seid</td></tr><tr><th>sie/Sie</th><td>haben / sind</td></tr></table><br><b>Forming the Partizip II:</b><br>• regular verbs: ge + stem + t → machen → <g>gemacht</g><br>• irregular verbs: ge + stem + en (often with a vowel change) → fahren → <g>gefahren</g><br>• verbs ending in -ieren: no ge- → studieren → <g>studiert</g><br>• separable verbs: prefix + ge + stem → einkaufen → <g>eingekauft</g><br>• inseparable verbs (be-, ge-, er-, ver-, zer-, ent-, emp-, miss-): no ge- → verstehen → <g>verstanden</g><br><br><b>sein or haben?</b><br><g>sein</g>: motion (gehen, fahren, fliegen), change of state (aufwachen, sterben) + the verbs <g>sein, werden, bleiben</g>.<br><g>haben</g>: all other verbs, all reflexive verbs, and all verbs with an accusative object.<br><br><b>Examples:</b><br>Ich <g>habe</g> einen Brief <g>geschrieben</g>. (I have written a letter.)<br>Er <g>ist</g> nach Hause <g>gegangen</g>. (He has gone home.)",
      ...
      "ru": "<b>Образование:</b> вспомогательный глагол <g>haben</g> или <g>sein</g> на 2-й позиции + <g>Partizip II</g> (причастие прошедшего времени) в самом конце предложения.<br><br><table><tr><th>ich</th><td>habe / bin</td></tr><tr><th>du</th><td>hast / bist</td></tr><tr><th>er/sie/es</th><td>hat / ist</td></tr><tr><th>wir</th><td>haben / sind</td></tr><tr><th>ihr</th><td>habt / seid</td></tr><tr><th>sie/Sie</th><td>haben / sind</td></tr></table><br><b>Образование Partizip II:</b><br>• правильные глаголы: ge + основа + t → machen → <g>gemacht</g><br>• неправильные глаголы: ge + основа + en (часто с изменением гласной) → fahren → <g>gefahren</g><br>• глаголы на -ieren: без ge- → studieren → <g>studiert</g><br>• отделяемые глаголы: приставка + ge + основа → einkaufen → <g>eingekauft</g><br>• неотделяемые глаголы (be-, ge-, er-, ver-, zer-, ent-, emp-, miss-): без ge- → verstehen → <g>verstanden</g><br><br><b>sein или haben?</b><br><g>sein</g>: движение (gehen, fahren, fliegen), изменение состояния (aufwachen, sterben) + глаголы <g>sein, werden, bleiben</g>.<br><g>haben</g>: все остальные глаголы, все возвратные глаголы и глаголы с винительным дополнением.<br><br><b>Примеры:</b><br>Ich <g>habe</g> einen Brief <g>geschrieben</g>. (Я написал письмо.)<br>Er <g>ist</g> nach Hause <g>gegangen</g>. (Он пошёл домой.)"
    }
  },
  {
    "id": "praeteritum",
    ...
    "rule": {
      ...
      "en": "<b>Formation of regular verbs:</b> stem + <g>-te</g> + ending.<br><br><table><tr><th>ich</th><td>machte</td></tr><tr><th>du</th><td>machtest</td></tr><tr><th>er/sie/es</th><td>machte</td></tr><tr><th>wir</th><td>machten</td></tr><tr><th>ihr</th><td>machtet</td></tr><tr><th>sie/Sie</th><td>machten</td></tr></table><br><b>Irregular verbs</b> change their stem vowel (Ablaut) and often have their own forms, e.g. fahren → fuhr, gehen → ging — these must be learned individually.<br><br><b>Important for A2:</b> In everyday speech, the <g>Perfekt</g> is usually used. But <g>sein</g>, <g>haben</g> and modal verbs are almost always used in the Präteritum.<br><br><table><tr><th></th><th>sein</th><th>haben</th></tr><tr><td>ich</td><td>war</td><td>hatte</td></tr><tr><td>du</td><td>warst</td><td>hattest</td></tr><tr><td>er/sie/es</td><td>war</td><td>hatte</td></tr><tr><td>wir</td><td>waren</td><td>hatten</td></tr><tr><td>ihr</td><td>wart</td><td>hattet</td></tr><tr><td>sie/Sie</td><td>waren</td><td>hatten</td></tr></table><br><b>Example:</b> Letztes Jahr <g>war</g> ich in Deutschland und <g>hatte</g> viel Zeit. (Last year I was in Germany and had a lot of time.)",
      ...
      "ru": "<b>Образование правильных глаголов:</b> основа + суффикс <g>-te</g> + окончание.<br><br><table><tr><th>ich</th><td>machte</td></tr><tr><th>du</th><td>machtest</td></tr><tr><th>er/sie/es</th><td>machte</td></tr><tr><th>wir</th><td>machten</td></tr><tr><th>ihr</th><td>machtet</td></tr><tr><th>sie/Sie</th><td>machten</td></tr></table><br><b>Неправильные глаголы</b> меняют корневой гласный (аблаут) и часто имеют собственные формы, например fahren → fuhr, gehen → ging — эти формы нужно учить отдельно.<br><br><b>Важно для уровня A2:</b> в повседневной речи чаще используется <g>Perfekt</g>. Но глаголы <g>sein</g>, <g>haben</g> и модальные глаголы почти всегда употребляются в <g>Präteritum</g>.<br><br><table><tr><th></th><th>sein</th><th>haben</th></tr><tr><td>ich</td><td>war</td><td>hatte</td></tr><tr><td>du</td><td>warst</td><td>hattest</td></tr><tr><td>er/sie/es</td><td>war</td><td>hatte</td></tr><tr><td>wir</td><td>waren</td><td>hatten</td></tr><tr><td>ihr</td><td>wart</td><td>hattet</td></tr><tr><td>sie/Sie</td><td>waren</td><td>hatten</td></tr></table><br><b>Пример:</b> Letztes Jahr <g>war</g> ich in Deutschland und <g>hatte</g> viel Zeit. (В прошлом году я был в Германии, и у меня было много времени.)"
    }
  },
  {
    "id": "modalverben",
    ...
    "rule": {
      ...
      "en": "<b>Position:</b> the modal verb is in position 2 and is conjugated. The second (main) verb is in the <g>Infinitiv</g> right at the end of the sentence.<br><br><table><tr><th>Person</th><th>können</th></tr><tr><td>ich</td><td>kann</td></tr><tr><td>du</td><td>kannst</td></tr><tr><td>er/sie/es</td><td>kann</td></tr><tr><td>wir</td><td>können</td></tr><tr><td>ihr</td><td>könnt</td></tr><tr><td>sie/Sie</td><td>können</td></tr></table><br><b>Conjugated the same way:</b><br>• müssen → muss, musst, muss, müssen, müsst, müssen<br>• wollen → will, willst, will, wollen, wollt, wollen<br>• dürfen → darf, darfst, darf, dürfen, dürft, dürfen<br>• sollen → soll, sollst, soll, sollen, sollt, sollen<br>• mögen → mag, magst, mag, mögen, mögt, mögen<br><br><b>Note:</b> for all modal verbs (except sollen), the forms for <g>ich</g> and <g>er/sie/es</g> are identical, and the stem vowel often changes in the singular.<br><br><b>Example:</b> Ich <g>kann</g> gut <g>schwimmen</g>. (I can swim well.) Wir <g>müssen</g> jetzt <g>gehen</g>. (We have to go now.)",
      ...
      "ru": "<b>Позиция:</b> модальный глагол стоит на 2-й позиции и изменяется по лицам. Второй (основной) глагол стоит в форме <g>Infinitiv</g> в самом конце предложения.<br><br><table><tr><th>Лицо</th><th>können</th></tr><tr><td>ich</td><td>kann</td></tr><tr><td>du</td><td>kannst</td></tr><tr><td>er/sie/es</td><td>kann</td></tr><tr><td>wir</td><td>können</td></tr><tr><td>ihr</td><td>könnt</td></tr><tr><td>sie/Sie</td><td>können</td></tr></table><br><b>Так же спрягаются:</b><br>• müssen → muss, musst, muss, müssen, müsst, müssen<br>• wollen → will, willst, will, wollen, wollt, wollen<br>• dürfen → darf, darfst, darf, dürfen, dürft, dürfen<br>• sollen → soll, sollst, soll, sollen, sollt, sollen<br>• mögen → mag, magst, mag, mögen, mögt, mögen<br><br><b>Внимание:</b> у всех модальных глаголов (кроме sollen) формы для <g>ich</g> и <g>er/sie/es</g> совпадают, а корневой гласный часто меняется в единственном числе.<br><br><b>Пример:</b> Ich <g>kann</g> gut <g>schwimmen</g>. (Я умею хорошо плавать.) Wir <g>müssen</g> jetzt <g>gehen</g>. (Нам нужно сейчас идти.)"
    }
  },
  {
    ...
    "rule": {
      ...
      "en": "<b>Formation:</b> in the Präteritum, modal verbs lose their umlaut (ä, ö, ü → a, o, u) and take the ending <g>-te</g>, like regular verbs.<br><br><table><tr><th>Infinitiv</th><th>Präteritum (ich)</th></tr><tr><td>können</td><td>konnte</td></tr><tr><td>müssen</td><td>musste</td></tr><tr><td>wollen</td><td>wollte</td></tr><tr><td>dürfen</td><td>durfte</td></tr><tr><td>sollen</td><td>sollte</td></tr><tr><td>mögen</td><td>mochte</td></tr></table><br><b>Other persons (example können):</b> du konntest, er/sie/es konnte, wir konnten, ihr konntet, sie/Sie konnten.<br><br><b>Example:</b> Als Kind <g>konnte</g> ich nicht schwimmen. (As a child I couldn't swim.) Ich <g>musste</g> jeden Tag früh aufstehen. (I had to get up early every day.)",
      ...
      "ru": "<b>Образование:</b> в <g>Präteritum</g> модальные глаголы теряют умлаут (ä, ö, ü → a, o, u) и получают окончание <g>-te</g>, как и правильные глаголы.<br><br><table><tr><th>Infinitiv</th><th>Präteritum (ich)</th></tr><tr><td>können</td><td>konnte</td></tr><tr><td>müssen</td><td>musste</td></tr><tr><td>wollen</td><td>wollte</td></tr><tr><td>dürfen</td><td>durfte</td></tr><tr><td>sollen</td><td>sollte</td></tr><tr><td>mögen</td><td>mochte</td></tr></table><br><b>Остальные лица (пример können):</b> du konntest, er/sie/es konnte, wir konnten, ihr konntet, sie/Sie konnten.<br><br><b>Пример:</b> Als Kind <g>konnte</g> ich nicht schwimmen. (В детстве я не умел плавать.) Ich <g>musste</g> jeden Tag früh aufstehen. (Мне приходилось каждый день рано вставать.)"
    }
  },
  {
    "id": "weil_satz",
    ...
    "rule": {
      ...
      "en": "<b>Word order:</b> main clause, + <g>weil</g> + subject + (further details) + ... + verb (conjugated, right at the end).<br><br><table><tr><th>Position</th><th>weil</th><th>Subject</th><th>Details</th><th>Verb</th></tr><tr><td>Example</td><td>weil</td><td>ich</td><td>in Deutschland</td><td>lebe</td></tr></table><br><b>Note:</b> with two verbs (e.g. modal verb + infinitive or Perfekt), both verbs go together at the end of the sentence, with the conjugated verb absolutely last.<br><br><b>Examples:</b><br>Ich lerne Deutsch, <g>weil</g> ich in Deutschland leben <g>möchte</g>. (I'm learning German because I want to live in Germany.)<br>Sie ist müde, <g>weil</g> sie viel <g>gearbeitet hat</g>. (She's tired because she worked a lot.)",
      ...
      "ru": "<b>Порядок слов:</b> главное предложение, + <g>weil</g> + подлежащее + (остальные члены) + ... + глагол (изменяемый, в самом конце).<br><br><table><tr><th>Позиция</th><th>weil</th><th>Подлежащее</th><th>Остальное</th><th>Глагол</th></tr><tr><td>Пример</td><td>weil</td><td>ich</td><td>in Deutschland</td><td>lebe</td></tr></table><br><b>Внимание:</b> если в предложении два глагола (напр., модальный глагол + инфинитив, или Perfekt), оба уходят в конец вместе, а изменяемый глагол — самым последним.<br><br><b>Примеры:</b><br>Ich lerne Deutsch, <g>weil</g> ich in Deutschland leben <g>möchte</g>. (Я учу немецкий, потому что хочу жить в Германии.)<br>Sie ist müde, <g>weil</g> sie viel <g>gearbeitet hat</g>. (Она устала, потому что много работала.)"
    }
  },
  {
    "id": "dass_satz",
    ...
    "rule": {
      ...
      "en": "<b>Word order:</b> exactly like <g>weil</g> — after <g>dass</g>, the conjugated verb goes right to the end of the subordinate clause.<br><br><b>Use:</b> <g>dass</g> connects a main clause with a subordinate clause after verbs of thinking, saying, or feeling.<br><br><table><tr><th>Verbs with dass</th></tr><tr><td>glauben, denken, meinen (believe, think)</td></tr><tr><td>sagen, erzählen, antworten (say, tell, answer)</td></tr><tr><td>wissen, finden, hoffen (know, find, hope)</td></tr><tr><td>froh sein, sicher sein (be glad, be sure)</td></tr></table><br><b>Examples:</b><br>Ich weiß, <g>dass</g> du recht <g>hast</g>. (I know that you're right.)<br>Er sagt, <g>dass</g> er morgen <g>kommt</g>. (He says that he's coming tomorrow.)",
      ...
      "ru": "<b>Порядок слов:</b> так же, как и с <g>weil</g> — после <g>dass</g> изменяемый глагол стоит в самом конце придаточного предложения.<br><br><b>Употребление:</b> союз <g>dass</g> соединяет главное предложение с придаточным после глаголов мысли, речи или чувства.<br><br><table><tr><th>Глаголы с dass</th></tr><tr><td>glauben, denken, meinen (полагать, думать)</td></tr><tr><td>sagen, erzählen, antworten (говорить, рассказывать, отвечать)</td></tr><tr><td>wissen, finden, hoffen (знать, считать, надеяться)</td></tr><tr><td>froh sein, sicher sein (радоваться, быть уверенным)</td></tr></table><br><b>Примеры:</b><br>Ich weiß, <g>dass</g> du recht <g>hast</g>. (Я знаю, что ты прав.)<br>Er sagt, <g>dass</g> er morgen <g>kommt</g>. (Он говорит, что придёт завтра.)"
    }
  },
  {
    "id": "wenn_satz",
    ...
    "explanation": {
      "de": "Wir benutzen <g>wenn</g> für Bedingungen (Wenn...) oder für wiederholte Aktionen in der Gegenwart/Vergangenheit. Das Verb steht am Ende.<br>Beispiel: <g>Wenn</g> es regnet, <g>bleibe</g> ich zu Hause.",
    ...
    "rule": {
      ...
      "en": "<b>Word order:</b> <g>wenn</g> + subject + ... + verb (end). The main clause afterward often begins directly with the verb (the subordinate clause occupies position 1).<br><br><b>Two meanings:</b><br>1) <b>Condition</b> (If... then): <g>Wenn</g> es regnet, <g>bleibe</g> ich zu Hause. (If it rains, I stay home.)<br>2) <b>Repetition</b> in the present/past (= every time): <g>Wenn</g> ich Zeit <g>habe</g>, lese ich. (Whenever I have time, I read.)<br><br><table><tr><th>Subordinate clause</th><th>Main clause</th></tr><tr><td>Wenn es regnet,</td><td>bleibe ich zu Hause.</td></tr></table><br><b>Note:</b> right after the comma comes the verb (verb-subject inversion), because the subordinate clause takes up position 1 in the main clause.",
      ...
      "ru": "<b>Порядок слов:</b> <g>wenn</g> + подлежащее + ... + глагол (в конце). Главное предложение после запятой часто начинается сразу с глагола (придаточное занимает первую позицию).<br><br><b>Два значения:</b><br>1) <b>Условие</b> (Если... то): <g>Wenn</g> es regnet, <g>bleibe</g> ich zu Hause. (Если идёт дождь, я остаюсь дома.)<br>2) <b>Повторяющееся действие</b> в настоящем/прошлом (= каждый раз, когда): <g>Wenn</g> ich Zeit <g>habe</g>, lese ich. (Когда у меня есть время, я читаю.)<br><br><table><tr><th>Придаточное предложение</th><th>Главное предложение</th></tr><tr><td>Wenn es regnet,</td><td>bleibe ich zu Hause.</td></tr></table><br><b>Внимание:</b> сразу после запятой идёт глагол (инверсия глагол-подлежащее), потому что придаточное занимает первую позицию в главном предложении."
    }
  },
  {
    ...
    "rule": {
      ...
      "en": "<b>als vs. wenn (past tense):</b><br><table><tr><th>als</th><td>a single event in the past</td></tr><tr><th>wenn</th><td>a repeated event in the past (= every time)</td></tr></table><br><b>Examples:</b><br><g>Als</g> ich 18 war, habe ich meinen Führerschein gemacht. (once — When I was 18, I got my driver's license.)<br><g>Wenn</g> ich früher Ferien hatte, bin ich immer zu meiner Oma gefahren. (several times — Whenever I had vacation, I always went to my grandma's.)<br><br><b>schon vs. erst:</b><br><table><tr><th>schon</th><td>earlier / more than expected (already)</td></tr><tr><th>erst</th><td>later / less than expected, not quite yet (only, just)</td></tr></table><br><b>Examples:</b><br>Es ist <g>schon</g> 20 Uhr! (It's already 8pm! — that's late)<br>Es ist <g>erst</g> 8 Uhr. (It's only 8am. — that's early)<br>Ich war <g>schon</g> dreimal in Berlin. (I've already been to Berlin three times.) / Ich war <g>erst</g> einmal in Berlin. (I've only been to Berlin once.)",
      ...
      "ru": "<b>als или wenn (прошедшее время):</b><br><table><tr><th>als</th><td>однократное событие в прошлом</td></tr><tr><th>wenn</th><td>повторяющееся событие в прошлом (= каждый раз)</td></tr></table><br><b>Примеры:</b><br><g>Als</g> ich 18 war, habe ich meinen Führerschein gemacht. (один раз — Когда мне было 18, я получил водительские права.)<br><g>Wenn</g> ich früher Ferien hatte, bin ich immer zu meiner Oma gefahren. (несколько раз — Каждый раз, когда у меня были каникулы, я ездил к бабушке.)<br><br><b>schon или erst:</b><br><table><tr><th>schon</th><td>раньше / больше, чем ожидалось (уже)</td></tr><tr><th>erst</th><td>позже / меньше, чем ожидалось, ещё не совсем (только, лишь)</td></tr></table><br><b>Примеры:</b><br>Es ist <g>schon</g> 20 Uhr! (Уже 20:00! — это поздно)<br>Es ist <g>erst</g> 8 Uhr. (Только 8:00. — это рано)<br>Ich war <g>schon</g> dreimal in Berlin. (Я уже был в Берлине трижды.) / Ich war <g>erst</g> einmal in Berlin. (Я был в Берлине только один раз.)"
    }
  },
  {
    "id": "dativ_verben",
    ...
    "rule": {
      "de": "<b>Frage:</b> Wem? — diese Verben haben immer ein Objekt im <g>Dativ</g>, nie im Akkusativ.<br><br><table><tr><th>Verb</th><th>Bedeutung</th></tr><tr><td>helfen</td><td>Unterstützung geben</td></tr><tr><td>danken</td><td>Dank aussprechen</td></tr><tr><td>gefallen</td><td>gut finden / mögen</td></tr><tr><td>gehören</td><td>Besitzer sein von</td></tr><tr><td>schmecken</td><td>gut sein im Geschmack</td></tr><tr><td>gratulieren</td><td>Glückwünsche aussprechen</td></tr><tr><td>antworten</td><td>eine Antwort geben</td></tr></table><br><b>Artikel im Dativ:</b><br><table><tr><th></th><th>maskulin</th><th>feminin</th><th>neutral</th><th>Plural</th></tr><tr><td>bestimmt</td><td>dem</td><td>der</td><td>dem</td><td>den (+n)</td></tr><tr><td>unbestimmt</td><td>einem</td><td>einer</td><td>einem</td><td>–</td></tr></table><br><b>Beispiele:</b><br>Ich helfe <g>dem</g> Mann.<br>Das Buch gehört <g>der</g> Lehrerin.<br>Die Suppe schmeckt <g>den</g> Kindern.",
      "en": "<b>Question:</b> To whom? — these verbs always take an object in the <g>Dativ</g> (dative case), never the accusative.<br><br><table><tr><th>Verb</th><th>Meaning</th></tr><tr><td>helfen</td><td>to help</td></tr><tr><td>danken</td><td>to thank</td></tr><tr><td>gefallen</td><td>to please/like</td></tr><tr><td>gehören</td><td>to belong to</td></tr><tr><td>schmecken</td><td>to taste (good)</td></tr><tr><td>gratulieren</td><td>to congratulate</td></tr><tr><td>antworten</td><td>to answer</td></tr></table><br><b>Article in the dative:</b><br><table><tr><th></th><th>masculine</th><th>feminine</th><th>neuter</th><th>plural</th></tr><tr><td>definite</td><td>dem</td><td>der</td><td>dem</td><td>den (+n)</td></tr><tr><td>indefinite</td><td>einem</td><td>einer</td><td>einem</td><td>–</td></tr></table><br><b>Examples:</b><br>Ich helfe <g>dem</g> Mann. (I'm helping the man.)<br>Das Buch gehört <g>der</g> Lehrerin. (The book belongs to the teacher.)<br>Die Suppe schmeckt <g>den</g> Kindern. (The soup tastes good to the children.)",
      ...
      "ru": "<b>Вопрос:</b> Кому? — эти глаголы всегда требуют дополнения в <g>дательном падеже</g> (Dativ), никогда в винительном.<br><br><table><tr><th>Глагол</th><th>Значение</th></tr><tr><td>helfen</td><td>помогать</td></tr><tr><td>danken</td><td>благодарить</td></tr><tr><td>gefallen</td><td>нравиться</td></tr><tr><td>gehören</td><td>принадлежать</td></tr><tr><td>schmecken</td><td>быть вкусным</td></tr><tr><td>gratulieren</td><td>поздравлять</td></tr><tr><td>antworten</td><td>отвечать</td></tr></table><br><b>Артикль в дательном падеже:</b><br><table><tr><th></th><th>муж. род</th><th>жен. род</th><th>ср. род</th><th>множ. число</th></tr><tr><td>определённый</td><td>dem</td><td>der</td><td>dem</td><td>den (+n)</td></tr><tr><td>неопределённый</td><td>einem</td><td>einer</td><td>einem</td><td>–</td></tr></table><br><b>Примеры:</b><br>Ich helfe <g>dem</g> Mann. (Я помогаю мужчине.)<br>Das Buch gehört <g>der</g> Lehrerin. (Книга принадлежит учительнице.)<br>Die Suppe schmeckt <g>den</g> Kindern. (Суп нравится детям.)"
    }
  },
  {
    ...
    "rule": {
      "de": "<b>Struktur:</b> diese Verben haben zwei Objekte — Person im <g>Dativ</g> (Wem?) und Sache im <g>Akkusativ</g> (Was?).<br><br><table><tr><th>Verb</th><th>Bedeutung</th></tr><tr><td>geben</td><td>überreichen</td></tr><tr><td>zeigen</td><td>sehen lassen</td></tr><tr><td>schenken</td><td>als Geschenk geben</td></tr><tr><td>bringen</td><td>hinbringen</td></tr><tr><td>erklären</td><td>verständlich machen</td></tr><tr><td>schreiben</td><td>schriftlich mitteilen</td></tr></table><br><b>Reihenfolge der Objekte:</b><br><table><tr><th>zwei Nomen</th><td>Dativ vor Akkusativ</td></tr><tr><th>Nomen + Pronomen</th><td>Pronomen (egal welcher Kasus) vor Nomen</td></tr><tr><th>zwei Pronomen</th><td>Akkusativ vor Dativ</td></tr></table><br><b>Beispiele:</b><br>Ich gebe <g>dem Kind</g> (Dativ) <g>einen Ball</g> (Akkusativ).<br>Ich gebe <g>ihm</g> (Pronomen) <g>einen Ball</g>.<br>Ich gebe <g>ihn</g> (Akk.) <g>ihm</g> (Dat.).",
      "en": "<b>Structure:</b> these verbs have two objects — the person in the <g>Dativ</g> (To whom?) and the thing in the <g>Akkusativ</g> (What?).<br><br><table><tr><th>Verb</th><th>Meaning</th></tr><tr><td>geben</td><td>to give</td></tr><tr><td>zeigen</td><td>to show</td></tr><tr><td>schenken</td><td>to give as a gift</td></tr><tr><td>bringen</td><td>to bring</td></tr><tr><td>erklären</td><td>to explain</td></tr><tr><td>schreiben</td><td>to write</td></tr></table><br><b>Order of objects:</b><br><table><tr><th>two nouns</th><td>dative before accusative</td></tr><tr><th>noun + pronoun</th><td>the pronoun (whatever case) comes before the noun</td></tr><tr><th>two pronouns</th><td>accusative before dative</td></tr></table><br><b>Examples:</b><br>Ich gebe <g>dem Kind</g> (dative) <g>einen Ball</g> (accusative). (I'm giving the child a ball.)<br>Ich gebe <g>ihm</g> (pronoun) <g>einen Ball</g>. (I'm giving him a ball.)<br>Ich gebe <g>ihn</g> (acc.) <g>ihm</g> (dat.). (I'm giving it to him.)",
      ...
      "ru": "<b>Структура:</b> эти глаголы имеют два дополнения — лицо в <g>дательном падеже</g> (Кому?) и вещь в <g>винительном падеже</g> (Что?).<br><br><table><tr><th>Глагол</th><th>Значение</th></tr><tr><td>geben</td><td>давать</td></tr><tr><td>zeigen</td><td>показывать</td></tr><tr><td>schenken</td><td>дарить</td></tr><tr><td>bringen</td><td>приносить</td></tr><tr><td>erklären</td><td>объяснять</td></tr><tr><td>schreiben</td><td>писать</td></tr></table><br><b>Порядок дополнений:</b><br><table><tr><th>два существительных</th><td>дательный перед винительным</td></tr><tr><th>существительное + местоимение</th><td>местоимение (независимо от падежа) стоит перед существительным</td></tr><tr><th>два местоимения</th><td>винительный перед дательным</td></tr></table><br><b>Примеры:</b><br>Ich gebe <g>dem Kind</g> (дательный) <g>einen Ball</g> (винительный). (Я даю ребёнку мяч.)<br>Ich gebe <g>ihm</g> (местоимение) <g>einen Ball</g>. (Я даю ему мяч.)<br>Ich gebe <g>ihn</g> (вин.) <g>ihm</g> (дат.). (Я даю его ему.)"
    }
  },
  {
    ...
    "rule": {
      ...
      "en": "<b>The nine two-way prepositions:</b> <g>an, auf, hinter, in, neben, über, unter, vor, zwischen</g>.<br><br><table><tr><th>Question</th><th>Case</th><th>Meaning</th></tr><tr><td>Where to?</td><td><g>Accusative</g></td><td>motion, direction, destination</td></tr><tr><td>Where?</td><td><g>Dative</g></td><td>position, rest, location</td></tr></table><br><b>Rule of thumb:</b> if something moves and its location changes → Accusative. If something stays/is at a location → Dative.<br><br><table><tr><th></th><th>masculine</th><th>feminine</th><th>neuter</th></tr><tr><td>Acc.</td><td>den</td><td>die</td><td>das</td></tr><tr><td>Dat.</td><td>dem</td><td>der</td><td>dem</td></tr></table><br><b>Examples:</b><br>Ich hänge das Bild <g>an die</g> Wand. (Acc. — motion, I'm hanging the picture)<br>Das Bild hängt <g>an der</g> Wand. (Dat. — position, the picture is hanging)<br>Ich gehe <g>ins</g> Kino. (I'm going to the cinema.) / Ich bin <g>im</g> Kino. (I'm at the cinema.)",
      ...
      "ru": "<b>Девять предлогов двойного управления:</b> <g>an, auf, hinter, in, neben, über, unter, vor, zwischen</g>.<br><br><table><tr><th>Вопрос</th><th>Падеж</th><th>Значение</th></tr><tr><td>Куда?</td><td><g>Винительный</g></td><td>движение, направление, цель</td></tr><tr><td>Где?</td><td><g>Дательный</g></td><td>положение, покой, место</td></tr></table><br><b>Правило для запоминания:</b> если предмет движется и меняет своё место → винительный падеж. Если предмет находится на месте/в состоянии покоя → дательный падеж.<br><br><table><tr><th></th><th>муж. род</th><th>жен. род</th><th>ср. род</th></tr><tr><td>Вин.</td><td>den</td><td>die</td><td>das</td></tr><tr><td>Дат.</td><td>dem</td><td>der</td><td>dem</td></tr></table><br><b>Примеры:</b><br>Ich hänge das Bild <g>an die</g> Wand. (Винительный — движение, я вешаю картину)<br>Das Bild hängt <g>an der</g> Wand. (Дательный — картина висит, статичное состояние)<br>Ich gehe <g>ins</g> Kino. (Иду в кино) / Ich bin <g>im</g> Kino. (Я в кино)"
    }
  },
  {
    ...
    "rule": {
      ...
      "en": "<b>Key prepositions for direction:</b><br><table><tr><th>Preposition</th><th>Use</th></tr><tr><td><g>zu</g> (+ dative)</td><td>to people, institutions, shops</td></tr><tr><td><g>nach</g></td><td>to cities/countries without an article, cardinal directions</td></tr><tr><td><g>in</g> (+ acc.)</td><td>to countries with an article, enclosed spaces</td></tr><tr><td><g>an</g> (+ acc.)</td><td>to borders, shores, rivers</td></tr><tr><td><g>über</g> (+ acc.)</td><td>via a route/through a place</td></tr></table><br><b>Contractions:</b> zu + dem = <g>zum</g>, zu + der = <g>zur</g>, in + das = <g>ins</g>, an + das = <g>ans</g>.<br><br><b>Examples:</b><br>Ich gehe <g>zum</g> Arzt. (I'm going to the doctor.) Ich fliege <g>nach</g> Paris. (I'm flying to Paris.) Ich fahre <g>in die</g> Schweiz. (I'm going to Switzerland.) Wir fahren <g>an den</g> Rhein. (We're going to the Rhine.)",
      ...
      "ru": "<b>Основные предлоги направления:</b><br><table><tr><th>Предлог</th><th>Употребление</th></tr><tr><td><g>zu</g> (+ дательный)</td><td>к людям, учреждениям, магазинам</td></tr><tr><td><g>nach</g></td><td>к городам/странам без артикля, стороны света</td></tr><tr><td><g>in</g> (+ винительный)</td><td>в страны с артиклем, в закрытые помещения</td></tr><tr><td><g>an</g> (+ винительный)</td><td>к границам, берегам, рекам</td></tr><tr><td><g>über</g> (+ винительный)</td><td>через маршрут/определённое место</td></tr></table><br><b>Слитные формы:</b> zu + dem = <g>zum</g>, zu + der = <g>zur</g>, in + das = <g>ins</g>, an + das = <g>ans</g>.<br><br><b>Примеры:</b><br>Ich gehe <g>zum</g> Arzt. (Я иду к врачу.) Ich fliege <g>nach</g> Paris. (Я лечу в Париж.) Ich fahre <g>in die</g> Schweiz. (Я еду в Швейцарию.) Wir fahren <g>an den</g> Rhein. (Мы едем на Рейн.)"
    }
  },
  {
    ...
    "rule": {
      ...
      "en": "<table><tr><th>Preposition</th><th>Case</th><th>Meaning</th></tr><tr><td><g>vor</g></td><td>dative</td><td>a point in the past (2 years ago)</td></tr><tr><td><g>nach</g></td><td>dative</td><td>after an event, afterward</td></tr><tr><td><g>seit</g></td><td>dative</td><td>started in the past, continues to now</td></tr><tr><td><g>für</g></td><td>accusative</td><td>planned duration</td></tr><tr><td><g>bis</g></td><td>accusative</td><td>end point</td></tr></table><br><b>seit vs. für:</b> <g>seit</g> = the start of an action that's still going on today (use with the present tense!). <g>für</g> = a planned or completed duration.<br><br><b>Examples:</b><br><g>Seit einem</g> Jahr lerne ich Deutsch. (I've been learning German for a year.)<br>Ich fahre <g>für einen</g> Monat nach Berlin. (I'm going to Berlin for a month.)<br><g>Vor</g> zwei Jahren habe ich geheiratet. (I got married two years ago.)",
      ...
      "ru": "<table><tr><th>Предлог</th><th>Падеж</th><th>Значение</th></tr><tr><td><g>vor</g></td><td>дательный</td><td>момент времени в прошлом (два года назад)</td></tr><tr><td><g>nach</g></td><td>дательный</td><td>после события, потом</td></tr><tr><td><g>seit</g></td><td>дательный</td><td>начало действия в прошлом, длящегося до сих пор</td></tr><tr><td><g>für</g></td><td>винительный</td><td>запланированная продолжительность</td></tr><tr><td><g>bis</g></td><td>винительный</td><td>конечная точка</td></tr></table><br><b>Внимание, seit или für:</b> <g>seit</g> — начало действия, которое длится до сих пор (используется с настоящим временем!). <g>für</g> — запланированная или завершённая продолжительность.<br><br><b>Примеры:</b><br><g>Seit einem</g> Jahr lerne ich Deutsch. (Я учу немецкий уже год.)<br>Ich fahre <g>für einen</g> Monat nach Berlin. (Я еду в Берлин на месяц.)<br><g>Vor</g> zwei Jahren habe ich geheiratet. (Два года назад я женился/вышла замуж.)"
    }
  },
  {
    "id": "adjektivendungen",
    ...
    "rule": {
      ...
      "en": "<b>Rule:</b> after 'ein/mein/dein...', the adjective in the nominative and accusative (except masc. acc.) carries the gender signal that the article itself can't show.<br><br><table><tr><th></th><th>masculine</th><th>feminine</th><th>neuter</th><th>plural</th></tr><tr><td>Nominative</td><td>-er</td><td>-e</td><td>-es</td><td>-en</td></tr><tr><td>Accusative</td><td>-en</td><td>-e</td><td>-es</td><td>-en</td></tr><tr><td>Dative</td><td>-en</td><td>-en</td><td>-en</td><td>-en</td></tr></table><br><b>Rule of thumb:</b> in the dative and plural it's almost always <g>-en</g>. Only in the nominative (and acc. feminine/neuter) do the endings differ by gender.<br><br><b>Examples:</b><br>Das ist ein <g>guter</g> Mann. (Nom. masc. — That's a good man.)<br>Ich habe ein <g>schönes</g> Auto. (Acc. neuter — I have a nice car.)<br>Ich habe einen <g>guten</g> Freund. (Acc. masc. — I have a good friend.)<br>Mit meinem <g>neuen</g> Auto. (Dative — With my new car.)",
      ...
      "ru": "<b>Правило:</b> после 'ein/mein/dein...' прилагательное в именительном и винительном (кроме муж. рода винительного) падежах берёт на себя сигнал рода, который не показывает сам артикль.<br><br><table><tr><th></th><th>муж. род</th><th>жен. род</th><th>ср. род</th><th>множ.</th></tr><tr><td>Именительный</td><td>-er</td><td>-e</td><td>-es</td><td>-en</td></tr><tr><td>Винительный</td><td>-en</td><td>-e</td><td>-es</td><td>-en</td></tr><tr><td>Дательный</td><td>-en</td><td>-en</td><td>-en</td><td>-en</td></tr></table><br><b>Для запоминания:</b> в дательном падеже и во множественном числе почти всегда <g>-en</g>. Только в именительном (и винительном жен./ср. рода) окончания различаются в зависимости от рода.<br><br><b>Примеры:</b><br>Das ist ein <g>guter</g> Mann. (Именительный, муж. род — Это хороший мужчина.)<br>Ich habe ein <g>schönes</g> Auto. (Винительный, ср. род — У меня красивая машина.)<br>Ich habe einen <g>guten</g> Freund. (Винительный, муж. род — У меня хороший друг.)<br>Mit meinem <g>neuen</g> Auto. (Дательный — Моей новой машиной.)"
    }
  },
  {
    "id": "was_fuer_ein",
    ...
    "rule": {
      ...
      "en": "<b>Meaning:</b> <g>Was für ein...?</g> asks about qualities, a type, or a choice (not about a specific quantity — 'welcher' is used for that).<br><br><table><tr><th>Case</th><th>masculine</th><th>feminine</th><th>neuter</th><th>plural</th></tr><tr><td>Nominative</td><td>was für ein</td><td>was für eine</td><td>was für ein</td><td>was für</td></tr><tr><td>Accusative</td><td>was für einen</td><td>was für eine</td><td>was für ein</td><td>was für</td></tr></table><br><b>Note:</b> 'für' has no influence on the case here — the case depends on the verb in the sentence!<br><br><b>Examples:</b><br><g>Was für ein</g> Auto hast du? (Acc. neuter — What kind of car do you have?)<br><g>Was für eine</g> Musik magst du? (What kind of music do you like?)<br><g>Was für</g> Bücher liest du gern? (plural — What kind of books do you like to read?)",
      ...
      "ru": "<b>Значение:</b> вопрос <g>Was für ein...?</g> (Что за...? Какой именно...?) спрашивает о качестве, типе или выборе предмета (а не о конкретном количестве — для этого используется 'welcher').<br><br><table><tr><th>Падеж</th><th>муж. род</th><th>жен. род</th><th>ср. род</th><th>множ.</th></tr><tr><td>Именительный</td><td>was für ein</td><td>was für eine</td><td>was für ein</td><td>was für</td></tr><tr><td>Винительный</td><td>was für einen</td><td>was für eine</td><td>was für ein</td><td>was für</td></tr></table><br><b>Внимание:</b> слово 'für' здесь не влияет на падеж — падеж зависит от глагола в предложении!<br><br><b>Примеры:</b><br><g>Was für ein</g> Auto hast du? (Винительный, ср. род — Какая у тебя машина?)<br><g>Was für eine</g> Musik magst du? (Какая музыка тебе нравится?)<br><g>Was für</g> Bücher liest du gern? (множ. — Какие книги ты любишь читать?)"
    }
  },
  {
    "id": "komparativ",
    ...
    "explanation": {
      "de": "Der Komparativ bekommt ein <g>-er</g> (oft mit Umlaut: alt -> älter). Für Gleichheit nutzen wir <g>so ... wie</g>. Für Unterschiede nutzen wir den Komparativ + <g>als</g>.<br>Beispiel: Er ist <g>so groß wie</g> ich. Er ist <g>älter als</g> ich.",
    ...
    "rule": {
      ...
      "en": "<b>Formation:</b> adjective + <g>-er</g> (often with an umlaut for one-syllable words: a→ä, o→ö, u→ü).<br><br><table><tr><th>Base form</th><th>Comparative</th></tr><tr><td>alt (old)</td><td>älter</td></tr><tr><td>groß (big)</td><td>größer</td></tr><tr><td>jung (young)</td><td>jünger</td></tr><tr><td>gut (good)</td><td>besser</td></tr><tr><td>gern (gladly)</td><td>lieber</td></tr><tr><td>viel (much)</td><td>mehr</td></tr></table><br><b>Comparisons:</b><br><table><tr><th>Equality</th><td>(nicht) so ... wie (as ... as)</td></tr><tr><th>Difference</th><td>comparative + als (than)</td></tr></table><br><b>Examples:</b><br>Er ist <g>so groß wie</g> ich. (He is as tall as me.)<br>Er ist <g>älter als</g> ich. (He is older than me.)<br>Ich arbeite <g>mehr als</g> er. (I work more than him.)",
      ...
      "ru": "<b>Образование:</b> прилагательное + окончание <g>-er</g> (часто с умлаутом в односложных словах: a→ä, o→ö, u→ü).<br><br><table><tr><th>Начальная форма</th><th>Компаратив</th></tr><tr><td>alt (старый)</td><td>älter</td></tr><tr><td>groß (большой)</td><td>größer</td></tr><tr><td>jung (молодой)</td><td>jünger</td></tr><tr><td>gut (хороший)</td><td>besser</td></tr><tr><td>gern (охотно)</td><td>lieber</td></tr><tr><td>viel (много)</td><td>mehr</td></tr></table><br><b>Сравнения:</b><br><table><tr><th>Равенство</th><td>(nicht) so ... wie (такой же ... как)</td></tr><tr><th>Различие</th><td>компаратив + als (чем)</td></tr></table><br><b>Примеры:</b><br>Er ist <g>so groß wie</g> ich. (Он такой же высокий, как я.)<br>Er ist <g>älter als</g> ich. (Он старше меня.)<br>Ich arbeite <g>mehr als</g> er. (Я работаю больше, чем он.)"
    }
  },
  {
    "id": "superlativ",
    ...
    "explanation": {
      "de": "Der Superlativ ist die höchste Stufe. Nach Verben nutzen wir meistens <g>am ...-sten</g>. Vor Nomen nutzen wir den bestimmten Artikel + <g>-ste</g>.<br>Beispiel: Kaffee schmeckt mir <g>am besten</g>. Das ist das <g>schönste</g> Haus.",
    ...
    "rule": {
      ...
      "en": "<b>Two forms:</b><br><table><tr><th>After verbs (predicative)</th><td><g>am</g> + adjective + <g>-sten</g></td></tr><tr><th>Before nouns (attributive)</th><td>definite article + adjective + <g>-ste</g> + ending</td></tr></table><br><table><tr><th>Base form</th><th>Comparative</th><th>Superlative (am ...)</th></tr><tr><td>alt</td><td>älter</td><td>am ältesten</td></tr><tr><td>groß</td><td>größer</td><td>am größten</td></tr><tr><td>gut</td><td>besser</td><td>am besten</td></tr><tr><td>gern</td><td>lieber</td><td>am liebsten</td></tr><tr><td>viel</td><td>mehr</td><td>am meisten</td></tr></table><br><b>Note:</b> adjectives ending in -d, -t, -s, -z, -sch get an extra -e- (am kältesten, am heißesten).<br><br><b>Examples:</b><br>Kaffee schmeckt mir <g>am besten</g>. (I like the taste of coffee the most.)<br>Das ist das <g>schönste</g> Haus der Stadt. (That's the most beautiful house in the city.)",
      ...
      "ru": "<b>Две формы:</b><br><table><tr><th>После глаголов (предикативно)</th><td><g>am</g> + прилагательное + <g>-sten</g></td></tr><tr><th>Перед существительным (атрибутивно)</th><td>определённый артикль + прилагательное + <g>-ste</g> + окончание</td></tr></table><br><table><tr><th>Начальная форма</th><th>Компаратив</th><th>Суперлатив (am ...)</th></tr><tr><td>alt</td><td>älter</td><td>am ältesten</td></tr><tr><td>groß</td><td>größer</td><td>am größten</td></tr><tr><td>gut</td><td>besser</td><td>am besten</td></tr><tr><td>gern</td><td>lieber</td><td>am liebsten</td></tr><tr><td>viel</td><td>mehr</td><td>am meisten</td></tr></table><br><b>Внимание:</b> прилагательные, оканчивающиеся на -d, -t, -s, -z, -sch, получают дополнительное -e- (am kältesten, am heißesten).<br><br><b>Примеры:</b><br>Kaffee schmeckt mir <g>am besten</g>. (Кофе мне нравится больше всего.)<br>Das ist das <g>schönste</g> Haus der Stadt. (Это самый красивый дом в городе.)"
    }
  },
  {
    ...
    "rule": {
      ...
      "en": "<b>Declension:</b> <g>dieser, diese, dieses</g> is declined exactly like the definite article (der, die, das).<br><br><table><tr><th></th><th>masculine</th><th>feminine</th><th>neuter</th><th>plural</th></tr><tr><td>Nominative</td><td>dieser</td><td>diese</td><td>dieses</td><td>diese</td></tr><tr><td>Accusative</td><td>diesen</td><td>diese</td><td>dieses</td><td>diese</td></tr><tr><td>Dative</td><td>diesem</td><td>dieser</td><td>diesem</td><td>diesen</td></tr></table><br><b>Compare with the article:</b> der→dieser, die→diese, das→dieses, dem→diesem, den→diesen.<br><br><b>Examples:</b><br>Mir gefällt <g>dieses</g> Buch. (Nom./Acc. neuter — I like this book.)<br><g>Diese</g> Wohnung ist teuer. (This apartment is expensive.)<br>Ich helfe <g>diesem</g> Mann. (Dative — I'm helping this man.)",
      ...
      "ru": "<b>Склонение:</b> <g>dieser, diese, dieses</g> склоняется точно так же, как определённый артикль (der, die, das).<br><br><table><tr><th></th><th>муж. род</th><th>жен. род</th><th>ср. род</th><th>множ.</th></tr><tr><td>Именительный</td><td>dieser</td><td>diese</td><td>dieses</td><td>diese</td></tr><tr><td>Винительный</td><td>diesen</td><td>diese</td><td>dieses</td><td>diese</td></tr><tr><td>Дательный</td><td>diesem</td><td>dieser</td><td>diesem</td><td>diesen</td></tr></table><br><b>Сравнение с артиклем:</b> der→dieser, die→diese, das→dieses, dem→diesem, den→diesen.<br><br><b>Примеры:</b><br>Mir gefällt <g>dieses</g> Buch. (Именительный/винительный ср. рода — Мне нравится эта книга.)<br><g>Diese</g> Wohnung ist teuer. (Эта квартира дорогая.)<br>Ich helfe <g>diesem</g> Mann. (Дательный — Я помогаю этому мужчине.)"
    }
  },
  {
    "id": "hoeflichkeit_konjunktiv",
    "title": {"de": "Höfliche Bitten (Konjunktiv II)", "en": "Polite requests (subjunctive II)", "uk": "Ввічливі прохання (конʼюнктив II)", "ru": "Вежливые просьбы (конъюнктив II)"},
    "explanation": {
    ...
    "rule": {
      ...
      "en": "<b>Formation with würde:</b> <g>würde</g> (conjugated) + subject ... + infinitive at the end.<br><br><table><tr><th>ich</th><td>würde</td></tr><tr><th>du</th><td>würdest</td></tr><tr><th>er/sie/es</th><td>würde</td></tr><tr><th>wir</th><td>würden</td></tr><tr><th>ihr</th><td>würdet</td></tr><tr><th>sie/Sie</th><td>würden</td></tr></table><br><b>Important fixed forms (without würde):</b><br><table><tr><th>haben</th><td><g>hätte</g>, hättest, hätte, hätten, hättet, hätten</td></tr><tr><th>sein</th><td><g>wäre</g>, wärst, wäre, wären, wärt, wären</td></tr><tr><th>können</th><td><g>könnte</g>, könntest, könnte, könnten, könntet, könnten</td></tr></table><br><b>Examples:</b><br>Ich <g>hätte</g> gern einen Kaffee. (I'd like a coffee.)<br><g>Würden</g> Sie mir bitte <g>helfen</g>? (Would you please help me?)<br><g>Könntest</g> du bitte das Fenster schließen? (Could you please close the window?)",
      ...
      "ru": "<b>Образование с würde:</b> <g>würde</g> (в нужной форме) + подлежащее ... + инфинитив в конце предложения.<br><br><table><tr><th>ich</th><td>würde</td></tr><tr><th>du</th><td>würdest</td></tr><tr><th>er/sie/es</th><td>würde</td></tr><tr><th>wir</th><td>würden</td></tr><tr><th>ihr</th><td>würdet</td></tr><tr><th>sie/Sie</th><td>würden</td></tr></table><br><b>Важные отдельные формы (без würde):</b><br><table><tr><th>haben</th><td><g>hätte</g>, hättest, hätte, hätten, hättet, hätten</td></tr><tr><th>sein</th><td><g>wäre</g>, wärst, wäre, wären, wärt, wären</td></tr><tr><th>können</th><td><g>könnte</g>, könntest, könnte, könnten, könntet, könnten</td></tr></table><br><b>Примеры:</b><br>Ich <g>hätte</g> gern einen Kaffee. (Я хотел бы кофе.)<br><g>Würden</g> Sie mir bitte <g>helfen</g>? (Не могли бы вы мне помочь?)<br><g>Könntest</g> du bitte das Fenster schließen? (Не мог бы ты закрыть окно?)"
    }
  },
  {
    "id": "personalpronomen",
    ...
    "rule": {
      ...
      "en": "<b>Declension of personal pronouns:</b><br><br><table><tr><th>Nominative</th><th>Accusative</th><th>Dative</th></tr><tr><td>ich</td><td>mich</td><td>mir</td></tr><tr><td>du</td><td>dich</td><td>dir</td></tr><tr><td>er</td><td>ihn</td><td>ihm</td></tr><tr><td>sie</td><td>sie</td><td>ihr</td></tr><tr><td>es</td><td>es</td><td>ihm</td></tr><tr><td>wir</td><td>uns</td><td>uns</td></tr><tr><td>ihr</td><td>euch</td><td>euch</td></tr><tr><td>sie/Sie</td><td>sie/Sie</td><td>ihnen/Ihnen</td></tr></table><br><b>Which case, and when?</b> Accusative after verbs with a direct object (lieben, sehen, kennen). Dative after verbs answering 'To whom?' (helfen, danken, gefallen).<br><br><b>Examples:</b><br>Hilfst du <g>mir</g>? (Dative — Will you help me?)<br>Ich liebe <g>dich</g>. (Accusative — I love you.)<br>Kennst du <g>ihn</g>? (Do you know him?)",
      ...
      "ru": "<b>Склонение личных местоимений:</b><br><table><tr><th>Именительный</th><th>Винительный</th><th>Дательный</th></tr><tr><td>ich</td><td>mich</td><td>mir</td></tr><tr><td>du</td><td>dich</td><td>dir</td></tr><tr><td>er</td><td>ihn</td><td>ihm</td></tr><tr><td>sie</td><td>sie</td><td>ihr</td></tr><tr><td>es</td><td>es</td><td>ihm</td></tr><tr><td>wir</td><td>uns</td><td>uns</td></tr><tr><td>ihr</td><td>euch</td><td>euch</td></tr><tr><td>sie/Sie</td><td>sie/Sie</td><td>ihnen/Ihnen</td></tr></table><br><b>Когда какой падеж?</b> Винительный — после глаголов с одним дополнением (lieben, sehen, kennen). Дательный — после глаголов с вопросом 'Кому?' (helfen, danken, gefallen).<br><br><b>Примеры:</b><br>Hilfst du <g>mir</g>? (Дательный — Ты мне поможешь?)<br>Ich liebe <g>dich</g>. (Винительный — Я тебя люблю.)<br>Kennst du <g>ihn</g>? (Ты его знаешь?)"
    }
  },
  {
    ...
    "rule": {
      ...
      "en": "<b>Declension of reflexive pronouns in the accusative:</b><br><br><table><tr><th>ich</th><td>mich</td></tr><tr><th>du</th><td>dich</td></tr><tr><th>er/sie/es</th><td>sich</td></tr><tr><th>wir</th><td>uns</td></tr><tr><th>ihr</th><td>euch</td></tr><tr><th>sie/Sie</th><td>sich</td></tr></table><br><b>Note:</b> only 'er/sie/es' and 'sie/Sie' have the form <g>sich</g>. For the other persons, the reflexive pronouns are identical to the accusative pronouns (mich, dich, uns, euch).<br><br><b>Important reflexive verbs:</b> sich waschen (to wash oneself), sich freuen auf/über (to look forward to/be happy about), sich interessieren für (to be interested in), sich beeilen (to hurry), sich erinnern an (to remember), sich fühlen (to feel).<br><br><b>Examples:</b><br>Ich wasche <g>mich</g> jeden Morgen. (I wash myself every morning.)<br>Er freut <g>sich</g> auf die Ferien. (He's looking forward to the vacation.)<br>Wir beeilen <g>uns</g>. (We're hurrying.)",
      ...
      "ru": "<b>Склонение возвратных местоимений в винительном падеже:</b><br><br><table><tr><th>ich</th><td>mich</td></tr><tr><th>du</th><td>dich</td></tr><tr><th>er/sie/es</th><td>sich</td></tr><tr><th>wir</th><td>uns</td></tr><tr><th>ihr</th><td>euch</td></tr><tr><th>sie/Sie</th><td>sich</td></tr></table><br><b>Внимание:</b> форма <g>sich</g> существует только для 'er/sie/es' и 'sie/Sie'. У остальных лиц возвратные местоимения совпадают с винительными формами личных местоимений (mich, dich, uns, euch).<br><br><b>Важные возвратные глаголы:</b> sich waschen (мыться), sich freuen (радоваться), sich interessieren für (интересоваться), sich beeilen (спешить), sich erinnern an (помнить), sich fühlen (чувствовать себя).<br><br><b>Примеры:</b><br>Ich wasche <g>mich</g> jeden Morgen. (Я умываюсь каждое утро.)<br>Er freut <g>sich</g> auf die Ferien. (Он радуется предстоящим каникулам.)<br>Wir beeilen <g>uns</g>. (Мы спешим.)"
    }
  },
  {
    ...
    "rule": {
      ...
      "en": "<b>Principle:</b> some verbs always need the same preposition + a fixed case — this combination has to be memorized.<br><br><table><tr><th>Verb + preposition</th><th>Case</th></tr><tr><td>warten auf (to wait for)</td><td>accusative</td></tr><tr><td>sich freuen auf (to look forward to)</td><td>accusative</td></tr><tr><td>sich interessieren für (to be interested in)</td><td>accusative</td></tr><tr><td>denken an (to think of)</td><td>accusative</td></tr><tr><td>sprechen mit (to talk to)</td><td>dative</td></tr><tr><td>sich treffen mit (to meet with)</td><td>dative</td></tr><tr><td>Angst haben vor (to be afraid of)</td><td>dative</td></tr></table><br><b>Asking about them:</b> for people you ask <g>Auf wen?/Mit wem?</g> (For whom?/With whom?), for things <g>Worauf?/Womit?</g> (wo(r) + preposition).<br><br><b>Examples:</b><br>Ich warte <g>auf den</g> Bus. (I'm waiting for the bus.)<br>Ich spreche <g>mit meiner</g> Mutter. (I'm talking with my mother.)<br><g>Worauf</g> wartest du? — <g>Auf den</g> Bus. (What are you waiting for? — For the bus.)",
      ...
      "ru": "<b>Принцип:</b> некоторые глаголы всегда требуют один и тот же предлог с определённым падежом — эту комбинацию нужно учить наизусть.<br><br><table><tr><th>Глагол + предлог</th><th>Падеж</th></tr><tr><td>warten auf (ждать)</td><td>винительный</td></tr><tr><td>sich freuen auf (радоваться предстоящему)</td><td>винительный</td></tr><tr><td>sich interessieren für (интересоваться)</td><td>винительный</td></tr><tr><td>denken an (думать о)</td><td>винительный</td></tr><tr><td>sprechen mit (разговаривать с)</td><td>дательный</td></tr><tr><td>sich treffen mit (встречаться с)</td><td>дательный</td></tr><tr><td>Angst haben vor (бояться)</td><td>дательный</td></tr></table><br><b>Вопросы к ним:</b> о людях спрашивают <g>Auf wen?/Mit wem?</g> (На кого?/С кем?), о вещах — <g>Worauf?/Womit?</g> (wo(r) + предлог).<br><br><b>Примеры:</b><br>Ich warte <g>auf den</g> Bus. (Я жду автобус.)<br>Ich spreche <g>mit meiner</g> Mutter. (Я разговариваю со своей мамой.)<br><g>Worauf</g> wartest du? — <g>Auf den</g> Bus. (Чего ты ждёшь? — Автобуса.)"
    }
  },
  {
    "id": "satz_mit_deshalb",
    ...
    "rule": {
      ...
      "en": "<b>Position:</b> <g>deshalb</g> is an adverb (not a connector like 'weil') and takes position 1 in the main clause. Right after it comes the conjugated verb (position 2), then the subject.<br><br><table><tr><th>Position 1</th><th>Position 2 (verb)</th><th>Subject</th><th>Rest</th></tr><tr><td>Deshalb</td><td>bleibe</td><td>ich</td><td>im Bett.</td></tr></table><br><b>Comparison with weil:</b><br><table><tr><th>weil</th><td>subordinate clause, verb at the end: ..., weil ich krank bin.</td></tr><tr><th>deshalb</th><td>two main clauses: Ich bin krank, deshalb bleibe ich im Bett.</td></tr></table><br><b>Similar words:</b> deswegen, darum, daher (same position and meaning).<br><br><b>Example:</b> Ich bin krank, <g>deshalb bleibe</g> ich im Bett. (I'm sick, so I'm staying in bed.)",
      ...
      "ru": "<b>Позиция:</b> <g>deshalb</g> — наречие (а не союз, как 'weil'), поэтому занимает первую позицию в главном предложении. Сразу после него идёт спрягаемый глагол (2-я позиция), а затем подлежащее.<br><br><table><tr><th>Позиция 1</th><th>Позиция 2 (глагол)</th><th>Подлежащее</th><th>Остальное</th></tr><tr><td>Deshalb</td><td>bleibe</td><td>ich</td><td>im Bett.</td></tr></table><br><b>Сравнение с weil:</b><br><table><tr><th>weil</th><td>придаточное предложение, глагол в конце: ..., weil ich krank bin.</td></tr><tr><th>deshalb</th><td>два самостоятельных предложения: Ich bin krank, deshalb bleibe ich im Bett.</td></tr></table><br><b>Похожие слова:</b> deswegen, darum, daher (та же позиция и значение).<br><br><b>Пример:</b> Ich bin krank, <g>deshalb bleibe</g> ich im Bett. (Я болею, поэтому остаюсь в постели.)"
    }
  },
  {
    ...
    "rule": {
      ...
      "en": "<b>Extending the Konjunktiv II:</b><br><table><tr><th>Form</th><th>Function</th><th>Example</th></tr><tr><td><g>sollte</g></td><td>giving advice</td><td>Du <g>solltest</g> mehr schlafen. (You should sleep more.)</td></tr><tr><td><g>könnte</g></td><td>a very polite question / suggestion</td><td><g>Könntest</g> du mir helfen? (Could you help me?)</td></tr><tr><td><g>hätte</g>/<g>wäre</g></td><td>a wish</td><td>Ich <g>hätte</g> gern Zeit. (I'd like to have time.)</td></tr></table><br><b>Conjugation of sollen:</b> ich sollte, du solltest, er/sie/es sollte, wir sollten, ihr solltet, sie/Sie sollten.<br><br><b>Examples:</b><br>Du <g>solltest</g> zum Arzt gehen. (advice — You should go to the doctor.)<br><g>Könnten</g> Sie das Fenster schließen? (polite request — Could you close the window?)",
      ...
      "ru": "<b>Расширение Конъюнктива II:</b><br><table><tr><th>Форма</th><th>Функция</th><th>Пример</th></tr><tr><td><g>sollte</g></td><td>дать совет</td><td>Du <g>solltest</g> mehr schlafen. (Тебе стоит больше спать.)</td></tr><tr><td><g>könnte</g></td><td>очень вежливо спросить / предложить</td><td><g>Könntest</g> du mir helfen? (Не мог бы ты мне помочь?)</td></tr><tr><td><g>hätte</g>/<g>wäre</g></td><td>желание</td><td>Ich <g>hätte</g> gern Zeit. (Я хотел бы иметь время.)</td></tr></table><br><b>Спряжение sollen:</b> ich sollte, du solltest, er/sie/es sollte, wir sollten, ihr solltet, sie/Sie sollten.<br><br><b>Примеры:</b><br>Du <g>solltest</g> zum Arzt gehen. (Тебе следует сходить к врачу — совет.)<br><g>Könnten</g> Sie das Fenster schließen? (Не могли бы вы закрыть окно? — вежливая просьба.)"
    }
  },
  {
    ...
    "rule": {
      ...
      "en": "<b>Rule:</b> after the definite article, the article itself already shows the gender — so the adjective usually takes a 'weak' ending.<br><br><table><tr><th></th><th>masculine</th><th>feminine</th><th>neuter</th><th>plural</th></tr><tr><td>Nominative</td><td>-e</td><td>-e</td><td>-e</td><td>-en</td></tr><tr><td>Accusative</td><td>-en</td><td>-e</td><td>-e</td><td>-en</td></tr><tr><td>Dative</td><td>-en</td><td>-en</td><td>-en</td><td>-en</td></tr></table><br><b>Rule of thumb:</b> only in the nominative (all genders) and accusative (feminine/neuter) is it <g>-e</g>. In all other cases: <g>-en</g>.<br><br><b>Examples:</b><br>Der <g>neue</g> Kollege ist nett. (Nom. masc. — The new colleague is nice.)<br>Ich helfe dem <g>alten</g> Mann. (Dative — I'm helping the old man.)<br>Ich kenne die <g>neue</g> Kollegin. (Acc. fem. — I know the new colleague.)",
      ...
      "ru": "<b>Правило:</b> после определённого артикля род уже показывает сам артикль — поэтому прилагательное обычно получает 'слабое' окончание.<br><br><table><tr><th></th><th>муж. род</th><th>жен. род</th><th>ср. род</th><th>множ.</th></tr><tr><td>Именительный</td><td>-e</td><td>-e</td><td>-e</td><td>-en</td></tr><tr><td>Винительный</td><td>-en</td><td>-e</td><td>-e</td><td>-en</td></tr><tr><td>Дательный</td><td>-en</td><td>-en</td><td>-en</td><td>-en</td></tr></table><br><b>Для запоминания:</b> только в именительном (все роды) и винительном (жен./ср. рода) — <g>-e</g>. Во всех остальных случаях: <g>-en</g>.<br><br><b>Примеры:</b><br>Der <g>neue</g> Kollege ist nett. (Именительный, муж. род — Новый коллега приятный.)<br>Ich helfe dem <g>alten</g> Mann. (Дательный — Я помогаю старому мужчине.)<br>Ich kenne die <g>neue</g> Kollegin. (Винительный, жен. род — Я знаю новую коллегу.)"
    }
  },
  {
    ...
    "rule": {
      ...
      "en": "<b>Relative pronoun in the nominative = like the definite article:</b><br><table><tr><th>masculine</th><th>feminine</th><th>neuter</th><th>plural</th></tr><tr><td>der</td><td>die</td><td>das</td><td>die</td></tr></table><br><b>Rule:</b> the gender of the relative pronoun matches the noun it refers to, while the case depends on its function in the subordinate clause. The verb goes at the end.<br><br><b>Structure:</b> main clause + noun, + relative pronoun + ... + verb.<br><br><b>Examples:</b><br>Das ist der Mann, <g>der</g> hier <g>wohnt</g>. (Mann = masculine — That's the man who lives here.)<br>Das ist die Frau, <g>die</g> Deutsch <g>unterrichtet</g>. (Frau = feminine — That's the woman who teaches German.)<br>Das ist das Kind, <g>das</g> gern <g>spielt</g>. (Kind = neuter — That's the child who likes to play.)",
      ...
      "ru": "<b>Относительное местоимение в именительном падеже = как определённый артикль:</b><br><br><table><tr><th>муж. род</th><th>жен. род</th><th>ср. род</th><th>множ.</th></tr><tr><td>der</td><td>die</td><td>das</td><td>die</td></tr></table><br><b>Правило:</b> род относительного местоимения определяется существительным перед ним, а падеж — функцией в придаточном предложении. Глагол стоит в конце.<br><br><b>Структура:</b> главное предложение + существительное, + относительное местоимение + ... + глагол.<br><br><b>Примеры:</b><br>Das ist der Mann, <g>der</g> hier <g>wohnt</g>. (Mann — муж. род — Это мужчина, который здесь живёт.)<br>Das ist die Frau, <g>die</g> Deutsch <g>unterrichtet</g>. (Frau — жен. род — Это женщина, которая преподаёт немецкий.)<br>Das ist das Kind, <g>das</g> gern <g>spielt</g>. (Kind — ср. род — Это ребёнок, который любит играть.)"
    }
  },
  {
    "id": "verb_werden",
    ...
    "rule": {
      ...
      "en": "<b>Present tense conjugation (irregular):</b><br><br><table><tr><th>ich</th><td>werde</td></tr><tr><th>du</th><td>wirst</td></tr><tr><th>er/sie/es</th><td>wird</td></tr><tr><th>wir</th><td>werden</td></tr><tr><th>ihr</th><td>werdet</td></tr><tr><th>sie/Sie</th><td>werden</td></tr></table><br><b>Three uses:</b><br><table><tr><th>1. Change of state</th><td>+ adjective: Es <g>wird</g> kalt. (It's getting cold.)</td></tr><tr><th>2. Profession/state</th><td>+ noun: Er <g>wird</g> Arzt. (He's going to be a doctor.)</td></tr><tr><th>3. Future I</th><td>+ infinitive at the end: Ich <g>werde</g> morgen <g>kommen</g>. (I will come tomorrow.)</td></tr></table><br><b>Examples:</b><br>Mein Sohn <g>wird</g> bald Arzt. (My son will soon be a doctor.)<br>Es <g>wird</g> dunkel. (It's getting dark.)<br>Ich <g>werde</g> dich <g>anrufen</g>. (I will call you.)",
      ...
      "ru": "<b>Спряжение в настоящем времени (неправильный глагол):</b><br><br><table><tr><th>ich</th><td>werde</td></tr><tr><th>du</th><td>wirst</td></tr><tr><th>er/sie/es</th><td>wird</td></tr><tr><th>wir</th><td>werden</td></tr><tr><th>ihr</th><td>werdet</td></tr><tr><th>sie/Sie</th><td>werden</td></tr></table><br><b>Три употребления:</b><br><table><tr><th>1. Изменение состояния</th><td>+ прилагательное: Es <g>wird</g> kalt. (Становится холодно.)</td></tr><tr><th>2. Профессия/состояние</th><td>+ существительное: Er <g>wird</g> Arzt. (Он станет врачом.)</td></tr><tr><th>3. Будущее время (Futur I)</th><td>+ инфинитив в конце: Ich <g>werde</g> morgen <g>kommen</g>. (Я приду завтра.)</td></tr></table><br><b>Примеры:</b><br>Mein Sohn <g>wird</g> bald Arzt. (Мой сын скоро станет врачом.)<br>Es <g>wird</g> dunkel. (Темнеет.)<br>Ich <g>werde</g> dich <g>anrufen</g>. (Я тебе позвоню.)"
    }
  },
  {
    "id": "verb_lassen",
    ...
    "rule": {
      ...
      "en": "<b>Conjugation (irregular):</b> ich lasse, du <g>lässt</g>, er/sie/es <g>lässt</g>, wir lassen, ihr lasst, sie/Sie lassen.<br><br><b>Two meanings:</b><br><table><tr><th>1. to leave (behind)</th><td>to leave something somewhere: Ich <g>lasse</g> das Auto zu Hause. (I'm leaving the car at home.)</td></tr><tr><th>2. to have (something) done</th><td>to have someone else do an action: Ich <g>lasse</g> mein Auto <g>reparieren</g>. (I'm having my car repaired.)</td></tr></table><br><b>Word order:</b> <g>lassen</g> in position 2, the second verb's infinitive right at the end.<br><br><b>Examples:</b><br>Ich <g>lasse</g> meinen Schlüssel im Büro. (I'm leaving my key at the office.)<br>Ich <g>lasse</g> mir die Haare <g>schneiden</g>. (I'm getting my hair cut.)",
      ...
      "ru": "<b>Спряжение (неправильный глагол):</b> ich lasse, du <g>lässt</g>, er/sie/es <g>lässt</g>, wir lassen, ihr lasst, sie/Sie lassen.<br><br><b>Два значения:</b><br><table><tr><th>1. оставлять</th><td>оставить что-то где-то: Ich <g>lasse</g> das Auto zu Hause. (Я оставляю машину дома.)</td></tr><tr><th>2. поручать</th><td>поручить кому-то выполнить действие вместо себя: Ich <g>lasse</g> mein Auto <g>reparieren</g>. (Я отдаю машину в ремонт.)</td></tr></table><br><b>Порядок слов:</b> <g>lassen</g> на 2-й позиции, инфинитив второго глагола — в самом конце.<br><br><b>Примеры:</b><br>Ich <g>lasse</g> meinen Schlüssel im Büro. (Я оставляю ключ в офисе.)<br>Ich <g>lasse</g> mir die Haare <g>schneiden</g>. (Я стригусь — в парикмахерской, а не сама.)"
    }
  },
  {
    ...
    "rule": {
      ...
      "en": "<b>Use:</b> <g>damit</g> expresses a goal/intention (What for? For what purpose?). Important: the subjects of the main and subordinate clauses are usually different.<br><br><b>Word order:</b> main clause, + <g>damit</g> + subject + ... + verb (end).<br><br><table><tr><th>Connector</th><th>When to use it</th></tr><tr><td><g>damit</g></td><td>two different subjects</td></tr><tr><td><g>um ... zu</g></td><td>the same subject in both clauses (+ infinitive, no separate verb)</td></tr></table><br><b>Examples:</b><br>Ich gebe dir Geld, <g>damit</g> du ein Buch <g>kaufst</g>. (ich ≠ du — I'm giving you money so you can buy a book.)<br>Compare: Ich lerne Deutsch, <g>um</g> einen Job <g>zu</g> finden. (same subject: ich — I'm learning German to find a job.)",
      ...
      "ru": "<b>Употребление:</b> <g>damit</g> выражает цель/намерение (Для чего? С какой целью?). Важно: подлежащие в главном и придаточном предложениях обычно разные.<br><br><b>Порядок слов:</b> главное предложение, + <g>damit</g> + подлежащее + ... + глагол (в конце).<br><br><table><tr><th>Союз</th><th>Когда использовать?</th></tr><tr><td><g>damit</g></td><td>два разных подлежащих</td></tr><tr><td><g>um ... zu</g></td><td>одинаковое подлежащее в обеих частях (+ инфинитив, без собственного глагола)</td></tr></table><br><b>Примеры:</b><br>Ich gebe dir Geld, <g>damit</g> du ein Buch <g>kaufst</g>. (я ≠ ты — Я даю тебе деньги, чтобы ты купил книгу.)<br>Сравнение: Ich lerne Deutsch, <g>um</g> einen Job <g>zu</g> finden. (одинаковое подлежащее: я — Я учу немецкий, чтобы найти работу.)"
    }
  },
  {
    ...
    "rule": {
      ...
      "en": "<b>Structure:</b> polite introduction (Können Sie mir sagen...? / Ich weiß nicht,...) + question word + subject + ... + verb (end).<br><br><table><tr><th>Direct question</th><th>Indirect question</th></tr><tr><td>Wo ist der Bahnhof?</td><td>Können Sie mir sagen, wo der Bahnhof <g>ist</g>?</td></tr><tr><td>Wann kommt der Zug?</td><td>Wissen Sie, wann der Zug <g>kommt</g>?</td></tr></table><br><b>Typical introductions:</b> Können Sie mir sagen...? (Can you tell me...?) Wissen Sie...? (Do you know...?) Ich möchte wissen,... (I'd like to know...) Ich weiß nicht,... (I don't know...)<br><br><b>Examples:</b><br>Können Sie mir sagen, <g>wo</g> der Bahnhof <g>ist</g>? (Can you tell me where the station is?)<br>Ich weiß nicht, <g>wie</g> das <g>funktioniert</g>. (I don't know how this works.)",
      ...
      "ru": "<b>Структура:</b> вежливое вводное предложение (Können Sie mir sagen...? / Ich weiß nicht,...) + вопросительное слово + подлежащее + ... + глагол (в конце).<br><br><table><tr><th>Прямой вопрос</th><th>Косвенный вопрос</th></tr><tr><td>Wo ist der Bahnhof?</td><td>Können Sie mir sagen, wo der Bahnhof <g>ist</g>?</td></tr><tr><td>Wann kommt der Zug?</td><td>Wissen Sie, wann der Zug <g>kommt</g>?</td></tr></table><br><b>Типичные вводные фразы:</b> Können Sie mir sagen...? (Не могли бы вы мне сказать...?) Wissen Sie...? (Вы знаете...?) Ich möchte wissen,... (Я хотел бы знать,...) Ich weiß nicht,... (Я не знаю,...)<br><br><b>Примеры:</b><br>Können Sie mir sagen, <g>wo</g> der Bahnhof <g>ist</g>? (Не могли бы вы сказать, где вокзал?)<br>Ich weiß nicht, <g>wie</g> das <g>funktioniert</g>. (Я не знаю, как это работает.)"
    }
  },
  {
    ...
    "rule": {
      "de": "<b>Struktur:</b> höfliche Einleitung + <g>ob</g> + Subjekt + ... + Verb (Ende). Wird verwendet, wenn die direkte Frage keine W-Frage ist (Ja/Nein-Frage).<br><br><table><tr><th>Direkte Frage (Ja/Nein)</th><th>Indirekte Frage mit ob</th></tr><tr><td>Kommt er heute?</td><td>Ich weiß nicht, ob er heute <g>kommt</g>.</td></tr><tr><td>Hast du Zeit?</td><td>Ich frage mich, ob du Zeit <g>hast</g>.</td></tr></table><br><b>Unterschied zu Fragewort-Fragen:</b> Bei W-Fragen (wo, wann, wie...) bleibt das Fragewort; bei Ja/Nein-Fragen ersetzt <g>ob</g> das fehlende Fragewort.<br><br><b>Beispiel:</b> Ich weiß nicht, <g>ob</g> er heute <g>kommt</g>.",
      "en": "<b>Structure:</b> polite introduction + <g>ob</g> + subject + ... + verb (end). Used when the direct question has no question word (a yes/no question).<br><br><table><tr><th>Direct question (yes/no)</th><th>Indirect question with ob</th></tr><tr><td>Kommt er heute?</td><td>Ich weiß nicht, ob er heute <g>kommt</g>.</td></tr><tr><td>Hast du Zeit?</td><td>Ich frage mich, ob du Zeit <g>hast</g>.</td></tr></table><br><b>Difference from question-word questions:</b> with W-questions (wo, wann, wie...) the question word stays; with yes/no questions, <g>ob</g> (whether/if) replaces the missing question word.<br><br><b>Example:</b> Ich weiß nicht, <g>ob</g> er heute <g>kommt</g>. (I don't know whether he's coming today.)",
      "uk": "<b>Структура:</b> ввічливе вступне речення + <g>ob</g> + підмет + ... + дієслово (у кінці). Вживається, коли пряме питання не має питального слова (загальне питання із відповіддю Так/Ні).<br><br><table><tr><th>Пряме питання (Так/Ні)</th><th>Непряме питання з ob</th></tr><tr><td>Kommt er heute?</td><td>Ich weiß nicht, ob er heute <g>kommt</g>.</td></tr><tr><td>Hast du Zeit?</td><td>Ich frage mich, ob du Zeit <g>hast</g>.</td></tr></table><br><b>Відмінність від питань з питальним словом:</b> у W-питаннях (wo, wann, wie...) питальне слово залишається; у загальних питаннях <g>ob</g> (чи) замінює відсутнє питальне слово.<br><br><b>Приклад:</b> Ich weiß nicht, <g>ob</g> er heute <g>kommt</g>. (Я не знаю, чи він прийде сьогодні.)",
      "ru": "<b>Структура:</b> вежливое вводное предложение + <g>ob</g> + подлежащее + ... + глагол (в конце). Используется, когда прямой вопрос не имеет вопросительного слова (общий вопрос с ответом Да/Нет).<br><br><table><tr><th>Прямой вопрос (Да/Нет)</th><th>Косвенный вопрос с ob</th></tr><tr><td>Kommt er heute?</td><td>Ich weiß nicht, ob er heute <g>kommt</g>.</td></tr><tr><td>Hast du Zeit?</td><td>Ich frage mich, ob du Zeit <g>hast</g>.</td></tr></table><br><b>Отличие от вопросов с вопросительным словом:</b> в W-вопросах (wo, wann, wie...) вопросительное слово сохраняется; в общих вопросах <g>ob</g> (ли) заменяет отсутствующее вопросительное слово.<br><br><b>Пример:</b> Ich weiß nicht, <g>ob</g> er heute <g>kommt</g>. (Я не знаю, придёт ли он сегодня.)"
    }
  },
  {
    ...
    "rule": {
      "de": "<b>Zusammenfassung der neun Wechselpräpositionen:</b> <g>an, auf, hinter, in, neben, über, unter, vor, zwischen</g>.<br><br><table><tr><th>Frage</th><th>Kasus</th></tr><tr><td>Wohin? (Bewegung)</td><td><g>Akkusativ</g></td></tr><tr><td>Wo? (Position)</td><td><g>Dativ</g></td></tr></table><br><b>Test:</b> Kann man die Frage mit 'Wohin bewegt sich etwas?' beantworten → Akkusativ. Kann man mit 'Wo befindet es sich?' antworten → Dativ.<br><br><b>Beispiele:</b><br>Stell das Glas <g>auf den</g> Tisch. (Akk. — Bewegung: ich stelle es hin)<br>Das Glas steht <g>auf dem</g> Tisch. (Dat. — Position: es steht schon da)<br>Ich lege das Buch <g>in die</g> Tasche. / Das Buch liegt <g>in der</g> Tasche.",
      "en": "<b>Summary of the nine two-way prepositions:</b> <g>an, auf, hinter, in, neben, über, unter, vor, zwischen</g>.<br><br><table><tr><th>Question</th><th>Case</th></tr><tr><td>Where to? (motion)</td><td><g>Accusative</g></td></tr><tr><td>Where? (position)</td><td><g>Dative</g></td></tr></table><br><b>Quick test:</b> if you can answer with 'Where is something moving to?' → Accusative. If you can answer with 'Where is it located?' → Dative.<br><br><b>Examples:</b><br>Stell das Glas <g>auf den</g> Tisch. (Acc. — motion: I'm putting it there)<br>Das Glas steht <g>auf dem</g> Tisch. (Dat. — position: it's already standing there)<br>Ich lege das Buch <g>in die</g> Tasche. (I'm putting the book in the bag.) / Das Buch liegt <g>in der</g> Tasche. (The book is lying in the bag.)",
      "uk": "<b>Підсумок девʼяти прийменників подвійного керування:</b> <g>an, auf, hinter, in, neben, über, unter, vor, zwischen</g>.<br><br><table><tr><th>Питання</th><th>Відмінок</th></tr><tr><td>Куди? (рух)</td><td><g>Знахідний</g></td></tr><tr><td>Де? (положення)</td><td><g>Давальний</g></td></tr></table><br><b>Перевірка:</b> якщо на питання можна відповісти 'Куди рухається предмет?' → знахідний відмінок. Якщо відповідь 'Де він знаходиться?' → давальний відмінок.<br><br><b>Приклади:</b><br>Stell das Glas <g>auf den</g> Tisch. (Знахідний — рух: я ставлю склянку)<br>Das Glas steht <g>auf dem</g> Tisch. (Давальний — положення: вона вже стоїть)<br>Ich lege das Buch <g>in die</g> Tasche. (Я кладу книгу в сумку.) / Das Buch liegt <g>in der</g> Tasche. (Книга лежить у сумці.)",
      "ru": "<b>Итог по девяти предлогам двойного управления:</b> <g>an, auf, hinter, in, neben, über, unter, vor, zwischen</g>.<br><br><table><tr><th>Вопрос</th><th>Падеж</th></tr><tr><td>Куда? (движение)</td><td><g>Винительный</g></td></tr><tr><td>Где? (положение)</td><td><g>Дательный</g></td></tr></table><br><b>Проверка:</b> если на вопрос можно ответить 'Куда движется предмет?' → винительный падеж. Если ответ 'Где он находится?' → дательный падеж.<br><br><b>Примеры:</b><br>Stell das Glas <g>auf den</g> Tisch. (Винительный — движение: я ставлю стакан)<br>Das Glas steht <g>auf dem</g> Tisch. (Дательный — положение: он уже стоит)<br>Ich lege das Buch <g>in die</g> Tasche. (Я кладу книгу в сумку.) / Das Buch liegt <g>in der</g> Tasche. (Книга лежит в сумке.)"
    }
  },
  {
    ...
    "rule": {
      "de": "<b>Zusammenfassung:</b><br><table><tr><th>Nominativ</th><th>Akkusativ</th><th>Dativ</th></tr><tr><td>ich</td><td>mich</td><td>mir</td></tr><tr><td>du</td><td>dich</td><td>dir</td></tr><tr><td>er</td><td>ihn</td><td>ihm</td></tr><tr><td>sie</td><td>sie</td><td>ihr</td></tr><tr><td>es</td><td>es</td><td>ihm</td></tr><tr><td>wir</td><td>uns</td><td>uns</td></tr><tr><td>ihr</td><td>euch</td><td>euch</td></tr><tr><td>sie/Sie</td><td>sie/Sie</td><td>ihnen/Ihnen</td></tr></table><br><b>Merksatz:</b> Akkusativ = Wen/Was? (direktes Objekt). Dativ = Wem? (indirektes Objekt).<br><br><b>Beispiele:</b><br>Ich sehe <g>ihn</g>. (Akk.)<br>Ich gebe <g>ihm</g> das Buch. (Dativ)",
      "en": "<b>Summary:</b><br><table><tr><th>Nominative</th><th>Accusative</th><th>Dative</th></tr><tr><td>ich</td><td>mich</td><td>mir</td></tr><tr><td>du</td><td>dich</td><td>dir</td></tr><tr><td>er</td><td>ihn</td><td>ihm</td></tr><tr><td>sie</td><td>sie</td><td>ihr</td></tr><tr><td>es</td><td>es</td><td>ihm</td></tr><tr><td>wir</td><td>uns</td><td>uns</td></tr><tr><td>ihr</td><td>euch</td><td>euch</td></tr><tr><td>sie/Sie</td><td>sie/Sie</td><td>ihnen/Ihnen</td></tr></table><br><b>Rule of thumb:</b> Accusative = Whom/What? (direct object). Dative = To whom? (indirect object).<br><br><b>Examples:</b><br>Ich sehe <g>ihn</g>. (Acc. — I see him.)<br>Ich gebe <g>ihm</g> das Buch. (Dative — I'm giving him the book.)",
      "uk": "<b>Підсумок:</b><br><table><tr><th>Називний</th><th>Знахідний</th><th>Давальний</th></tr><tr><td>ich</td><td>mich</td><td>mir</td></tr><tr><td>du</td><td>dich</td><td>dir</td></tr><tr><td>er</td><td>ihn</td><td>ihm</td></tr><tr><td>sie</td><td>sie</td><td>ihr</td></tr><tr><td>es</td><td>es</td><td>ihm</td></tr><tr><td>wir</td><td>uns</td><td>uns</td></tr><tr><td>ihr</td><td>euch</td><td>euch</td></tr><tr><td>sie/Sie</td><td>sie/Sie</td><td>ihnen/Ihnen</td></tr></table><br><b>Для запамʼятовування:</b> знахідний = Кого/Що? (прямий додаток). Давальний = Кому? (непрямий додаток).<br><br><b>Приклади:</b><br>Ich sehe <g>ihn</g>. (Знахідний — Я його бачу.)<br>Ich gebe <g>ihm</g> das Buch. (Давальний — Я даю йому книгу.)",
      "ru": "<b>Итог:</b><br><table><tr><th>Именительный</th><th>Винительный</th><th>Дательный</th></tr><tr><td>ich</td><td>mich</td><td>mir</td></tr><tr><td>du</td><td>dich</td><td>dir</td></tr><tr><td>er</td><td>ihn</td><td>ihm</td></tr><tr><td>sie</td><td>sie</td><td>ihr</td></tr><tr><td>es</td><td>es</td><td>ihm</td></tr><tr><td>wir</td><td>uns</td><td>uns</td></tr><tr><td>ihr</td><td>euch</td><td>euch</td></tr><tr><td>sie/Sie</td><td>sie/Sie</td><td>ihnen/Ihnen</td></tr></table><br><b>Для запоминания:</b> винительный = Кого/Что? (прямое дополнение). Дательный = Кому? (косвенное дополнение).<br><br><b>Примеры:</b><br>Ich sehe <g>ihn</g>. (Винительный — Я его вижу.)<br>Ich gebe <g>ihm</g> das Buch. (Дательный — Я даю ему книгу.)"
    }
  },
  {
    ...
    "rule": {
      "de": "<b>Zusammenfassung der wichtigsten Konnektoren:</b><br><table><tr><th>Konnektor</th><th>Bedeutung</th></tr><tr><td><g>weil</g></td><td>Grund (warum?)</td></tr><tr><td><g>dass</g></td><td>Inhalt/Objekt (was?)</td></tr><tr><td><g>wenn</g></td><td>Bedingung/Wiederholung</td></tr><tr><td><g>ob</g></td><td>indirekte Ja/Nein-Frage</td></tr><tr><td><g>damit</g></td><td>Ziel/Zweck</td></tr></table><br><b>Gemeinsame Regel:</b> In allen Nebensätzen mit diesen Konnektoren steht das konjugierte Verb ganz am Ende des Satzes.<br><br><b>Beispiele:</b><br>Ich denke, <g>dass</g> das wichtig <g>ist</g>.<br>Ich bleibe zu Hause, <g>weil</g> ich krank <g>bin</g>.<br>Ich weiß nicht, <g>ob</g> er <g>kommt</g>.",
      "en": "<b>Summary of the main connectors:</b><br><table><tr><th>Connector</th><th>Meaning</th></tr><tr><td><g>weil</g></td><td>reason (why?)</td></tr><tr><td><g>dass</g></td><td>content/object (what?)</td></tr><tr><td><g>wenn</g></td><td>condition/repetition</td></tr><tr><td><g>ob</g></td><td>indirect yes/no question</td></tr><tr><td><g>damit</g></td><td>goal/purpose</td></tr></table><br><b>Shared rule:</b> in all subordinate clauses with these connectors, the conjugated verb goes right to the end of the sentence.<br><br><b>Examples:</b><br>Ich denke, <g>dass</g> das wichtig <g>ist</g>. (I think that's important.)<br>Ich bleibe zu Hause, <g>weil</g> ich krank <g>bin</g>. (I'm staying home because I'm sick.)<br>Ich weiß nicht, <g>ob</g> er <g>kommt</g>. (I don't know if he's coming.)",
      "uk": "<b>Підсумок основних сполучників:</b><br><table><tr><th>Сполучник</th><th>Значення</th></tr><tr><td><g>weil</g></td><td>причина (чому?)</td></tr><tr><td><g>dass</g></td><td>зміст/додаток (що?)</td></tr><tr><td><g>wenn</g></td><td>умова/повторення</td></tr><tr><td><g>ob</g></td><td>непряме загальне питання (чи)</td></tr><tr><td><g>damit</g></td><td>мета/ціль</td></tr></table><br><b>Спільне правило:</b> у всіх підрядних реченнях з цими сполучниками змінюване дієслово стоїть у самому кінці речення.<br><br><b>Приклади:</b><br>Ich denke, <g>dass</g> das wichtig <g>ist</g>. (Я думаю, що це важливо.)<br>Ich bleibe zu Hause, <g>weil</g> ich krank <g>bin</g>. (Я залишаюсь вдома, тому що я хворію.)<br>Ich weiß nicht, <g>ob</g> er <g>kommt</g>. (Я не знаю, чи він прийде.)",
      "ru": "<b>Итог по основным союзам:</b><br><table><tr><th>Союз</th><th>Значение</th></tr><tr><td><g>weil</g></td><td>причина (почему?)</td></tr><tr><td><g>dass</g></td><td>содержание/дополнение (что?)</td></tr><tr><td><g>wenn</g></td><td>условие/повторение</td></tr><tr><td><g>ob</g></td><td>косвенный общий вопрос (ли)</td></tr><tr><td><g>damit</g></td><td>цель</td></tr></table><br><b>Общее правило:</b> во всех придаточных предложениях с этими союзами спрягаемый глагол стоит в самом конце предложения.<br><br><b>Примеры:</b><br>Ich denke, <g>dass</g> das wichtig <g>ist</g>. (Я думаю, что это важно.)<br>Ich bleibe zu Hause, <g>weil</g> ich krank <g>bin</g>. (Я остаюсь дома, потому что болею.)<br>Ich weiß nicht, <g>ob</g> er <g>kommt</g>. (Я не знаю, придёт ли он.)"
    }
  },
  {
    ...
    "rule": {
      "de": "<b>Zusammenfassung nach 'ein/mein/dein...':</b><br><table><tr><th></th><th>maskulin</th><th>feminin</th><th>neutral</th><th>Plural</th></tr><tr><td>Nominativ</td><td>-er</td><td>-e</td><td>-es</td><td>-en</td></tr><tr><td>Akkusativ</td><td>-en</td><td>-e</td><td>-es</td><td>-en</td></tr><tr><td>Dativ</td><td>-en</td><td>-en</td><td>-en</td><td>-en</td></tr></table><br><b>Merksatz:</b> Nur im Nominativ zeigt das Adjektiv das Genus deutlich (-er/-e/-es), weil 'ein' selbst kein Signal zeigt. In allen anderen Fällen: meistens <g>-en</g>.<br><br><b>Beispiele:</b><br>ein <g>alter</g> Freund. (Nom. mask.)<br>eine <g>alte</g> Freundin. (Nom. fem.)<br>mit einem <g>alten</g> Freund. (Dativ)",
      "en": "<b>Summary of endings after 'ein/mein/dein...':</b><br><table><tr><th></th><th>masculine</th><th>feminine</th><th>neuter</th><th>plural</th></tr><tr><td>Nominative</td><td>-er</td><td>-e</td><td>-es</td><td>-en</td></tr><tr><td>Accusative</td><td>-en</td><td>-e</td><td>-es</td><td>-en</td></tr><tr><td>Dative</td><td>-en</td><td>-en</td><td>-en</td><td>-en</td></tr></table><br><b>Rule of thumb:</b> only in the nominative does the adjective clearly show the gender (-er/-e/-es), because 'ein' itself gives no signal. In all other cases: mostly <g>-en</g>.<br><br><b>Examples:</b><br>ein <g>alter</g> Freund. (Nom. masc. — an old friend.)<br>eine <g>alte</g> Freundin. (Nom. fem. — an old friend, female.)<br>mit einem <g>alten</g> Freund. (Dative — with an old friend.)",
      "uk": "<b>Підсумок закінчень після 'ein/mein/dein...':</b><br><table><tr><th></th><th>чол. рід</th><th>жін. рід</th><th>сер. рід</th><th>множина</th></tr><tr><td>Називний</td><td>-er</td><td>-e</td><td>-es</td><td>-en</td></tr><tr><td>Знахідний</td><td>-en</td><td>-e</td><td>-es</td><td>-en</td></tr><tr><td>Давальний</td><td>-en</td><td>-en</td><td>-en</td><td>-en</td></tr></table><br><b>Для запамʼятовування:</b> лише в називному відмінку прикметник чітко показує рід (-er/-e/-es), бо саме 'ein' не дає такого сигналу. У всіх інших випадках — здебільшого <g>-en</g>.<br><br><b>Приклади:</b><br>ein <g>alter</g> Freund. (Називний, чол. рід — старий друг.)<br>eine <g>alte</g> Freundin. (Називний, жін. рід — стара подруга.)<br>mit einem <g>alten</g> Freund. (Давальний — зі старим другом.)",
      "ru": "<b>Итог по окончаниям после 'ein/mein/dein...':</b><br><table><tr><th></th><th>муж. род</th><th>жен. род</th><th>ср. род</th><th>множ.</th></tr><tr><td>Именительный</td><td>-er</td><td>-e</td><td>-es</td><td>-en</td></tr><tr><td>Винительный</td><td>-en</td><td>-e</td><td>-es</td><td>-en</td></tr><tr><td>Дательный</td><td>-en</td><td>-en</td><td>-en</td><td>-en</td></tr></table><br><b>Для запоминания:</b> только в именительном падеже прилагательное чётко показывает род (-er/-e/-es), поскольку само 'ein' такого сигнала не даёт. Во всех остальных случаях — в основном <g>-en</g>.<br><br><b>Примеры:</b><br>ein <g>alter</g> Freund. (Именительный, муж. род — старый друг.)<br>eine <g>alte</g> Freundin. (Именительный, жен. род — старая подруга.)<br>mit einem <g>alten</g> Freund. (Дательный — со старым другом.)"
    }
  },
  {
    "id": "dass_satz_wdh",
    ...
    "explanation": {
      ...
      "uk": "Повторення: сполучник <g>dass</g> вводить підрядне зʼясувальне речення. Дієслово стоїть у самому кінці. Часто вживається після виразів: Ich finde, <g>dass</g>... / Es ist gut, <g>dass</g>...<br>Приклад: Es ist gut, <g>dass</g> du hier <g>bist</g>.",
    ...
    "rule": {
      "de": "<b>Zusammenfassung:</b> <g>dass</g> leitet einen Nebensatz ein, das konjugierte Verb steht am Ende. Häufig nach Meinungs- und Gefühlsausdrücken.<br><br><table><tr><th>Ausdruck</th><th>Beispiel</th></tr><tr><td>Ich finde, dass...</td><td>Ich finde, <g>dass</g> das gut <g>ist</g>.</td></tr><tr><td>Es ist gut/schön, dass...</td><td>Es ist gut, <g>dass</g> du hier <g>bist</g>.</td></tr><tr><td>Ich hoffe, dass...</td><td>Ich hoffe, <g>dass</g> es <g>klappt</g>.</td></tr></table><br><b>Achtung:</b> Bei zwei Verben (Modalverb, Perfekt) stehen beide am Ende, das konjugierte Verb ganz zuletzt: Ich finde, dass er das gut gemacht <g>hat</g>.<br><br><b>Beispiel:</b> Es ist gut, <g>dass</g> du hier <g>bist</g>.",
      "en": "<b>Summary:</b> <g>dass</g> introduces a subordinate clause, the conjugated verb goes at the end. Often used after expressions of opinion and feeling.<br><br><table><tr><th>Expression</th><th>Example</th></tr><tr><td>Ich finde, dass... (I think that...)</td><td>Ich finde, <g>dass</g> das gut <g>ist</g>.</td></tr><tr><td>Es ist gut/schön, dass... (It's good/nice that...)</td><td>Es ist gut, <g>dass</g> du hier <g>bist</g>.</td></tr><tr><td>Ich hoffe, dass... (I hope that...)</td><td>Ich hoffe, <g>dass</g> es <g>klappt</g>.</td></tr></table><br><b>Note:</b> with two verbs (modal verb, Perfekt), both go to the end, with the conjugated verb last: Ich finde, dass er das gut gemacht <g>hat</g>.<br><br><b>Example:</b> Es ist gut, <g>dass</g> du hier <g>bist</g>. (It's good that you're here.)",
      "uk": "<b>Підсумок:</b> сполучник <g>dass</g> вводить підрядне речення, змінюване дієслово стоїть у кінці. Часто вживається після виразів думки та почуттів.<br><br><table><tr><th>Вираз</th><th>Приклад</th></tr><tr><td>Ich finde, dass... (я вважаю, що...)</td><td>Ich finde, <g>dass</g> das gut <g>ist</g>.</td></tr><tr><td>Es ist gut/schön, dass... (добре, що...)</td><td>Es ist gut, <g>dass</g> du hier <g>bist</g>.</td></tr><tr><td>Ich hoffe, dass... (сподіваюсь, що...)</td><td>Ich hoffe, <g>dass</g> es <g>klappt</g>.</td></tr></table><br><b>Увага:</b> якщо в реченні два дієслова (модальне дієслово, Perfekt), обидва йдуть у кінець, а змінюване дієслово — останнім: Ich finde, dass er das gut gemacht <g>hat</g>.<br><br><b>Приклад:</b> Es ist gut, <g>dass</g> du hier <g>bist</g>. (Добре, що ти тут.)",
      "ru": "<b>Итог:</b> союз <g>dass</g> вводит придаточное предложение, спрягаемый глагол стоит в конце. Часто употребляется после выражений мнения и чувств.<br><br><table><tr><th>Выражение</th><th>Пример</th></tr><tr><td>Ich finde, dass... (я считаю, что...)</td><td>Ich finde, <g>dass</g> das gut <g>ist</g>.</td></tr><tr><td>Es ist gut/schön, dass... (хорошо, что...)</td><td>Es ist gut, <g>dass</g> du hier <g>bist</g>.</td></tr><tr><td>Ich hoffe, dass... (надеюсь, что...)</td><td>Ich hoffe, <g>dass</g> es <g>klappt</g>.</td></tr></table><br><b>Внимание:</b> если в предложении два глагола (модальный глагол, Perfekt), оба идут в конец, а спрягаемый глагол — последним: Ich finde, dass er das gut gemacht <g>hat</g>.<br><br><b>Пример:</b> Es ist gut, <g>dass</g> du hier <g>bist</g>. (Хорошо, что ты здесь.)"
    }
  }
];
...
var VOCAB = [
  ...
  {"id":"k1_024","cat":"k1","term":{"de":"weil","en":"because","uk":"тому що","ru":"потому что"},"short":{"de": "ein kleines Wort, mit dem man einen Grund nennt","en": "a small word used to give a reason","uk": "коротке слово, яким називають причину","ru": "короткое слово, которым называют причину"},"def":{"de":"Sie hilft ihm gern, <g><b>weil</b></g> er noch neu im Team ist.","en":"She likes to help him <g><b>because</b></g> he is still new to the team.","uk":"Вона залюбки допомагає йому, <g><b>тому що</b></g> він ще новенький у команді.","ru":"Она с удовольствием помогает ему, <g><b>потому что</b></g> он ещё новенький в команде."},"gram":"weil_satz"},
  ...
  {"id":"k2_031","cat":"k2","term":{"de":"das Sofa","en":"sofa / couch","uk":"диван","ru":"диван"},"short":{"de": "ein weiches Möbelstück zum Sitzen für mehrere Personen","en": "a soft piece of furniture for several people to sit on","uk": "мʼякі меблі, на яких можуть сидіти кілька людей","ru": "мягкая мебель, на которой могут сидеть несколько человек"},"def":{"de":"Die Katze liegt gern <g>auf dem <b>Sofa</b></g> im Wohnzimmer.","en":"The cat likes to lie <g>on the <b>sofa</b></g> in the living room.","uk":"Кіт любить лежати <g>на <b>дивані</b></g> у вітальні.","ru":"Кот любит лежать <g>на <b>диване</b></g> в гостиной."},"gram":"wechselpraepositionen"},
  ...
  {"id":"k16_021","cat":"k16","term":{"de":"der Geburtstag","en":"birthday","uk":"день народження","ru":"день рождения"},"short":{"de": "der Tag im Jahr, an dem eine Person geboren wurde","en": "the day of the year a person was born","uk": "день у році, коли людина народилася","ru": "день в году, когда человек родился"},"def":{"de":"Wir feiern seinen <b>Geburtstag</b> groß, <g>weil</g> er fünfzig Jahre alt wird.","en":"We are celebrating his <b>birthday</b> in a big way <g>because</g> he is turning fifty.","uk":"Ми відзначаємо його <b>день народження</b> з розмахом, <g>тому що</g> йому виповнюється пʼятдесят.","ru":"Мы отмечаем его <b>день рождения</b> с размахом, <g>потому что</g> ему исполняется пятьдесят."},"gram":"nebensaetze_konnektoren_wdh"},
  {"id":"k16_022","cat":"k16","term":{"de":"das Geschenk","en":"gift","uk":"подарунок","ru":"подарок"},"short":{"de": "etwas, das man jemandem zu einem besonderen Anlass gibt","en": "something you give someone on a special occasion","uk": "те, що даруєш комусь з особливої нагоди","ru": "то, что даришь кому-то по особому случаю"},"def":{"de":"Sie kauft ein <b>Geschenk</b>, <g>obwohl</g> sie noch keine Ahnung hat, was ihm gefällt.","en":"She is buying a <b>gift</b>, <g>although</g> she has no idea yet what he likes.","uk":"Вона купує <b>подарунок</b>, <g>хоча</g> ще не знає, що йому сподобається.","ru":"Она покупает <b>подарок</b>, <g>хотя</g> ещё не знает, что ему понравится."},"gram":"nebensaetze_konnektoren_wdh"},
  {"id":"k16_023","cat":"k16","term":{"de":"schenken","en":"to give (as a gift)","uk":"дарувати","ru":"дарить"},"short":{"de": "jemandem etwas geben, ohne dafür Geld zu bekommen, meistens zu einem Anlass","en": "to give someone something without receiving money for it, usually for an occasion","uk": "давати комусь щось безкоштовно, зазвичай з нагоди","ru": "давать кому-то что-то бесплатно, обычно по случаю"},"def":{"de":"Er <b>schenkt</b> ihr Blumen, <g>weil</g> sie heute Geburtstag hat.","en":"He <b>gives</b> her flowers <g>because</g> today is her birthday.","uk":"Він <b>дарує</b> їй квіти, <g>тому що</g> сьогодні в неї день народження.","ru":"Он <b>дарит</b> ей цветы, <g>потому что</g> сегодня у неё день рождения."},"gram":"nebensaetze_konnektoren_wdh"},
  {"id":"k16_024","cat":"k16","term":{"de":"die Überraschung","en":"surprise","uk":"сюрприз","ru":"сюрприз"},"short":{"de": "etwas Unerwartetes, das große Freude macht","en": "something unexpected that brings great joy","uk": "щось несподіване, що приносить велику радість","ru": "что-то неожиданное, что приносит большую радость"},"def":{"de":"Die <b>Überraschung</b> gelingt gut, <g>weil</g> niemand von der Party weiß.","en":"The <b>surprise</b> works well <g>because</g> nobody knows about the party.","uk":"<b>Сюрприз</b> вдається добре, <g>тому що</g> ніхто не знає про вечірку.","ru":"<b>Сюрприз</b> удаётся хорошо, <g>потому что</g> никто не знает о вечеринке."},"gram":"nebensaetze_konnektoren_wdh"},
  {"id":"k16_025","cat":"k16","term":{"de":"dekorieren","en":"to decorate","uk":"прикрашати","ru":"украшать"},"short":{"de": "einen Raum oder Ort schön machen, meistens für ein Fest","en": "to make a room or place look nice, usually for an event","uk": "робити приміщення чи місце гарним, зазвичай для свята","ru": "делать помещение или место красивым, обычно для праздника"},"def":{"de":"Sie <b>dekorieren</b> den Saal bunt, <g>damit</g> die Feier festlich aussieht.","en":"They <b>decorate</b> the hall colorfully <g>so that</g> the celebration looks festive.","uk":"Вони яскраво <b>прикрашають</b> зал, <g>щоб</g> святкування виглядало урочисто.","ru":"Они ярко <b>украшают</b> зал, <g>чтобы</g> торжество выглядело празднично."},"gram":"nebensaetze_konnektoren_wdh"},
  {"id":"k16_026","cat":"k16","term":{"de":"der Kuchen","en":"cake","uk":"пиріг","ru":"пирог"},"short":{"de": "eine süße Backware, die man oft zu Festen isst","en": "a sweet baked item often eaten at celebrations","uk": "солодка випічка, яку часто їдять на святах","ru": "сладкая выпечка, которую часто едят на праздниках"},"def":{"de":"Sie backt einen <b>Kuchen</b>, <g>weil</g> heute ihr Geburtstag ist.","en":"She is baking a <b>cake</b> <g>because</g> today is her birthday.","uk":"Вона пече <b>пиріг</b>, <g>тому що</g> сьогодні в неї день народження.","ru":"Она печёт <b>пирог</b>, <g>потому что</g> сегодня у неё день рождения."},"gram":"nebensaetze_konnektoren_wdh"},
  {"id":"k16_027","cat":"k16","term":{"de":"die Kerze","en":"candle","uk":"свічка","ru":"свеча"},"short":{"de": "ein Stück Wachs mit einem Docht, das man anzündet","en": "a piece of wax with a wick that you light","uk": "шматок воску з ґнотом, який запалюють","ru": "кусок воска с фитилём, который зажигают"},"def":{"de":"Sie zündet fünf <b>Kerzen</b> an, <g>weil</g> das Kind fünf Jahre alt wird.","en":"She lights five <b>candles</b> <g>because</g> the child is turning five.","uk":"Вона запалює пʼять <b>свічок</b>, <g>тому що</g> дитині виповнюється пʼять років.","ru":"Она зажигает пять <b>свечей</b>, <g>потому что</g> ребёнку исполняется пять лет."},"gram":"nebensaetze_konnektoren_wdh"},
  {"id":"k16_028","cat":"k16","term":{"de":"der Gast","en":"guest","uk":"гість","ru":"гость"},"short":{"de": "eine Person, die zu einem Fest oder Treffen eingeladen ist","en": "a person who is invited to a party or meeting","uk": "людина, яку запросили на свято чи зустріч","ru": "человек, которого пригласили на праздник или встречу"},"def":{"de":"Jeder <b>Gast</b> bringt etwas mit, <g>weil</g> das bei ihnen so Tradition ist.","en":"Every <b>guest</b> brings something <g>because</g> that is their tradition.","uk":"Кожен <b>гість</b> щось приносить, <g>тому що</g> в них це традиція.","ru":"Каждый <b>гость</b> что-то приносит, <g>потому что</g> у них это традиция."},"gram":"nebensaetze_konnektoren_wdh"},
  {"id":"k16_029","cat":"k16","term":{"de":"der Brauch","en":"custom","uk":"звичай","ru":"обычай"},"short":{"de": "etwas, das man in einer Kultur schon lange auf eine bestimmte Art macht","en": "something that has been done in a certain way in a culture for a long time","uk": "те, що в культурі роблять певним чином вже давно","ru": "то, что в культуре делают определённым образом уже давно"},"def":{"de":"Dieser <b>Brauch</b> ist sehr alt, <g>obwohl</g> ihn heute nur wenige Familien pflegen.","en":"This <b>custom</b> is very old, <g>although</g> only a few families keep it today.","uk":"Цей <b>звичай</b> дуже давній, <g>хоча</g> сьогодні його дотримуються лише кілька родин.","ru":"Этот <b>обычай</b> очень старый, <g>хотя</g> сегодня его придерживаются лишь немногие семьи."},"gram":"nebensaetze_konnektoren_wdh"},
  {"id":"k16_030","cat":"k16","term":{"de":"das Ritual","en":"ritual","uk":"ритуал","ru":"ритуал"},"short":{"de": "eine feste Handlung, die man immer auf die gleiche Weise wiederholt","en": "a fixed action that is always repeated in the same way","uk": "усталена дія, яку завжди повторюють однаково","ru": "устоявшееся действие, которое всегда повторяют одинаково"},"def":{"de":"Das <b>Ritual</b> wiederholt sich jedes Jahr, <g>weil</g> es fest zur Feier gehört.","en":"The <b>ritual</b> repeats every year <g>because</g> it is a fixed part of the celebration.","uk":"<b>Ритуал</b> повторюється щороку, <g>тому що</g> він є невідʼємною частиною свята.","ru":"<b>Ритуал</b> повторяется каждый год, <g>потому что</g> он является неотъемлемой частью праздника."},"gram":"nebensaetze_konnektoren_wdh"},
  {"id":"k16_031","cat":"k16","term":{"de":"der Karneval","en":"carnival","uk":"карнавал","ru":"карнавал"},"short":{"de": "ein buntes Fest mit Kostümen und Musik, meistens im Februar","en": "a colorful festival with costumes and music, usually in February","uk": "барвисте свято з костюмами та музикою, зазвичай у лютому","ru": "яркий праздник с костюмами и музыкой, обычно в феврале"},"def":{"de":"Viele Menschen kommen zum <b>Karneval</b>, <g>weil</g> die Kostüme so bunt sind.","en":"Many people come to the <b>carnival</b> <g>because</g> the costumes are so colorful.","uk":"Багато людей приходять на <b>карнавал</b>, <g>тому що</g> костюми такі яскраві.","ru":"Многие люди приходят на <b>карнавал</b>, <g>потому что</g> костюмы такие яркие."},"gram":"nebensaetze_konnektoren_wdh"},
  {"id":"k16_032","cat":"k16","term":{"de":"das Feuerwerk","en":"fireworks","uk":"феєрверк","ru":"фейерверк"},"short":{"de": "bunte Lichter am Himmel, die man an Silvester oder bei Festen sieht","en": "colorful lights in the sky seen at New Year's or festivals","uk": "барвисті вогні в небі, які бачать на новий рік чи на святах","ru": "яркие огни в небе, которые видят на новый год или на праздниках"},"def":{"de":"Alle schauen zum Himmel, <g>weil</g> das <b>Feuerwerk</b> gleich beginnt.","en":"Everyone looks up at the sky <g>because</g> the <b>fireworks</b> are about to start.","uk":"Усі дивляться на небо, <g>тому що</g> зараз почнеться <b>феєрверк</b>.","ru":"Все смотрят на небо, <g>потому что</g> сейчас начнётся <b>фейерверк</b>."},"gram":"nebensaetze_konnektoren_wdh"},
  {"id":"k16_033","cat":"k16","term":{"de":"die Zeremonie","en":"ceremony","uk":"церемонія","ru":"церемония"},"short":{"de": "ein feierlicher, offizieller Ablauf zu einem besonderen Anlass","en": "a solemn, official proceeding for a special occasion","uk": "урочистий офіційний перебіг з особливої нагоди","ru": "торжественная официальная процедура по особому случаю"},"def":{"de":"Die <b>Zeremonie</b> dauert eine Stunde, <g>obwohl</g> die Hochzeit selbst viel länger ist.","en":"The <b>ceremony</b> lasts an hour, <g>although</g> the wedding itself is much longer.","uk":"<b>Церемонія</b> триває годину, <g>хоча</g> саме весілля значно довше.","ru":"<b>Церемония</b> длится час, <g>хотя</g> сама свадьба намного дольше."},"gram":"nebensaetze_konnektoren_wdh"},
  {"id":"k16_034","cat":"k16","term":{"de":"die Torte","en":"gateau, layered cake","uk":"торт","ru":"торт"},"short":{"de": "ein besonders schöner, oft mehrschichtiger Kuchen für Feste","en": "a particularly beautiful, often layered cake for celebrations","uk": "особливо гарний, часто багатошаровий торт для свят","ru": "особенно красивый, часто многослойный торт для праздников"},"def":{"de":"Die <b>Torte</b> sieht wunderschön aus, <g>weil</g> die Bäckerin so viel Zeit investiert hat.","en":"The <b>gateau</b> looks beautiful <g>because</g> the baker invested so much time.","uk":"<b>Торт</b> виглядає чудово, <g>тому що</g> пекарка вклала стільки часу.","ru":"<b>Торт</b> выглядит прекрасно, <g>потому что</g> пекарь вложила столько времени."},"gram":"nebensaetze_konnektoren_wdh"},
  {"id":"k16_035","cat":"k16","term":{"de":"das Jubiläum","en":"anniversary","uk":"ювілей","ru":"юбилей"},"short":{"de": "ein Tag, an dem man feiert, dass etwas schon viele Jahre besteht","en": "a day when you celebrate that something has existed for many years","uk": "день, коли святкують, що щось існує вже багато років","ru": "день, когда празднуют, что что-то существует уже много лет"},"def":{"de":"Sie feiern ihr <b>Jubiläum</b>, <g>weil</g> sie seit zwanzig Jahren zusammen sind.","en":"They are celebrating their <b>anniversary</b> <g>because</g> they have been together for twenty years.","uk":"Вони святкують свій <b>ювілей</b>, <g>тому що</g> вони разом уже двадцять років.","ru":"Они празднуют свой <b>юбилей</b>, <g>потому что</g> они вместе уже двадцать лет."},"gram":"nebensaetze_konnektoren_wdh"},
  {"id":"k16_036","cat":"k16","term":{"de":"der Luftballon","en":"balloon","uk":"кулька (повітряна)","ru":"воздушный шарик"},"short":{"de": "ein leichter, bunter Ballon, den man mit Luft füllt und an Festen aufhängt","en": "a light, colorful balloon filled with air and hung up at parties","uk": "легка кольорова кулька, яку надувають повітрям і вішають на святах","ru": "лёгкий цветной шарик, который надувают воздухом и вешают на праздниках"},"def":{"de":"Die Kinder lachen, <g>weil</g> ein <b>Luftballon</b> laut geplatzt ist.","en":"The children laugh <g>because</g> a <b>balloon</b> popped loudly.","uk":"Діти сміються, <g>тому що</g> <b>кулька</b> голосно лопнула.","ru":"Дети смеются, <g>потому что</g> <b>шарик</b> громко лопнул."},"gram":"nebensaetze_konnektoren_wdh"},
  {"id":"k16_037","cat":"k16","term":{"de":"tanzen","en":"to dance","uk":"танцювати","ru":"танцевать"},"short":{"de": "sich rhythmisch zur Musik bewegen","en": "to move rhythmically to music","uk": "рухатися ритмічно під музику","ru": "двигаться ритмично под музыку"},"def":{"de":"Sie <b>tanzen</b> bis spät in die Nacht, <g>weil</g> die Musik so gut ist.","en":"They <b>dance</b> until late at night <g>because</g> the music is so good.","uk":"Вони <b>танцюють</b> до пізньої ночі, <g>тому що</g> музика така хороша.","ru":"Они <b>танцуют</b> до поздней ночи, <g>потому что</g> музыка такая хорошая."},"gram":"nebensaetze_konnektoren_wdh"},
  {"id":"k16_038","cat":"k16","term":{"de":"der Toast","en":"toast, speech","uk":"тост","ru":"тост"},"short":{"de": "eine kurze Rede, bevor man mit den Gläsern anstößt","en": "a short speech before clinking glasses","uk": "коротка промова перед тим, як цокатися келихами","ru": "короткая речь перед тем, как чокаться бокалами"},"def":{"de":"Er hält einen <b>Toast</b>, <g>weil</g> er dem Brautpaar etwas Persönliches sagen möchte.","en":"He gives a <b>toast</b> <g>because</g> he wants to say something personal to the couple.","uk":"Він виголошує <b>тост</b>, <g>тому що</g> хоче сказати молодятам щось особисте.","ru":"Он произносит <b>тост</b>, <g>потому что</g> хочет сказать молодожёнам что-то личное."},"gram":"nebensaetze_konnektoren_wdh"},
  {"id":"k16_039","cat":"k16","term":{"de":"anstoßen","en":"to clink glasses, to toast","uk":"цокатися келихами","ru":"чокаться бокалами"},"short":{"de": "die Gläser zusammen leicht berühren, bevor man trinkt","en": "to gently touch glasses together before drinking","uk": "злегка торкнутися келихами перед тим, як випити","ru": "слегка соприкоснуться бокалами перед тем, как выпить"},"def":{"de":"Alle <b>stoßen</b> mit den Gläsern <b>an</b>, <g>weil</g> das Brautpaar gerade geheiratet hat.","en":"Everyone <b>clinks glasses</b> <g>because</g> the couple has just gotten married.","uk":"Усі <b>цокаються</b> келихами, <g>тому що</g> молодята щойно одружилися.","ru":"Все <b>чокаются</b> бокалами, <g>потому что</g> молодожёны только что поженились."},"gram":"nebensaetze_konnektoren_wdh"},
  {"id":"k16_040","cat":"k16","term":{"de":"der Gastgeber / die Gastgeberin","en":"host","uk":"господар / господиня (свята)","ru":"хозяин / хозяйка (праздника)"},"short":{"de": "eine Person, die andere zu sich einlädt und sich um sie kümmert","en": "a person who invites others to their place and takes care of them","uk": "людина, яка запрошує до себе інших і піклується про них","ru": "человек, который приглашает к себе других и заботится о них"},"def":{"de":"Die <b>Gastgeberin</b> begrüßt jeden Gast persönlich, <g>weil</g> ihr das sehr wichtig ist.","en":"The <b>host</b> greets every guest personally <g>because</g> it is very important to her.","uk":"<b>Господиня</b> особисто вітає кожного гостя, <g>тому що</g> для неї це дуже важливо.","ru":"<b>Хозяйка</b> лично приветствует каждого гостя, <g>потому что</g> для неё это очень важно."},"gram":"nebensaetze_konnektoren_wdh"}
];
...
var DIALOGE = [
  {
    ...
    "a": {
      "de": "Ich heiße Mark und komme aus der Ukraine aus Kiew. Ich wohne jetzt in Köln.",
      "en": "My name is Mark and I come from Ukraine from Kyiv. I live in Cologne now.",
      "uk": "Мене звати Марк, я з Уркаїни з Києва. Тепер я живу в Кельні.",
      "ru": "Меня зовут Марк, я из Украины ик Киева. Теперь я живу в Кёльне."
    },
    "gram": ""
  },
  {
  ...
  },
  {
    ...
    "a1": {
      ...
      "en": "<r>Agreed, that works well.</r><br><r>My suggestion would be that</r> we eat soup there, because I have <g>already eaten</g> there once.<br><r>Are you okay with that?</r>",
      "uk": "<r>Домовились, це підходить.</r><br><r>Моя пропозиція —</r> з'їсти там суп, тому що я там уже раз <g>їла</g>.<br><r>Ти згоден з цим?</r>",
      "ru": "<r>Договорились, это подходит.</r><br><r>Моё предложение —</r> поесть там суп, потому что я там уже раз <g>ела</g>.<br><r>Ты согласен с этим?</r>"
    },
    "q2": {
  ...
  },
  {
    ...
    "a": {
      "de": "<r>Klingt super, machen wir so.</r><br><r>Wir könnten doch</r> um Viertel vor acht bei der Bäckerei starten.<br><r>Was denkst du?</r>",
      "en": "<r>Sounds great, let's do that.</r><br><r>We could</r> start at quarter to eight at the bakery.<br><r>What do you think?</r>",
      "uk": "<r>Звучить чудово, зробімо так.</r><br><r>Ми могли б</r> стартувати без чверті восьма біля пекарні.<br><r>Що ти думаєш?</r>",
      "ru": "<r>Звучит отлично, так и сделаем.</r><br><r>Мы могли бы</r> стартовать без четверти восемь у пекарни.<br><r>Что ты думаешь?</r>"
    },
    "q1": {
      "de": "<r>Das klingt gut, aber</r> vielleicht sollten wir früher losfahren, <g>weil</g> um diese Zeit oft Stau <g>ist</g>.<br><r>Ich hätte einen Vorschlag:</r> Wir treffen uns schon um halb acht.<br><r>Wie findest du das?</r>",
      "en": "<r>That sounds good, but</r> maybe we should leave earlier, <g>because</g> there is often a traffic jam <g>at that time</g>.<br><r>I have a suggestion:</r> we meet already at half past seven.<br><r>How do you like that?</r>",
      "uk": "<r>Це звучить непогано, але</r>, можливо, нам варто виїжджати раніше, тому що о цей час часто буває затор.<br><r>У мене є пропозиція:</r> зустрінемося вже о пів на восьму.<br><r>Як тобі така ідея?</r>",
      "ru": "<r>Это звучит неплохо, но</r>, возможно, нам стоит выезжать раньше, потому что в это время часто бывает пробка.<br><r>У меня есть предложение:</r> встретимся уже в половине восьмого.<br><r>Как тебе такая идея?</r>"
    },
    "a1": {
      "de": "<r>Einverstanden, das passt gut.</r><br><r>Mein Vorschlag wäre, dass</r> ich meinen Wecker früher stelle.<br><r>Bist du damit einverstanden?</r>",
      "en": "<r>Agreed, that works well.</r><br><r>My suggestion would be that</r> I set my alarm clock earlier.<br><r>Are you okay with that?</r>",
      "uk": "<r>Домовились, це підходить.</r><br><r>Моя пропозиція —</r> поставити будильник раніше.<br><r>Ти згодна з цим?</r>",
      "ru": "<r>Договорились, это подходит.</r><br><r>Моё предложение —</r> поставить будильник раньше.<br><r>Ты согласна с этим?</r>"
    },
    "q2": {
      "de": "<r>Perfekt, so machen wir es.</r><br><r>Wir könnten es doch so machen:</r> Ich warte um halb acht vor deinem Haus.<br><r>Passt dir das so?</r>",
      "en": "<r>Perfect, that's how we'll do it.</r><br><r>We could do it like this:</r> I wait at half past seven in front of your house.<br><r>Does that work for you?</r>",
      "uk": "<r>Чудово, так і зробимо.</r><br><r>Можна зробити так:</r> я чекатиму о пів на восьму перед твоїм будинком.<br><r>Тобі так підходить?</r>",
  ...
  },
  {
    ...
    "a": {
      "de": "<r>Perfekt, so machen wir es.</r><br><r>Wir könnten doch</r> zusammen zur Rezeption gehen und den Schlüssel holen.<br><r>Was denkst du?</r>",
      "en": "<r>Perfect, that's how we'll do it.</r><br><r>We could</r> go to the reception together and get the key.<br><r>What do you think?</r>",
      "uk": "<r>Чудово, так і зробимо.</r><br><r>Ми могли б</r> разом піти на рецепцію і забрати ключ.<br><r>Що ти думаєш?</r>",
      "ru": "<r>Отлично, так и сделаем.</r><br><r>Мы могли бы</r> вместе пойти на ресепшн и забрать ключ.<br><r>Что ты думаешь?</r>"
    },
    "q1": {
      "de": "<r>Das klingt gut, aber</r> vielleicht sollten wir zuerst meinen Arbeitsplatz suchen.<br><r>Ich hätte einen Vorschlag:</r> Du zeigst mir zuerst das Büro, dann holen wir den Schlüssel.<br><r>Wie findest du das?</r>",
      "en": "<r>That sounds good, but</r> maybe we should look for my workplace first.<br><r>I have a suggestion:</r> you show me the office first, then we get the key.<br><r>How do you like that?</r>",
      "uk": "<r>Це звучить непогано, але</r>, можливо, нам варто спершу знайти моє робоче місце.<br><r>У мене є пропозиція:</r> спочатку ти покажеш мені офіс, а потім ми заберемо ключ.<br><r>Як тобі така ідея?</r>",
      "ru": "<r>Это звучит неплохо, но</r>, возможно, нам стоит сначала найти моё рабочее место.<br><r>У меня есть предложение:</r> сначала ты покажешь мне офис, а потом мы заберём ключ.<br><r>Как тебе такая идея?</r>"
    },
    "a1": {
      "de": "<r>Einverstanden, das passt gut.</r><br><r>Mein Vorschlag wäre, dass</r> der Schreibtisch am Fenster <g>dir</g> gehört.<br><r>Bist du damit einverstanden?</r>",
      "en": "<r>Agreed, that works well.</r><br><r>My suggestion would be that</r> the desk by the window belongs to <g>you</g>.<br><r>Are you okay with that?</r>",
      "uk": "<r>Домовились, це підходить.</r><br><r>Моя пропозиція —</r> стіл біля вікна належить <g>тобі</g>.<br><r>Ти згодна з цим?</r>",
      "ru": "<r>Договорились, это подходит.</r><br><r>Моё предложение —</r> стол у окна принадлежит <g>тебе</g>.<br><r>Ты согласна с этим?</r>"
    },
    "q2": {
      "de": "<r>Perfekt, so machen wir es.</r><br><r>Wir könnten es doch so machen:</r> Wir treffen uns um neun Uhr vor dem Büro.<br><r>Passt dir das so?</r>",
      "en": "<r>Perfect, that's how we'll do it.</r><br><r>We could do it like this:</r> we meet at nine o'clock in front of the office.<br><r>Does that work for you?</r>",
      "uk": "<r>Чудово, так і зробимо.</r><br><r>Можна зробити так:</r> зустрінемося о дев'ятій перед офісом.<br><r>Тобі так підходить?</r>",
  ...
  },
  {
    ...
    "a": {
      "de": "<r>Klingt super, machen wir so.</r><br><r>Wir könnten doch</r> am Freitagnachmittag in der Kantine feiern.<br><r>Was denkst du?</r>",
      "en": "<r>Sounds great, let's do that.</r><br><r>We could</r> celebrate on Friday afternoon in the cafeteria.<br><r>What do you think?</r>",
      "uk": "<r>Звучить чудово, зробімо так.</r><br><r>Ми могли б</r> святкувати в п'ятницю вдень у їдальні.<br><r>Що ти думаєш?</r>",
      "ru": "<r>Звучит отлично, так и сделаем.</r><br><r>Мы могли бы</r> отпраздновать в пятницу днём в столовой.<br><r>Что ты думаешь?</r>"
    },
    "q1": {
      "de": "<r>Das klingt gut, aber</r> vielleicht sollten wir früher anfangen, weil freitags viele Kollegen schon gehen.<br><r>Ich hätte einen Vorschlag:</r> Wir feiern schon um drei Uhr.<br><r>Wie findest du das?</r>",
      "en": "<r>That sounds good, but</r> maybe we should start earlier, because on Fridays many colleagues already leave.<br><r>I have a suggestion:</r> we celebrate already at three o'clock.<br><r>How do you like that?</r>",
      "uk": "<r>Це звучить непогано, але</r>, можливо, нам варто почати раніше, тому що по п'ятницях багато колег уже йдуть.<br><r>У мене є пропозиція:</r> святкуємо вже о третій.<br><r>Як тобі така ідея?</r>",
      "ru": "<r>Это звучит неплохо, но</r>, возможно, нам стоит начать раньше, потому что по пятницам многие коллеги уже уходят.<br><r>У меня есть предложение:</r> празднуем уже в три часа.<br><r>Как тебе такая идея?</r>"
    },
    "a1": {
      "de": "<r>Einverstanden, das passt gut.</r><br><r>Mein Vorschlag wäre, dass</r> wir Kuchen und Getränke mitbringen.<br><r>Bist du damit einverstanden?</r>",
      "en": "<r>Agreed, that works well.</r><br><r>My suggestion would be that</r> we bring cake and drinks.<br><r>Are you okay with that?</r>",
      "uk": "<r>Домовились, це підходить.</r><br><r>Моя пропозиція —</r> принести торт і напої.<br><r>Ти згоден з цим?</r>",
      "ru": "<r>Договорились, это подходит.</r><br><r>Моё предложение —</r> принести торт и напитки.<br><r>Ты согласен с этим?</r>"
    },
    "q2": {
      "de": "<r>Perfekt, so machen wir es.</r><br><r>Wir könnten es doch so machen:</r> Du bringst die Getränke, und ich backe einen Kuchen.<br><r>Passt dir das so?</r>",
      "en": "<r>Perfect, that's how we'll do it.</r><br><r>We could do it like this:</r> you bring the drinks, and I bake a cake.<br><r>Does that work for you?</r>",
      "uk": "<r>Чудово, так і зробимо.</r><br><r>Можна зробити так:</r> ти приносиш напої, а я спечу торт.<br><r>Тобі так підходить?</r>",
  ...
  },
  {
    ...
    "a": {
      "de": "<r>Klingt super, machen wir so.</r><br><r>Wir könnten doch</r> am Samstagmorgen anfangen.<br><r>Was denkst du?</r>",
      "en": "<r>Sounds great, let's do that.</r><br><r>We could</r> start on Saturday morning.<br><r>What do you think?</r>",
      "uk": "<r>Звучить чудово, зробімо так.</r><br><r>Ми могли б</r> почати в суботу вранці.<br><r>Що ти думаєш?</r>",
      "ru": "<r>Звучит отлично, так и сделаем.</r><br><r>Мы могли бы</r> начать в субботу утром.<br><r>Что ты думаешь?</r>"
    },
    "q1": {
      "de": "<r>Das klingt gut, aber</r> vielleicht sollten wir auch einen Transporter mieten.<br><r>Ich hätte einen Vorschlag:</r> Mein Bruder <g>hat</g> uns schon oft <g>geholfen</g>, er hat selbst einen Transporter.<br><r>Wie findest du das?</r>",
      "en": "<r>That sounds good, but</r> maybe we should also rent a moving van.<br><r>I have a suggestion:</r> my brother <g>has</g> already <g>helped</g> us many times, he has his own moving van.<br><r>How do you like that?</r>",
      "uk": "<r>Це звучить непогано, але</r>, можливо, нам варто ще орендувати фургон.<br><r>У мене є пропозиція:</r> мій брат уже часто нам <g>допомагав</g>, у нього є свій фургон.<br><r>Як тобі така ідея?</r>",
      "ru": "<r>Это звучит неплохо, но</r>, возможно, нам стоит ещё арендовать фургон.<br><r>У меня есть предложение:</r> мой брат уже часто нам <g>помогал</g>, у него есть свой фургон.<br><r>Как тебе такая идея?</r>"
    },
    "a1": {
      "de": "<r>Einverstanden, das passt gut.</r><br><r>Mein Vorschlag wäre, dass</r> wir zuerst die Kisten mit Büchern packen.<br><r>Bist du damit einverstanden?</r>",
      "en": "<r>Agreed, that works well.</r><br><r>My suggestion would be that</r> we pack the boxes with books first.<br><r>Are you okay with that?</r>",
      "uk": "<r>Домовились, це підходить.</r><br><r>Моя пропозиція —</r> спочатку спакувати коробки з книжками.<br><r>Ти згодна з цим?</r>",
      "ru": "<r>Договорились, это подходит.</r><br><r>Моё предложение —</r> сначала упаковать коробки с книгами.<br><r>Ты согласна с этим?</r>"
    },
    "q2": {
      "de": "<r>Perfekt, so machen wir es.</r><br><r>Wir könnten es doch so machen:</r> Wir benutzen den Aufzug für den Schrank.<br><r>Passt dir das so?</r>",
      "en": "<r>Perfect, that's how we'll do it.</r><br><r>We could do it like this:</r> we use the elevator for the wardrobe.<br><r>Does that work for you?</r>",
      "uk": "<r>Чудово, так і зробимо.</r><br><r>Можна зробити так:</r> ми використаємо ліфт для шафи.<br><r>Тобі так підходить?</r>",
  ...
  {
    "id": "dlg_038",
    "cat": "Möbel in der WG aufstellen",
    "type": "Gemeinsam etwas planen",
    "task": {
      "de": "Sie und ein Mitbewohner / eine Mitbewohnerin sind gerade in eine neue Wohngemeinschaft gezogen. Sie möchten gemeinsam die Möbel im Wohnzimmer aufstellen.<br><br>Planen Sie zusammen mit Ihrer Gesprächspartnerin oder Ihrem Gesprächspartner, wie Sie das machen möchten.<br><br>Diese Punkte helfen Ihnen:<br>Wohin stellen wir das Sofa?<br>Wo soll der Tisch stehen?<br>Wohin kommt das Regal?",
      "en": "You and a flatmate have just moved into a new shared flat. You would like to arrange the furniture in the living room together.<br><br>Plan together with your conversation partner how you would like to do this.<br><br>These points will help you:<br>Where do we put the sofa?<br>Where should the table stand?<br>Where does the shelf go?",
      "uk": "Ви й співмешканець / співмешканка щойно переїхали в нову квартиру на кількох мешканців. Ви хочете разом розставити меблі у вітальні.<br><br>Сплануйте разом зі своїм співрозмовником або співрозмовницею, як ви це зробите.<br><br>Ці пункти допоможуть вам:<br>Куди ми поставимо диван?<br>Де стоятиме стіл?<br>Куди піде стелаж?",
      "ru": "Вы и сосед / соседка по квартире только что переехали в новую квартиру с соседями. Вы хотите вместе расставить мебель в гостиной.<br><br>Спланируйте вместе со своим собеседником или собеседницей, как вы это сделаете.<br><br>Эти пункты помогут вам:<br>Куда мы поставим диван?<br>Где будет стоять стол?<br>Куда пойдёт стеллаж?"
    },
    "name_q": "de_w_julia",
    "name_a": "de_m_alex",
    "q": {
      "de": "Hallo Alex! Wir müssen noch die Möbel im Wohnzimmer aufstellen. Hast du Zeit?",
      "en": "Hi Alex! We still need to arrange the furniture in the living room. Do you have time?",
      "uk": "Привіт, Алекс! Нам ще треба розставити меблі у вітальні. У тебе є час?",
      "ru": "Привет, Алекс! Нам ещё нужно расставить мебель в гостиной. У тебя есть время?"
    },
    "a": {
      "de": "<r>Klingt super, machen wir so.</r><br><r>Wir könnten doch</r> das Sofa <g>an die</g> Wand stellen.<br><r>Was denkst du?</r>",
      "en": "<r>Sounds great, let's do that.</r><br><r>We could</r> put the sofa <g>up against</g> the wall.<br><r>What do you think?</r>",
      "uk": "<r>Звучить чудово, зробімо так.</r><br><r>Ми могли б</r> поставити диван <g>до</g> стіни.<br><r>Що ти думаєш?</r>",
      "ru": "<r>Звучит отлично, так и сделаем.</r><br><r>Мы могли бы</r> поставить диван <g>к</g> стене.<br><r>Что ты думаешь?</r>"
    },
    "q1": {
      "de": "<r>Das klingt gut, aber</r> vielleicht sollten wir auch an den Tisch denken.<br><r>Ich hätte einen Vorschlag:</r> Der Tisch steht dann <g>vor dem</g> Sofa.<br><r>Wie findest du das?</r>",
      "en": "<r>That sounds good, but</r> maybe we should also think about the table.<br><r>I have a suggestion:</r> then the table stands <g>in front of the</g> sofa.<br><r>How do you like that?</r>",
      "uk": "<r>Це звучить непогано, але</r>, можливо, нам варто ще подумати про стіл.<br><r>У мене є пропозиція:</r> тоді стіл стоятиме <g>перед</g> диваном.<br><r>Як тобі така ідея?</r>",
      "ru": "<r>Это звучит неплохо, но</r>, возможно, нам стоит ещё подумать о столе.<br><r>У меня есть предложение:</r> тогда стол будет стоять <g>перед</g> диваном.<br><r>Как тебе такая идея?</r>"
    },
    "a1": {
      "de": "<r>Einverstanden, das passt gut.</r><br><r>Mein Vorschlag wäre, dass</r> wir das Regal <g>in die</g> Ecke stellen.<br><r>Bist du damit einverstanden?</r>",
      "en": "<r>Agreed, that works well.</r><br><r>My suggestion would be that</r> we put the shelf <g>into the</g> corner.<br><r>Are you okay with that?</r>",
      "uk": "<r>Домовились, це підходить.</r><br><r>Моя пропозиція —</r> поставити стелаж <g>у</g> куток.<br><r>Ти згоден з цим?</r>",
      "ru": "<r>Договорились, это подходит.</r><br><r>Моё предложение —</r> поставить стеллаж <g>в</g> угол.<br><r>Ты согласен с этим?</r>"
    },
    "q2": {
      "de": "<r>Perfekt, so machen wir es.</r><br><r>Wir könnten es doch so machen:</r> Die Stühle kommen dann in die Küche.<br><r>Passt dir das so?</r>",
      "en": "<r>Perfect, that's how we'll do it.</r><br><r>We could do it like this:</r> the chairs then go into the kitchen.<br><r>Does that work for you?</r>",
      "uk": "<r>Чудово, так і зробимо.</r><br><r>Можна зробити так:</r> стільці тоді підуть на кухню.<br><r>Тобі так підходить?</r>",
  ...
  {
    "id": "dlg_039",
    "cat": "Alte Möbel verkaufen",
    "type": "Gemeinsam etwas planen",
    "task": {
      "de": "Sie und Ihr Mitbewohner / Ihre Mitbewohnerin möchten alte Möbel verkaufen. Vorher müssen Sie noch das Zimmer aufräumen und für Fotos vorbereiten.<br><br>Planen Sie zusammen mit Ihrer Gesprächspartnerin oder Ihrem Gesprächspartner, wie Sie das machen möchten.<br><br>Diese Punkte helfen Ihnen:<br>Wann räumen wir auf?<br>Welchen Preis nehmen wir?<br>Wer schreibt die Kleinanzeige?",
      "en": "You and your flatmate would like to sell some old furniture. Before that, you still need to tidy up the room and prepare it for photos.<br><br>Plan together with your conversation partner how you would like to do this.<br><br>These points will help you:<br>When do we tidy up?<br>What price do we ask?<br>Who writes the classified ad?",
      "uk": "Ви й ваш співмешканець / співмешканка хочете продати старі меблі. Перед цим вам ще треба прибрати кімнату й підготувати її для фото.<br><br>Сплануйте разом зі своїм співрозмовником або співрозмовницею, як ви це зробите.<br><br>Ці пункти допоможуть вам:<br>Коли ми прибираємо?<br>Яку ціну ми поставимо?<br>Хто напише оголошення?",
      "ru": "Вы и ваш сосед / соседка по квартире хотите продать старую мебель. Перед этим вам ещё нужно убрать комнату и подготовить её для фото.<br><br>Спланируйте вместе со своим собеседником или собеседницей, как вы это сделаете.<br><br>Эти пункты помогут вам:<br>Когда мы убираем?<br>Какую цену мы поставим?<br>Кто напишет объявление?"
    },
    "name_q": "de_m_mark",
    "name_a": "de_w_nina",
    "q": {
      "de": "Hallo Nina! Wir sollten das alte Sofa und das Regal verkaufen. Hast du Lust, das zusammen zu planen?",
      "en": "Hi Nina! We should sell the old sofa and the shelf. Do you feel like planning that together?",
      "uk": "Привіт, Ніно! Нам варто продати старий диван і стелаж. Хочеш разом це спланувати?",
      "ru": "Привет, Нина! Нам стоит продать старый диван и стеллаж. Хочешь вместе это спланировать?"
    },
    "a": {
      "de": "<r>Klingt super, machen wir so.</r><br><r>Wir könnten doch</r> am Samstag das Zimmer aufräumen.<br><r>Was denkst du?</r>",
      "en": "<r>Sounds great, let's do that.</r><br><r>We could</r> tidy up the room on Saturday.<br><r>What do you think?</r>",
      "uk": "<r>Звучить чудово, зробімо так.</r><br><r>Ми могли б</r> прибрати кімнату в суботу.<br><r>Що ти думаєш?</r>",
      "ru": "<r>Звучит отлично, так и сделаем.</r><br><r>Мы могли бы</r> убрать комнату в субботу.<br><r>Что ты думаешь?</r>"
    },
    "q1": {
      "de": "<r>Das klingt gut, aber</r> vielleicht sollten wir früher anfangen, <g>weil</g> wir am Sonntag schon Besuch <g>bekommen</g>.<br><r>Ich hätte einen Vorschlag:</r> Wir fangen schon am Freitagabend an.<br><r>Wie findest du das?</r>",
      "en": "<r>That sounds good, but</r> maybe we should start earlier, <g>because</g> we already have guests <g>coming</g> on Sunday.<br><r>I have a suggestion:</r> we start already on Friday evening.<br><r>How do you like that?</r>",
      "uk": "<r>Це звучить непогано, але</r>, можливо, нам варто почати раніше, тому що в неділю до нас уже прийдуть гості.<br><r>У мене є пропозиція:</r> почнемо вже в п'ятницю ввечері.<br><r>Як тобі така ідея?</r>",
      "ru": "<r>Это звучит неплохо, но</r>, возможно, нам стоит начать раньше, потому что в воскресенье к нам уже придут гости.<br><r>У меня есть предложение:</r> начнём уже в пятницу вечером.<br><r>Как тебе такая идея?</r>"
    },
    "a1": {
      "de": "<r>Einverstanden, das passt gut.</r><br><r>Mein Vorschlag wäre, dass</r> wir einen fairen Preis für das Sofa nehmen, <g>weil</g> es schon alt <g>ist</g>.<br><r>Bist du damit einverstanden?</r>",
      "en": "<r>Agreed, that works well.</r><br><r>My suggestion would be that</r> we ask a fair price for the sofa, <g>because</g> it <g>is</g> already old.<br><r>Are you okay with that?</r>",
      "uk": "<r>Домовились, це підходить.</r><br><r>Моя пропозиція —</r> поставити чесну ціну за диван, бо він уже старий.<br><r>Ти згоден з цим?</r>",
      "ru": "<r>Договорились, это подходит.</r><br><r>Моё предложение —</r> поставить честную цену за диван, потому что он уже старый.<br><r>Ты согласен с этим?</r>"
    },
    "q2": {
      "de": "<r>Perfekt, so machen wir es.</r><br><r>Wir könnten es doch so machen:</r> Du schreibst die Kleinanzeige, und ich mache die Fotos.<br><r>Passt dir das so?</r>",
      "en": "<r>Perfect, that's how we'll do it.</r><br><r>We could do it like this:</r> you write the classified ad, and I take the photos.<br><r>Does that work for you?</r>",
      "uk": "<r>Чудово, так і зробимо.</r><br><r>Можна зробити так:</r> ти пишеш оголошення, а я роблю фото.<br><r>Тобі так підходить?</r>",
  ...
  {
    "id": "dlg_040",
    "cat": "Einen Putzplan erstellen",
    "type": "Gemeinsam etwas planen",
    "task": {
      "de": "Sie und Ihre Mitbewohnerin streiten in letzter Zeit oft, weil niemand weiß, wer putzen oder den Müll rausbringen soll. Sie möchten einen Putzplan erstellen.<br><br>Planen Sie zusammen mit Ihrer Gesprächspartnerin oder Ihrem Gesprächspartner, wie Sie das machen möchten.<br><br>Diese Punkte helfen Ihnen:<br>Wer macht was? (Küche, Bad)<br>Wie oft? (jede Woche)<br>Wer bringt den Müll raus?",
      "en": "You and your flatmate have been arguing a lot lately because nobody knows who should clean or take out the trash. You would like to create a cleaning schedule.<br><br>Plan together with your conversation partner how you would like to do this.<br><br>These points will help you:<br>Who does what? (kitchen, bathroom)<br>How often? (every week)<br>Who takes out the trash?",
      "uk": "Ви й ваша сусідка останнім часом часто сваритеся, бо ніхто не знає, хто має прибирати чи виносити сміття. Ви хочете скласти графік прибирання.<br><br>Сплануйте разом зі своїм співрозмовником або співрозмовницею, як ви це зробите.<br><br>Ці пункти допоможуть вам:<br>Хто що робить? (кухня, ванна)<br>Як часто? (щотижня)<br>Хто виносить сміття?",
      "ru": "Вы и ваша соседка по квартире в последнее время часто ссоритесь, потому что никто не знает, кто должен убирать или выносить мусор. Вы хотите составить график уборки.<br><br>Спланируйте вместе со своим собеседником или собеседницей, как вы это сделаете.<br><br>Эти пункты помогут вам:<br>Кто что делает? (кухня, ванная)<br>Как часто? (каждую неделю)<br>Кто выносит мусор?"
    },
    "name_q": "de_w_anna",
    "name_a": "de_w_nina",
    "q": {
      "de": "Hallo Nina! Wir streiten in letzter Zeit oft wegen des Haushalts. Sollen wir einen Putzplan machen?",
      "en": "Hi Nina! We've been arguing a lot lately about the household chores. Should we make a cleaning schedule?",
      "uk": "Привіт, Ніно! Останнім часом ми часто сваримося через хатні справи. Складемо графік прибирання?",
      "ru": "Привет, Нина! В последнее время мы часто ссоримся из-за домашних дел. Составим график уборки?"
    },
    "a": {
      "de": "<r>Klingt super, machen wir so.</r><br><r>Wir könnten doch</r> die Aufgaben aufteilen: Ich putze das Bad.<br><r>Was denkst du?</r>",
      "en": "<r>Sounds great, let's do that.</r><br><r>We could</r> split the tasks: I'll clean the bathroom.<br><r>What do you think?</r>",
      "uk": "<r>Звучить чудово, зробімо так.</r><br><r>Ми могли б</r> розподілити завдання: я прибираю ванну.<br><r>Що ти думаєш?</r>",
      "ru": "<r>Звучит отлично, так и сделаем.</r><br><r>Мы могли бы</r> разделить задачи: я убираю ванную.<br><r>Что ты думаешь?</r>"
    },
    "q1": {
      "de": "<r>Das klingt gut, aber</r> vielleicht sollten wir auch die Küche einteilen.<br><r>Ich hätte einen Vorschlag:</r> Ich wasche dann jede Woche in der Küche ab.<br><r>Wie findest du das?</r>",
      "en": "<r>That sounds good, but</r> maybe we should also divide up the kitchen.<br><r>I have a suggestion:</r> I'll do the dishes in the kitchen every week then.<br><r>How do you like that?</r>",
      "uk": "<r>Це звучить непогано, але</r>, можливо, нам варто ще розподілити кухню.<br><r>У мене є пропозиція:</r> тоді я щотижня митиму посуд на кухні.<br><r>Як тобі така ідея?</r>",
      "ru": "<r>Это звучит неплохо, но</r>, возможно, нам стоит ещё разделить кухню.<br><r>У меня есть предложение:</r> тогда я каждую неделю буду мыть посуду на кухне.<br><r>Как тебе такая идея?</r>"
    },
    "a1": {
      "de": "<r>Einverstanden, das passt gut.</r><br><r>Mein Vorschlag wäre, dass</r> wir uns beim Müll abwechseln.<br><r>Bist du damit einverstanden?</r>",
      "en": "<r>Agreed, that works well.</r><br><r>My suggestion would be that</r> we take turns with the trash.<br><r>Are you okay with that?</r>",
      "uk": "<r>Домовились, це підходить.</r><br><r>Моя пропозиція —</r> по черзі виносити сміття.<br><r>Ти згодна з цим?</r>",
      "ru": "<r>Договорились, это подходит.</r><br><r>Моё предложение —</r> по очереди выносить мусор.<br><r>Ты согласна с этим?</r>"
    },
    "q2": {
      "de": "<r>Perfekt, so machen wir es.</r><br><r>Wir könnten es doch so machen:</r> Wir schreiben den Putzplan an die Kühlschranktür.<br><r>Passt dir das so?</r>",
      "en": "<r>Perfect, that's how we'll do it.</r><br><r>We could do it like this:</r> we write the cleaning schedule on the fridge door.<br><r>Does that work for you?</r>",
      "uk": "<r>Чудово, так і зробимо.</r><br><r>Можна зробити так:</r> напишемо графік прибирання на дверцятах холодильника.<br><r>Тобі так підходить?</r>",
  ...
  {
    "id": "dlg_041",
    "cat": "Einem Sportverein beitreten",
    "type": "Gemeinsam etwas planen",
    "task": {
      "de": "Sie und ein Freund / eine Freundin möchten zusammen einem Sportverein beitreten. Außerdem gibt es bald einen Wettkampf.<br><br>Planen Sie zusammen mit Ihrer Gesprächspartnerin oder Ihrem Gesprächspartner, wie Sie das machen möchten.<br><br>Diese Punkte helfen Ihnen:<br>Welche Sportart?<br>Wann ist das Training?<br>Gehen wir zum Wettkampf?",
      "en": "You and a friend would like to join a sports club together. There is also a competition coming up soon.<br><br>Plan together with your conversation partner how you would like to do this.<br><br>These points will help you:<br>Which sport?<br>When is the training?<br>Shall we go to the competition?",
      "uk": "Ви й друг / подруга хочете разом вступити до спортивного клубу. Крім того, скоро буде змагання.<br><br>Сплануйте разом зі своїм співрозмовником або співрозмовницею, як ви це зробите.<br><br>Ці пункти допоможуть вам:<br>Який вид спорту?<br>Коли тренування?<br>Чи підемо ми на змагання?",
      "ru": "Вы и друг / подруга хотите вместе вступить в спортивный клуб. К тому же скоро будет соревнование.<br><br>Спланируйте вместе со своим собеседником или собеседницей, как вы это сделаете.<br><br>Эти пункты помогут вам:<br>Какой вид спорта?<br>Когда тренировка?<br>Пойдём ли мы на соревнование?"
    },
    "name_q": "de_m_david",
    "name_a": "de_w_julia",
    "q": {
      "de": "Hallo Julia! Ich habe gehört, dass der Sportverein neue Mitglieder sucht. Wollen wir zusammen hingehen?",
      "en": "Hi Julia! I heard that the sports club is looking for new members. Shall we go together?",
      "uk": "Привіт, Юліє! Я чув, що спортивний клуб шукає нових членів. Підемо разом?",
      "ru": "Привет, Юлия! Я слышал, что спортивный клуб ищет новых членов. Пойдём вместе?"
    },
    "a": {
      "de": "<r>Klingt super, machen wir so.</r><br><r>Wir könnten doch</r> zusammen Volleyball spielen.<br><r>Was denkst du?</r>",
      "en": "<r>Sounds great, let's do that.</r><br><r>We could</r> play volleyball together.<br><r>What do you think?</r>",
      "uk": "<r>Звучить чудово, зробімо так.</r><br><r>Ми могли б</r> разом грати у волейбол.<br><r>Що ти думаєш?</r>",
      "ru": "<r>Звучит отлично, так и сделаем.</r><br><r>Мы могли бы</r> вместе играть в волейбол.<br><r>Что ты думаешь?</r>"
    },
    "q1": {
      "de": "<r>Das klingt gut, aber</r> ich glaube, <g>dass</g> Volleyball schon voll <g>ist</g>.<br><r>Ich hätte einen Vorschlag:</r> Wir probieren zuerst Tischtennis.<br><r>Wie findest du das?</r>",
      "en": "<r>That sounds good, but</r> I believe <g>that</g> volleyball <g>is</g> already full.<br><r>I have a suggestion:</r> we try table tennis first.<br><r>How do you like that?</r>",
      "uk": "<r>Це звучить непогано, але</r> я думаю, що волейбол уже переповнений.<br><r>У мене є пропозиція:</r> спочатку спробуємо настільний теніс.<br><r>Як тобі така ідея?</r>",
      "ru": "<r>Это звучит неплохо, но</r> я думаю, что волейбол уже переполнен.<br><r>У меня есть предложение:</r> сначала попробуем настольный теннис.<br><r>Как тебе такая идея?</r>"
    },
    "a1": {
      "de": "<r>Einverstanden, das passt gut.</r><br><r>Mein Vorschlag wäre, dass</r> wir am Training am Mittwoch teilnehmen.<br><r>Bist du damit einverstanden?</r>",
      "en": "<r>Agreed, that works well.</r><br><r>My suggestion would be that</r> we take part in the training on Wednesday.<br><r>Are you okay with that?</r>",
      "uk": "<r>Домовились, це підходить.</r><br><r>Моя пропозиція —</r> взяти участь у тренуванні в середу.<br><r>Ти згоден з цим?</r>",
      "ru": "<r>Договорились, это подходит.</r><br><r>Моё предложение —</r> принять участие в тренировке в среду.<br><r>Ты согласен с этим?</r>"
    },
    "q2": {
      "de": "<r>Perfekt, so machen wir es.</r><br><r>Wir könnten es doch so machen:</r> Wir gehen danach noch zum Wettkampf der Mannschaft.<br><r>Passt dir das so?</r>",
      "en": "<r>Perfect, that's how we'll do it.</r><br><r>We could do it like this:</r> afterwards we also go to the team's competition.<br><r>Does that work for you?</r>",
      "uk": "<r>Чудово, так і зробимо.</r><br><r>Можна зробити так:</r> потім ще підемо на змагання команди.<br><r>Тобі так підходить?</r>",
  ...
  {
    "id": "dlg_042",
    "cat": "Eine Verabredung neu planen",
    "type": "Gemeinsam etwas planen",
    "task": {
      "de": "Sie mussten Ihre letzte Verabredung mit einem Freund / einer Freundin leider absagen. Jetzt möchten Sie einen neuen Termin finden.<br><br>Planen Sie zusammen mit Ihrer Gesprächspartnerin oder Ihrem Gesprächspartner, wie Sie das machen möchten.<br><br>Diese Punkte helfen Ihnen:<br>Wann? (Tag, Uhrzeit)<br>Was machen wir? (Kino, Fußball)<br>Wer schreibt es in den Kalender?",
      "en": "Unfortunately, you had to cancel your last meeting with a friend. Now you would like to find a new date.<br><br>Plan together with your conversation partner how you would like to do this.<br><br>These points will help you:<br>When? (day, time)<br>What shall we do? (cinema, football)<br>Who writes it in the calendar?",
      "uk": "На жаль, вам довелося скасувати останню зустріч із другом / подругою. Тепер ви хочете знайти новий термін.<br><br>Сплануйте разом зі своїм співрозмовником або співрозмовницею, як ви це зробите.<br><br>Ці пункти допоможуть вам:<br>Коли? (день, час)<br>Що робимо? (кіно, футбол)<br>Хто запише це в календар?",
      "ru": "К сожалению, вам пришлось отменить последнюю встречу с другом / подругой. Теперь вы хотите найти новую дату.<br><br>Спланируйте вместе со своим собеседником или собеседницей, как вы это сделаете.<br><br>Эти пункты помогут вам:<br>Когда? (день, время)<br>Что мы делаем? (кино, футбол)<br>Кто запишет это в календарь?"
    },
    "name_q": "de_m_mark",
    "name_a": "de_m_alex",
    "q": {
      "de": "Hallo Alex! Tut mir leid, dass ich unsere Verabredung letzte Woche absagen musste. Wollen wir einen neuen Termin finden?",
      "en": "Hi Alex! I'm sorry that I had to cancel our meeting last week. Shall we find a new date?",
      "uk": "Привіт, Алекс! Вибач, що я минулого тижня мусив скасувати нашу зустріч. Знайдемо новий термін?",
      "ru": "Привет, Алекс! Извини, что мне пришлось отменить нашу встречу на прошлой неделе. Найдём новую дату?"
    },
    "a": {
      "de": "<r>Klingt super, machen wir so.</r><br><r>Wir könnten doch</r> nächsten Samstag ins Kino gehen.<br><r>Was denkst du?</r>",
      "en": "<r>Sounds great, let's do that.</r><br><r>We could</r> go to the cinema next Saturday.<br><r>What do you think?</r>",
      "uk": "<r>Звучить чудово, зробімо так.</r><br><r>Ми могли б</r> піти в кіно наступної суботи.<br><r>Що ти думаєш?</r>",
      "ru": "<r>Звучит отлично, так и сделаем.</r><br><r>Мы могли бы</r> пойти в кино в следующую субботу.<br><r>Что ты думаешь?</r>"
    },
    "q1": {
      "de": "<r>Das klingt gut, aber</r> ich <g>wollte</g> eigentlich auch mal wieder Fußball spielen.<br><r>Ich hätte einen Vorschlag:</r> Wir spielen zuerst Fußball und gehen danach ins Kino.<br><r>Wie findest du das?</r>",
      "en": "<r>That sounds good, but</r> I <g>wanted</g> to play football again too.<br><r>I have a suggestion:</r> we play football first and then go to the cinema.<br><r>How do you like that?</r>",
      "uk": "<r>Це звучить непогано, але</r> я теж хотів знову пограти у футбол.<br><r>У мене є пропозиція:</r> спочатку граємо у футбол, а потім йдемо в кіно.<br><r>Як тобі така ідея?</r>",
      "ru": "<r>Это звучит неплохо, но</r> я тоже хотел снова поиграть в футбол.<br><r>У меня есть предложение:</r> сначала играем в футбол, а потом идём в кино.<br><r>Как тебе такая идея?</r>"
    },
    "a1": {
      "de": "<r>Einverstanden, das passt gut.</r><br><r>Mein Vorschlag wäre, dass</r> wir das machen, weil ich letztes Mal auch nicht <g>konnte</g>.<br><r>Bist du damit einverstanden?</r>",
      "en": "<r>Agreed, that works well.</r><br><r>My suggestion would be that</r> we do that, because I <g>couldn't</g> make it last time either.<br><r>Are you okay with that?</r>",
      "uk": "<r>Домовились, це підходить.</r><br><r>Моя пропозиція —</r> так і зробити, бо я минулого разу теж не міг.<br><r>Ти згоден з цим?</r>",
      "ru": "<r>Договорились, это подходит.</r><br><r>Моё предложение —</r> так и сделать, ведь я в прошлый раз тоже не смог.<br><r>Ты согласен с этим?</r>"
    },
    "q2": {
      "de": "<r>Perfekt, so machen wir es.</r><br><r>Wir könnten es doch so machen:</r> Ich trage den Termin gleich in meinen Kalender ein.<br><r>Passt dir das so?</r>",
      "en": "<r>Perfect, that's how we'll do it.</r><br><r>We could do it like this:</r> I'll put the date in my calendar right away.<br><r>Does that work for you?</r>",
      "uk": "<r>Чудово, так і зробимо.</r><br><r>Можна зробити так:</r> я одразу запишу термін у свій календар.<br><r>Тобі так підходить?</r>",
  ...
  {
    "id": "dlg_043",
    "cat": "Eine Wanderung planen",
    "type": "Gemeinsam etwas planen",
    "task": {
      "de": "Sie und ein Freund / eine Freundin hatten diese Woche viel Stress. Sie möchten am Wochenende zusammen wandern gehen, um sich zu entspannen.<br><br>Planen Sie zusammen mit Ihrer Gesprächspartnerin oder Ihrem Gesprächspartner, wie Sie das machen möchten.<br><br>Diese Punkte helfen Ihnen:<br>Wann? (Tag, Uhrzeit)<br>Wohin?<br>Was nehmen wir mit?",
      "en": "You and a friend have had a lot of stress this week. You would like to go hiking together at the weekend to relax.<br><br>Plan together with your conversation partner how you would like to do this.<br><br>These points will help you:<br>When? (day, time)<br>Where to?<br>What do we take with us?",
      "uk": "У вас і вашого друга / подруги цього тижня було багато стресу. Ви хочете разом піти в похід на вихідних, щоб розслабитися.<br><br>Сплануйте разом зі своїм співрозмовником або співрозмовницею, як ви це зробите.<br><br>Ці пункти допоможуть вам:<br>Коли? (день, час)<br>Куди?<br>Що ми беремо з собою?",
      "ru": "У вас и вашего друга / подруги на этой неделе было много стресса. Вы хотите вместе пойти в поход на выходных, чтобы расслабиться.<br><br>Спланируйте вместе со своим собеседником или собеседницей, как вы это сделаете.<br><br>Эти пункты помогут вам:<br>Когда? (день, время)<br>Куда?<br>Что мы возьмём с собой?"
    },
    "name_q": "de_w_anna",
    "name_a": "de_m_mark",
    "q": {
      "de": "Hallo Mark! Diese Woche war ziemlich stressig. Wollen wir am Wochenende zusammen wandern gehen?",
      "en": "Hi Mark! This week was pretty stressful. Shall we go hiking together at the weekend?",
      "uk": "Привіт, Марку! Цей тиждень був досить стресовий. Підемо разом у похід на вихідних?",
      "ru": "Привет, Марк! Эта неделя была довольно напряжённой. Пойдём вместе в поход на выходных?"
    },
    "a": {
      "de": "<r>Klingt super, machen wir so.</r><br><r>Wir könnten doch</r> am Samstagmorgen losgehen.<br><r>Was denkst du?</r>",
      "en": "<r>Sounds great, let's do that.</r><br><r>We could</r> set off on Saturday morning.<br><r>What do you think?</r>",
      "uk": "<r>Звучить чудово, зробімо так.</r><br><r>Ми могли б</r> вирушити в суботу вранці.<br><r>Що ти думаєш?</r>",
      "ru": "<r>Звучит отлично, так и сделаем.</r><br><r>Мы могли бы</r> отправиться в субботу утром.<br><r>Что ты думаешь?</r>"
    },
    "q1": {
      "de": "<r>Das klingt gut, aber</r> vielleicht sollten wir auch überlegen, wohin wir gehen.<br><r>Ich hätte einen Vorschlag:</r> Wir wandern zum See im Wald.<br><r>Wie findest du das?</r>",
      "en": "<r>That sounds good, but</r> maybe we should also think about where we're going.<br><r>I have a suggestion:</r> we hike to the lake in the forest.<br><r>How do you like that?</r>",
      "uk": "<r>Це звучить непогано, але</r>, можливо, нам варто ще подумати, куди йти.<br><r>У мене є пропозиція:</r> підемо до озера в лісі.<br><r>Як тобі така ідея?</r>",
      "ru": "<r>Это звучит неплохо, но</r>, возможно, нам стоит ещё подумать, куда идти.<br><r>У меня есть предложение:</r> пойдём к озеру в лесу.<br><r>Как тебе такая идея?</r>"
    },
    "a1": {
      "de": "<r>Einverstanden, das passt gut.</r><br><r>Mein Vorschlag wäre, dass</r> wir etwas zu essen und zu trinken mitnehmen.<br><r>Bist du damit einverstanden?</r>",
      "en": "<r>Agreed, that works well.</r><br><r>My suggestion would be that</r> we take some food and drink with us.<br><r>Are you okay with that?</r>",
      "uk": "<r>Домовились, це підходить.</r><br><r>Моя пропозиція —</r> взяти з собою щось поїсти й попити.<br><r>Ти згодна з цим?</r>",
      "ru": "<r>Договорились, это подходит.</r><br><r>Моё предложение —</r> взять с собой что-нибудь поесть и попить.<br><r>Ты согласна с этим?</r>"
    },
    "q2": {
      "de": "<r>Perfekt, so machen wir es.</r><br><r>Wir könnten es doch so machen:</r> Wir treffen uns um neun Uhr am Bahnhof.<br><r>Passt dir das so?</r>",
      "en": "<r>Perfect, that's how we'll do it.</r><br><r>We could do it like this:</r> we meet at nine o'clock at the train station.<br><r>Does that work for you?</r>",
      "uk": "<r>Чудово, так і зробимо.</r><br><r>Можна зробити так:</r> зустрінемося о дев'ятій на вокзалі.<br><r>Тобі так підходить?</r>",
  ...
  {
    "id": "dlg_044",
    "cat": "Ein Outfit für die Feier planen",
    "type": "Gemeinsam etwas planen",
    "task": {
      "de": "Sie und eine Freundin sind zusammen zu einer Hochzeitsfeier eingeladen. Sie möchten überlegen, was Sie anziehen.<br><br>Planen Sie zusammen mit Ihrer Gesprächspartnerin oder Ihrem Gesprächspartner, wie Sie das machen möchten.<br><br>Diese Punkte helfen Ihnen:<br>Welche Kleidung?<br>Welche Farbe gefällt dir?<br>Wer hat noch etwas Passendes?",
      "en": "You and a friend are invited to a wedding party together. You would like to think about what to wear.<br><br>Plan together with your conversation partner how you would like to do this.<br><br>These points will help you:<br>Which clothes?<br>Which colour do you like?<br>Who has something else suitable?",
      "uk": "Ви й подруга разом запрошені на весільне свято. Ви хочете подумати, що вдягнути.<br><br>Сплануйте разом зі своїм співрозмовником або співрозмовницею, як ви це зробите.<br><br>Ці пункти допоможуть вам:<br>Який одяг?<br>Який колір тобі подобається?<br>У кого ще є щось підходяще?",
      "ru": "Вы и подруга вместе приглашены на свадебное торжество. Вы хотите подумать, что надеть.<br><br>Спланируйте вместе со своим собеседником или собеседницей, как вы это сделаете.<br><br>Эти пункты помогут вам:<br>Какая одежда?<br>Какой цвет тебе нравится?<br>У кого ещё есть что-то подходящее?"
    },
    "name_q": "de_w_nina",
    "name_a": "de_w_julia",
    "q": {
      "de": "Hallo Julia! Am Samstag ist die Hochzeitsfeier von Mark. Kannst du mir helfen, ein Outfit zu finden?",
      "en": "Hi Julia! Mark's wedding party is on Saturday. Can you help me find an outfit?",
      "uk": "Привіт, Юліє! У суботу весільне свято Марка. Можеш допомогти мені підібрати вбрання?",
      "ru": "Привет, Юлия! В субботу свадебное торжество Марка. Можешь помочь мне подобрать наряд?"
    },
    "a": {
      "de": "<r>Klingt super, machen wir so.</r><br><r>Wir könnten doch</r> dein blaues Kleid anziehen.<br><r>Was denkst du?</r>",
      "en": "<r>Sounds great, let's do that.</r><br><r>We could</r> go with your blue dress.<br><r>What do you think?</r>",
      "uk": "<r>Звучить чудово, зробімо так.</r><br><r>Ми могли б</r> обрати твою синю сукню.<br><r>Що ти думаєш?</r>",
      "ru": "<r>Звучит отлично, так и сделаем.</r><br><r>Мы могли бы</r> выбрать твоё синее платье.<br><r>Что ты думаешь?</r>"
    },
    "q1": {
      "de": "<r>Das klingt gut, aber</r> das Kleid gefällt <g>mir</g> nicht so gut.<br><r>Ich hätte einen Vorschlag:</r> Ich ziehe lieber die neue Hose mit dem Pullover an.<br><r>Wie findest du das?</r>",
      "en": "<r>That sounds good, but</r> the dress doesn't really appeal to <g>me</g>.<br><r>I have a suggestion:</r> I'd rather wear the new trousers with the sweater.<br><r>How do you like that?</r>",
      "uk": "<r>Це звучить непогано, але</r> сукня мені не дуже подобається.<br><r>У мене є пропозиція:</r> я краще вдягну нові штани зі светром.<br><r>Як тобі така ідея?</r>",
      "ru": "<r>Это звучит неплохо, но</r> платье мне не очень нравится.<br><r>У меня есть предложение:</r> я лучше надену новые брюки со свитером.<br><r>Как тебе такая идея?</r>"
    },
    "a1": {
      "de": "<r>Einverstanden, das passt gut.</r><br><r>Mein Vorschlag wäre, dass</r> du meinen Schal ausleihst, der gehört <g>mir</g>, aber er passt gut zu deiner Hose.<br><r>Bist du damit einverstanden?</r>",
      "en": "<r>Agreed, that works well.</r><br><r>My suggestion would be that</r> you borrow my scarf, it belongs to <g>me</g>, but it goes well with your trousers.<br><r>Are you okay with that?</r>",
      "uk": "<r>Домовились, це підходить.</r><br><r>Моя пропозиція —</r> щоб ти взяла мій шарф, він мій, але він добре пасує до твоїх штанів.<br><r>Ти згодна з цим?</r>",
      "ru": "<r>Договорились, это подходит.</r><br><r>Моё предложение —</r> чтобы ты взяла мой шарф, он мой, но он хорошо подходит к твоим брюкам.<br><r>Ты согласна с этим?</r>"
    },
    "q2": {
      "de": "<r>Perfekt, so machen wir es.</r><br><r>Wir könnten es doch so machen:</r> Wir treffen uns um sechs Uhr bei mir und ziehen uns zusammen an.<br><r>Passt dir das so?</r>",
      "en": "<r>Perfect, that's how we'll do it.</r><br><r>We could do it like this:</r> we meet at my place at six o'clock and get dressed together.<br><r>Does that work for you?</r>",
      "uk": "<r>Чудово, так і зробимо.</r><br><r>Можна зробити так:</r> зустрінемося о шостій у мене й вдягнемося разом.<br><r>Тобі так підходить?</r>",
  ...
  {
    "id": "dlg_045",
    "cat": "Einen Einkaufsbummel planen",
    "type": "Gemeinsam etwas planen",
    "task": {
      "de": "Sie brauchen neue Kleidung für den Herbst. Ein Freund / Eine Freundin möchte mit Ihnen einkaufen gehen.<br><br>Planen Sie zusammen mit Ihrer Gesprächspartnerin oder Ihrem Gesprächspartner, wie Sie das machen möchten.<br><br>Diese Punkte helfen Ihnen:<br>Wann? (Tag, Uhrzeit)<br>Was brauchen wir?<br>Wo treffen wir uns?",
      "en": "You need new clothes for autumn. A friend would like to go shopping with you.<br><br>Plan together with your conversation partner how you would like to do this.<br><br>These points will help you:<br>When? (day, time)<br>What do we need?<br>Where do we meet?",
      "uk": "Вам потрібен новий одяг на осінь. Друг / подруга хоче піти з вами по покупки.<br><br>Сплануйте разом зі своїм співрозмовником або співрозмовницею, як ви це зробите.<br><br>Ці пункти допоможуть вам:<br>Коли? (день, час)<br>Що нам потрібно?<br>Де зустрінемося?",
      "ru": "Вам нужна новая одежда на осень. Друг / подруга хочет пойти с вами за покупками.<br><br>Спланируйте вместе со своим собеседником или собеседницей, как вы это сделаете.<br><br>Эти пункты помогут вам:<br>Когда? (день, время)<br>Что нам нужно?<br>Где встретимся?"
    },
    "name_q": "de_m_david",
    "name_a": "de_m_alex",
    "q": {
      "de": "Hallo Alex! Ich brauche neue Kleidung für den Herbst. Hast du Lust, mit mir einkaufen zu gehen?",
      "en": "Hi Alex! I need new clothes for autumn. Do you feel like going shopping with me?",
      "uk": "Привіт, Алекс! Мені потрібен новий одяг на осінь. Хочеш піти зі мною по покупки?",
      "ru": "Привет, Алекс! Мне нужна новая одежда на осень. Хочешь пойти со мной за покупками?"
    },
    "a": {
      "de": "<r>Klingt super, machen wir so.</r><br><r>Wir könnten doch</r> am Samstag in die Stadt gehen.<br><r>Was denkst du?</r>",
      "en": "<r>Sounds great, let's do that.</r><br><r>We could</r> go into town on Saturday.<br><r>What do you think?</r>",
      "uk": "<r>Звучить чудово, зробімо так.</r><br><r>Ми могли б</r> поїхати в місто в суботу.<br><r>Що ти думаєш?</r>",
      "ru": "<r>Звучит отлично, так и сделаем.</r><br><r>Мы могли бы</r> поехать в город в субботу.<br><r>Что ты думаешь?</r>"
    },
    "q1": {
      "de": "<r>Das klingt gut, aber</r> ich brauche vor allem einen <g>neuen</g> Pullover.<br><r>Ich hätte einen Vorschlag:</r> Wir schauen zuerst nach Pullovern, dann nach Schuhen.<br><r>Wie findest du das?</r>",
      "en": "<r>That sounds good, but</r> I mostly need a <g>new</g> sweater.<br><r>I have a suggestion:</r> we look for sweaters first, then shoes.<br><r>How do you like that?</r>",
      "uk": "<r>Це звучить непогано, але</r> мені передусім потрібен новий светр.<br><r>У мене є пропозиція:</r> спочатку шукаємо светри, потім взуття.<br><r>Як тобі така ідея?</r>",
      "ru": "<r>Это звучит неплохо, но</r> мне прежде всего нужен новый свитер.<br><r>У меня есть предложение:</r> сначала ищем свитеры, потом обувь.<br><r>Как тебе такая идея?</r>"
    },
    "a1": {
      "de": "<r>Einverstanden, das passt gut.</r><br><r>Mein Vorschlag wäre, dass</r> ich mir auch ein <g>neues</g> Hemd kaufe.<br><r>Bist du damit einverstanden?</r>",
      "en": "<r>Agreed, that works well.</r><br><r>My suggestion would be that</r> I also buy myself a <g>new</g> shirt.<br><r>Are you okay with that?</r>",
      "uk": "<r>Домовились, це підходить.</r><br><r>Моя пропозиція —</r> я теж куплю собі нову сорочку.<br><r>Ти згоден з цим?</r>",
      "ru": "<r>Договорились, это подходит.</r><br><r>Моё предложение —</r> я тоже куплю себе новую рубашку.<br><r>Ты согласен с этим?</r>"
    },
    "q2": {
      "de": "<r>Perfekt, so machen wir es.</r><br><r>Wir könnten es doch so machen:</r> Wir treffen uns um zehn Uhr am Bahnhof und probieren dann alles an.<br><r>Passt dir das so?</r>",
      "en": "<r>Perfect, that's how we'll do it.</r><br><r>We could do it like this:</r> we meet at ten o'clock at the train station and then try everything on.<br><r>Does that work for you?</r>",
      "uk": "<r>Чудово, так і зробимо.</r><br><r>Можна зробити так:</r> зустрінемося о десятій на вокзалі й тоді все приміримо.<br><r>Тобі так підходить?</r>",
  ...
  {
    "id": "dlg_046",
    "cat": "Einen Kaffee-Termin vereinbaren",
    "type": "Gemeinsam etwas planen",
    "task": {
      "de": "Sie haben tolle Neuigkeiten von Ihrem Urlaub und möchten sich mit einer Freundin treffen, um ihr davon zu erzählen.<br><br>Planen Sie zusammen mit Ihrer Gesprächspartnerin oder Ihrem Gesprächspartner, wie Sie das machen möchten.<br><br>Diese Punkte helfen Ihnen:<br>Wann? (Tag, Uhrzeit)<br>Wo?<br>Was bringen wir mit?",
      "en": "You have great news from your holiday and would like to meet a friend to tell her about it.<br><br>Plan together with your conversation partner how you would like to do this.<br><br>These points will help you:<br>When? (day, time)<br>Where?<br>What do we bring?",
      "uk": "У вас чудові новини з відпустки, і ви хочете зустрітися з подругою, щоб про них розповісти.<br><br>Сплануйте разом зі своїм співрозмовником або співрозмовницею, як ви це зробите.<br><br>Ці пункти допоможуть вам:<br>Коли? (день, час)<br>Де?<br>Що ми принесемо?",
      "ru": "У вас отличные новости из отпуска, и вы хотите встретиться с подругой, чтобы рассказать ей о них.<br><br>Спланируйте вместе со своим собеседником или собеседницей, как вы это сделаете.<br><br>Эти пункты помогут вам:<br>Когда? (день, время)<br>Где?<br>Что мы принесём?"
    },
    "name_q": "de_w_julia",
    "name_a": "de_w_anna",
    "q": {
      "de": "Hallo Anna! Ich habe tolle Neuigkeiten von meinem Urlaub. Wollen wir uns treffen?",
      "en": "Hi Anna! I have great news from my holiday. Shall we meet up?",
      "uk": "Привіт, Анно! У мене чудові новини з відпустки. Зустрінемося?",
      "ru": "Привет, Анна! У меня отличные новости из отпуска. Встретимся?"
    },
    "a": {
      "de": "<r>Klingt super, machen wir so.</r><br><r>Wir könnten doch</r> am Dienstag einen Termin vereinbaren.<br><r>Was denkst du?</r>",
      "en": "<r>Sounds great, let's do that.</r><br><r>We could</r> arrange to meet on Tuesday.<br><r>What do you think?</r>",
      "uk": "<r>Звучить чудово, зробімо так.</r><br><r>Ми могли б</r> домовитися про зустріч у вівторок.<br><r>Що ти думаєш?</r>",
      "ru": "<r>Звучит отлично, так и сделаем.</r><br><r>Мы могли бы</r> договориться о встрече во вторник.<br><r>Что ты думаешь?</r>"
    },
    "q1": {
      "de": "<r>Das klingt gut, aber</r> am Dienstag habe ich leider schon einen Termin.<br><r>Ich hätte einen Vorschlag:</r> Wir treffen uns lieber am Mittwoch, dann zeige ich <g>dir</g> <g>die Fotos</g>.<br><r>Wie findest du das?</r>",
      "en": "<r>That sounds good, but</r> unfortunately I already have an appointment on Tuesday.<br><r>I have a suggestion:</r> let's meet on Wednesday instead, then I'll show <g>you</g> <g>the photos</g>.<br><r>How do you like that?</r>",
      "uk": "<r>Це звучить непогано, але</r> у вівторок у мене вже є справа.<br><r>У мене є пропозиція:</r> зустрінемося краще в середу, тоді я покажу тобі фото.<br><r>Як тобі така ідея?</r>",
      "ru": "<r>Это звучит неплохо, но</r> во вторник у меня уже есть дело.<br><r>У меня есть предложение:</r> встретимся лучше в среду, тогда я покажу тебе фото.<br><r>Как тебе такая идея?</r>"
    },
    "a1": {
      "de": "<r>Einverstanden, das passt gut.</r><br><r>Mein Vorschlag wäre, dass</r> ich <g>dir</g> <g>einen Kuchen</g> mitbringe.<br><r>Bist du damit einverstanden?</r>",
      "en": "<r>Agreed, that works well.</r><br><r>My suggestion would be that</r> I bring <g>you</g> <g>a cake</g>.<br><r>Are you okay with that?</r>",
      "uk": "<r>Домовились, це підходить.</r><br><r>Моя пропозиція —</r> я принесу тобі торт.<br><r>Ти згодна з цим?</r>",
      "ru": "<r>Договорились, это подходит.</r><br><r>Моё предложение —</r> я принесу тебе торт.<br><r>Ты согласна с этим?</r>"
    },
    "q2": {
      "de": "<r>Perfekt, so machen wir es.</r><br><r>Wir könnten es doch so machen:</r> Wir treffen uns um vier Uhr in meinem Büro.<br><r>Passt dir das so?</r>",
      "en": "<r>Perfect, that's how we'll do it.</r><br><r>We could do it like this:</r> we meet at four o'clock at my office.<br><r>Does that work for you?</r>",
      "uk": "<r>Чудово, так і зробимо.</r><br><r>Можна зробити так:</r> зустрінемося о четвертій у моєму офісі.<br><r>Тобі так підходить?</r>",
  ...
  {
    "id": "dlg_047",
    "cat": "Ein Hemd im Kaufhaus aussuchen",
    "type": "Gemeinsam etwas planen",
    "task": {
      "de": "Ihr Freund braucht noch ein Hemd für eine Feier. Sie möchten zusammen ins Kaufhaus gehen.<br><br>Planen Sie zusammen mit Ihrer Gesprächspartnerin oder Ihrem Gesprächspartner, wie Sie das machen möchten.<br><br>Diese Punkte helfen Ihnen:<br>Wann? (Tag, Uhrzeit)<br>Welche Farbe und welches Muster?<br>Wo treffen wir uns?",
      "en": "Your friend still needs a shirt for a party. You would like to go to the department store together.<br><br>Plan together with your conversation partner how you would like to do this.<br><br>These points will help you:<br>When? (day, time)<br>Which colour and which pattern?<br>Where do we meet?",
      "uk": "Вашому другові ще потрібна сорочка на свято. Ви хочете разом піти в універмаг.<br><br>Сплануйте разом зі своїм співрозмовником або співрозмовницею, як ви це зробите.<br><br>Ці пункти допоможуть вам:<br>Коли? (день, час)<br>Який колір і який візерунок?<br>Де зустрінемося?",
      "ru": "Вашему другу ещё нужна рубашка для праздника. Вы хотите вместе пойти в универмаг.<br><br>Спланируйте вместе со своим собеседником или собеседницей, как вы это сделаете.<br><br>Эти пункты помогут вам:<br>Когда? (день, время)<br>Какой цвет и какой узор?<br>Где встретимся?"
    },
    "name_q": "de_m_david",
    "name_a": "de_m_mark",
    "q": {
      "de": "Hallo Mark! Du brauchst doch noch ein Hemd für die Feier. Wollen wir ins Kaufhaus gehen?",
      "en": "Hi Mark! You still need a shirt for the party, right? Shall we go to the department store?",
      "uk": "Привіт, Марку! Тобі ж ще потрібна сорочка на свято. Підемо в універмаг?",
      "ru": "Привет, Марк! Тебе же ещё нужна рубашка на праздник. Пойдём в универмаг?"
    },
    "a": {
      "de": "<r>Klingt super, machen wir so.</r><br><r>Wir könnten doch</r> morgen Nachmittag hingehen.<br><r>Was denkst du?</r>",
      "en": "<r>Sounds great, let's do that.</r><br><r>We could</r> go tomorrow afternoon.<br><r>What do you think?</r>",
      "uk": "<r>Звучить чудово, зробімо так.</r><br><r>Ми могли б</r> піти завтра вдень.<br><r>Що ти думаєш?</r>",
      "ru": "<r>Звучит отлично, так и сделаем.</r><br><r>Мы могли бы</r> пойти завтра днём.<br><r>Что ты думаешь?</r>"
    },
    "q1": {
      "de": "<r>Das klingt gut, aber</r> ich finde, du brauchst eher ein <g>dunkles</g> Hemd für die Feier.<br><r>Ich hätte einen Vorschlag:</r> Wir schauen zuerst im zweiten Stockwerk nach.<br><r>Wie findest du das?</r>",
      "en": "<r>That sounds good, but</r> I think you need a <g>dark</g> shirt for the party instead.<br><r>I have a suggestion:</r> we look on the second floor first.<br><r>How do you like that?</r>",
      "uk": "<r>Це звучить непогано, але</r> я думаю, тобі скоріше потрібна темна сорочка на свято.<br><r>У мене є пропозиція:</r> спочатку подивимося на другому поверсі.<br><r>Як тобі така ідея?</r>",
      "ru": "<r>Это звучит неплохо, но</r> я думаю, тебе скорее нужна тёмная рубашка на праздник.<br><r>У меня есть предложение:</r> сначала посмотрим на втором этаже.<br><r>Как тебе такая идея?</r>"
    },
    "a1": {
      "de": "<r>Einverstanden, das passt gut.</r><br><r>Mein Vorschlag wäre, dass</r> wir dort auch nach einem <g>gestreiften</g> Pullover schauen.<br><r>Bist du damit einverstanden?</r>",
      "en": "<r>Agreed, that works well.</r><br><r>My suggestion would be that</r> we also look for a <g>striped</g> sweater there.<br><r>Are you okay with that?</r>",
      "uk": "<r>Домовились, це підходить.</r><br><r>Моя пропозиція —</r> там же пошукати смугастий светр.<br><r>Ти згоден з цим?</r>",
      "ru": "<r>Договорились, это подходит.</r><br><r>Моё предложение —</r> там же поискать полосатый свитер.<br><r>Ты согласен с этим?</r>"
    },
    "q2": {
      "de": "<r>Perfekt, so machen wir es.</r><br><r>Wir könnten es doch so machen:</r> Wir treffen uns um drei Uhr vor dem Kaufhaus.<br><r>Passt dir das so?</r>",
      "en": "<r>Perfect, that's how we'll do it.</r><br><r>We could do it like this:</r> we meet at three o'clock in front of the department store.<br><r>Does that work for you?</r>",
      "uk": "<r>Чудово, так і зробимо.</r><br><r>Можна зробити так:</r> зустрінемося о третій перед універмагом.<br><r>Тобі так підходить?</r>",
  ...
  {
    "id": "dlg_048",
    "cat": "Kleidung für ein Fest auswählen",
    "type": "Gemeinsam etwas planen",
    "task": {
      "de": "Sie und eine Kollegin sind zum Firmenjubiläum eingeladen. Sie möchten überlegen, was Sie zu diesem festlichen Anlass anziehen.<br><br>Planen Sie zusammen mit Ihrer Gesprächspartnerin oder Ihrem Gesprächspartner, wie Sie das machen möchten.<br><br>Diese Punkte helfen Ihnen:<br>Welche Kleidung?<br>Wie bequem soll es sein?<br>Was noch? (Schmuck)",
      "en": "You and a colleague are invited to the company anniversary. You would like to think about what to wear for this festive occasion.<br><br>Plan together with your conversation partner how you would like to do this.<br><br>These points will help you:<br>Which clothes?<br>How comfortable should it be?<br>What else? (jewelry)",
      "uk": "Ви й колежанка запрошені на ювілей фірми. Ви хочете подумати, що вдягнути на цю урочисту подію.<br><br>Сплануйте разом зі своїм співрозмовником або співрозмовницею, як ви це зробите.<br><br>Ці пункти допоможуть вам:<br>Який одяг?<br>Наскільки зручним він має бути?<br>Що ще? (прикраси)",
      "ru": "Вы и коллега приглашены на юбилей фирмы. Вы хотите подумать, что надеть на это торжественное мероприятие.<br><br>Спланируйте вместе со своим собеседником или собеседницей, как вы это сделаете.<br><br>Эти пункты помогут вам:<br>Какая одежда?<br>Насколько удобной она должна быть?<br>Что ещё? (украшения)"
    },
    "name_q": "de_w_julia",
    "name_a": "de_w_nina",
    "q": {
      "de": "Hallo Nina! Am Freitag ist das Firmenjubiläum. Was ziehen wir zu diesem Anlass an?",
      "en": "Hi Nina! The company anniversary is on Friday. What shall we wear for this occasion?",
      "uk": "Привіт, Ніно! У п'ятницю ювілей фірми. Що ми вдягнемо на цю подію?",
      "ru": "Привет, Нина! В пятницу юбилей фирмы. Что мы наденем на это событие?"
    },
    "a": {
      "de": "<r>Klingt super, machen wir so.</r><br><r>Wir könnten doch</r> elegante Kleider tragen.<br><r>Was denkst du?</r>",
      "en": "<r>Sounds great, let's do that.</r><br><r>We could</r> wear elegant dresses.<br><r>What do you think?</r>",
      "uk": "<r>Звучить чудово, зробімо так.</r><br><r>Ми могли б</r> одягнути елегантні сукні.<br><r>Що ти думаєш?</r>",
      "ru": "<r>Звучит отлично, так и сделаем.</r><br><r>Мы могли бы</r> надеть элегантные платья.<br><r>Что ты думаешь?</r>"
    },
    "q1": {
      "de": "<r>Das klingt gut, aber</r> ich möchte auch bequeme Schuhe tragen.<br><r>Ich hätte einen Vorschlag:</r> Wir nehmen weite Kleider, die sind bequemer.<br><r>Wie findest du das?</r>",
      "en": "<r>That sounds good, but</r> I would also like to wear comfortable shoes.<br><r>I have a suggestion:</r> we take loose dresses, they are more comfortable.<br><r>How do you like that?</r>",
      "uk": "<r>Це звучить непогано, але</r> я також хочу взути зручне взуття.<br><r>У мене є пропозиція:</r> візьмемо широкі сукні, вони зручніші.<br><r>Як тобі така ідея?</r>",
      "ru": "<r>Это звучит неплохо, но</r> я также хочу надеть удобную обувь.<br><r>У меня есть предложение:</r> возьмём широкие платья, они удобнее.<br><r>Как тебе такая идея?</r>"
    },
    "a1": {
      "de": "<r>Einverstanden, das passt gut.</r><br><r>Mein Vorschlag wäre, dass</r> wir noch etwas Schmuck dazu tragen.<br><r>Bist du damit einverstanden?</r>",
      "en": "<r>Agreed, that works well.</r><br><r>My suggestion would be that</r> we also wear some jewelry with it.<br><r>Are you okay with that?</r>",
      "uk": "<r>Домовились, це підходить.</r><br><r>Моя пропозиція —</r> ще додати трохи прикрас.<br><r>Ти згодна з цим?</r>",
      "ru": "<r>Договорились, это подходит.</r><br><r>Моё предложение —</r> ещё добавить немного украшений.<br><r>Ты согласна с этим?</r>"
    },
    "q2": {
      "de": "<r>Perfekt, so machen wir es.</r><br><r>Wir könnten es doch so machen:</r> Wir treffen uns um sechs Uhr und fahren zusammen zum Fest.<br><r>Passt dir das so?</r>",
      "en": "<r>Perfect, that's how we'll do it.</r><br><r>We could do it like this:</r> we meet at six o'clock and drive to the party together.<br><r>Does that work for you?</r>",
      "uk": "<r>Чудово, так і зробимо.</r><br><r>Можна зробити так:</r> зустрінемося о шостій і поїдемо на свято разом.<br><r>Тобі так підходить?</r>",
  ...
  {
    "id": "dlg_049",
    "cat": "Das richtige Verkehrsmittel wählen",
    "type": "Gemeinsam etwas planen",
    "task": {
      "de": "Sie und ein Freund / eine Freundin möchten am Freitag zusammen zu einem Konzert fahren.<br><br>Planen Sie zusammen mit Ihrer Gesprächspartnerin oder Ihrem Gesprächspartner, wie Sie das machen möchten.<br><br>Diese Punkte helfen Ihnen:<br>Welches Verkehrsmittel? (je nach Wetter)<br>Wann?<br>Wo treffen wir uns?",
      "en": "You and a friend would like to go to a concert together on Friday.<br><br>Plan together with your conversation partner how you would like to do this.<br><br>These points will help you:<br>Which means of transport? (depending on the weather)<br>When?<br>Where do we meet?",
      "uk": "Ви й друг / подруга хочете разом поїхати на концерт у п'ятницю.<br><br>Сплануйте разом зі своїм співрозмовником або співрозмовницею, як ви це зробите.<br><br>Ці пункти допоможуть вам:<br>Яким транспортом? (залежно від погоди)<br>Коли?<br>Де зустрінемося?",
      "ru": "Вы и друг / подруга хотите вместе поехать на концерт в пятницу.<br><br>Спланируйте вместе со своим собеседником или собеседницей, как вы это сделаете.<br><br>Эти пункты помогут вам:<br>Каким транспортом? (в зависимости от погоды)<br>Когда?<br>Где встретимся?"
    },
    "name_q": "de_w_anna",
    "name_a": "de_m_mark",
    "q": {
      "de": "Hallo Mark! Am Freitag ist das Konzert. Wie wollen wir dorthin fahren?",
      "en": "Hi Mark! The concert is on Friday. How do we want to get there?",
      "uk": "Привіт, Марку! У п'ятницю концерт. Як ми туди поїдемо?",
      "ru": "Привет, Марк! В пятницу концерт. Как мы туда поедем?"
    },
    "a": {
      "de": "<r>Klingt super, machen wir so.</r><br><r>Wir könnten doch</r> mit dem Fahrrad fahren, <g>wenn</g> das Wetter schön <g>ist</g>.<br><r>Was denkst du?</r>",
      "en": "<r>Sounds great, let's do that.</r><br><r>We could</r> go by bike <g>if</g> the weather <g>is</g> nice.<br><r>What do you think?</r>",
      "uk": "<r>Звучить чудово, зробімо так.</r><br><r>Ми могли б</r> поїхати на велосипеді, якщо буде гарна погода.<br><r>Що ти думаєш?</r>",
      "ru": "<r>Звучит отлично, так и сделаем.</r><br><r>Мы могли бы</r> поехать на велосипеде, если будет хорошая погода.<br><r>Что ты думаешь?</r>"
    },
    "q1": {
      "de": "<r>Das klingt gut, aber</r> <g>wenn</g> es <g>regnet</g>, sollten wir lieber den Bus nehmen.<br><r>Ich hätte einen Vorschlag:</r> Wir schauen morgens auf die Wettervorhersage.<br><r>Wie findest du das?</r>",
      "en": "<r>That sounds good, but</r> <g>if</g> it <g>rains</g>, we should rather take the bus.<br><r>I have a suggestion:</r> we check the weather forecast in the morning.<br><r>How do you like that?</r>",
      "uk": "<r>Це звучить непогано, але</r> якщо піде дощ, нам краще сісти на автобус.<br><r>У мене є пропозиція:</r> вранці подивимося прогноз погоди.<br><r>Як тобі така ідея?</r>",
      "ru": "<r>Это звучит неплохо, но</r> если пойдёт дождь, нам лучше сесть на автобус.<br><r>У меня есть предложение:</r> утром посмотрим прогноз погоды.<br><r>Как тебе такая идея?</r>"
    },
    "a1": {
      "de": "<r>Einverstanden, das passt gut.</r><br><r>Mein Vorschlag wäre, dass</r> wir mit der U-Bahn fahren, dann müssen wir nur einmal umsteigen.<br><r>Bist du damit einverstanden?</r>",
      "en": "<r>Agreed, that works well.</r><br><r>My suggestion would be that</r> we take the subway, then we only have to change once.<br><r>Are you okay with that?</r>",
      "uk": "<r>Домовились, це підходить.</r><br><r>Моя пропозиція —</r> поїхати на метро, тоді нам треба буде зробити лише одну пересадку.<br><r>Ти згоден з цим?</r>",
      "ru": "<r>Договорились, это подходит.</r><br><r>Моё предложение —</r> поехать на метро, тогда нам нужно будет сделать только одну пересадку.<br><r>Ты согласен с этим?</r>"
    },
    "q2": {
      "de": "<r>Perfekt, so machen wir es.</r><br><r>Wir könnten es doch so machen:</r> Wir treffen uns um sieben Uhr an der Haltestelle.<br><r>Passt dir das so?</r>",
      "en": "<r>Perfect, that's how we'll do it.</r><br><r>We could do it like this:</r> we meet at seven o'clock at the bus stop.<br><r>Does that work for you?</r>",
      "uk": "<r>Чудово, так і зробимо.</r><br><r>Можна зробити так:</r> зустрінемося о сьомій на зупинці.<br><r>Тобі так підходить?</r>",
  ...
  {
    "id": "dlg_050",
    "cat": "Eine barrierefreie Route planen",
    "type": "Gemeinsam etwas planen",
    "task": {
      "de": "Ihre Kollegin sitzt im Rollstuhl und braucht Hilfe, um zur Arbeit zu kommen. Sie möchten gemeinsam eine barrierefreie Route planen.<br><br>Planen Sie zusammen mit Ihrer Gesprächspartnerin oder Ihrem Gesprächspartner, wie Sie das machen möchten.<br><br>Diese Punkte helfen Ihnen:<br>Welches Verkehrsmittel?<br>Wann losfahren?<br>Was, wenn es Verspätung gibt?",
      "en": "Your colleague uses a wheelchair and needs help getting to work. You would like to plan an accessible route together.<br><br>Plan together with your conversation partner how you would like to do this.<br><br>These points will help you:<br>Which means of transport?<br>When to leave?<br>What if there is a delay?",
      "uk": "Ваша колежанка пересувається на інвалідному візку і потребує допомоги, щоб дістатися на роботу. Ви хочете разом спланувати безбар'єрний маршрут.<br><br>Сплануйте разом зі своїм співрозмовником або співрозмовницею, як ви це зробите.<br><br>Ці пункти допоможуть вам:<br>Яким транспортом?<br>Коли виїжджати?<br>Що робити, якщо буде затримка?",
      "ru": "Ваша коллега передвигается на инвалидной коляске и нуждается в помощи, чтобы добраться до работы. Вы хотите вместе спланировать безбарьерный маршрут.<br><br>Спланируйте вместе со своим собеседником или собеседницей, как вы это сделаете.<br><br>Эти пункты помогут вам:<br>Каким транспортом?<br>Когда выезжать?<br>Что делать, если будет задержка?"
    },
    "name_q": "de_m_david",
    "name_a": "de_w_anna",
    "q": {
      "de": "Hallo Anna! Ich habe gehört, dass die neue U-Bahn-Station noch nicht barrierefrei ist. Lass uns eine gute Route für dich planen.",
      "en": "Hi Anna! I heard that the new subway station isn't accessible yet. Let's plan a good route for you.",
      "uk": "Привіт, Анно! Я чув, що нова станція метро ще не безбар'єрна. Давай сплануємо для тебе хороший маршрут.",
      "ru": "Привет, Анна! Я слышал, что новая станция метро ещё не безбарьерная. Давай спланируем для тебя хороший маршрут."
    },
    "a": {
      "de": "<r>Klingt super, machen wir so.</r><br><r>Wir könnten doch</r> morgens ein Taxi nehmen.<br><r>Was denkst du?</r>",
      "en": "<r>Sounds great, let's do that.</r><br><r>We could</r> take a taxi in the morning.<br><r>What do you think?</r>",
      "uk": "<r>Звучить чудово, зробімо так.</r><br><r>Ми могли б</r> вранці брати таксі.<br><r>Що ти думаєш?</r>",
      "ru": "<r>Звучит отлично, так и сделаем.</r><br><r>Мы могли бы</r> утром брать такси.<br><r>Что ты думаешь?</r>"
    },
    "q1": {
      "de": "<r>Das klingt gut, aber</r> vielleicht sollten wir auch den Bus bedenken, <g>weil</g> der barrierefrei <g>ist</g>.<br><r>Ich hätte einen Vorschlag:</r> Wir prüfen zuerst den Busfahrplan.<br><r>Wie findest du das?</r>",
      "en": "<r>That sounds good, but</r> maybe we should also consider the bus, <g>because</g> it <g>is</g> accessible.<br><r>I have a suggestion:</r> we check the bus schedule first.<br><r>How do you like that?</r>",
      "uk": "<r>Це звучить непогано, але</r>, можливо, нам варто ще подумати про автобус, тому що він безбар'єрний.<br><r>У мене є пропозиція:</r> спочатку перевіримо розклад автобусів.<br><r>Як тобі така ідея?</r>",
      "ru": "<r>Это звучит неплохо, но</r>, возможно, нам стоит ещё подумать об автобусе, потому что он безбарьерный.<br><r>У меня есть предложение:</r> сначала проверим расписание автобусов.<br><r>Как тебе такая идея?</r>"
    },
    "a1": {
      "de": "<r>Einverstanden, das passt gut.</r><br><r>Mein Vorschlag wäre, dass</r> wir früher losfahren, <g>weil</g> es bei Verspätung sonst stressig <g>wird</g>.<br><r>Bist du damit einverstanden?</r>",
      "en": "<r>Agreed, that works well.</r><br><r>My suggestion would be that</r> we leave earlier, <g>because</g> otherwise it <g>gets</g> stressful in case of a delay.<br><r>Are you okay with that?</r>",
      "uk": "<r>Домовились, це підходить.</r><br><r>Моя пропозиція —</r> виїжджати раніше, бо інакше при затримці буде стресово.<br><r>Ти згоден з цим?</r>",
      "ru": "<r>Договорились, это подходит.</r><br><r>Моё предложение —</r> выезжать раньше, потому что иначе при задержке будет стрессово.<br><r>Ты согласен с этим?</r>"
    },
    "q2": {
      "de": "<r>Perfekt, so machen wir es.</r><br><r>Wir könnten es doch so machen:</r> Wir treffen uns um Viertel vor acht an der Haltestelle.<br><r>Passt dir das so?</r>",
      "en": "<r>Perfect, that's how we'll do it.</r><br><r>We could do it like this:</r> we meet at quarter to eight at the bus stop.<br><r>Does that work for you?</r>",
      "uk": "<r>Чудово, так і зробимо.</r><br><r>Можна зробити так:</r> зустрінемося без чверті восьма на зупинці.<br><r>Тобі так підходить?</r>",
  ...
  {
    "id": "dlg_055",
    "cat": "Einen Erinnerungsabend planen",
    "type": "Gemeinsam etwas planen",
    "task": {
      "de": "Sie möchten einen Abend organisieren, an dem Ihre Familie sich an alte Zeiten erinnert.<br><br>Planen Sie zusammen mit Ihrer Gesprächspartnerin oder Ihrem Gesprächspartner, wie Sie das machen möchten.<br><br>Diese Punkte helfen Ihnen:<br>Wann?<br>Wen laden wir ein?<br>Welche Fragen stellen wir?",
      "en": "You would like to organise an evening where your family remembers old times.<br><br>Plan together with your conversation partner how you would like to do this.<br><br>These points will help you:<br>When?<br>Who do we invite?<br>What questions do we ask?",
      "uk": "Ви хочете організувати вечір, коли ваша родина згадуватиме давні часи.<br><br>Сплануйте разом зі своїм співрозмовником або співрозмовницею, як ви це зробите.<br><br>Ці пункти допоможуть вам:<br>Коли?<br>Кого ми запросимо?<br>Які запитання ми поставимо?",
      "ru": "Вы хотите организовать вечер, когда ваша семья будет вспоминать старые времена.<br><br>Спланируйте вместе со своим собеседником или собеседницей, как вы это сделаете.<br><br>Эти пункты помогут вам:<br>Когда?<br>Кого мы пригласим?<br>Какие вопросы мы зададим?"
    },
    "name_q": "de_m_david",
    "name_a": "de_w_nina",
    "q": {
      "de": "Hallo Nina! Ich möchte einen Abend organisieren, an dem die Familie sich an alte Zeiten erinnert. Machst du mit?",
      "en": "Hi Nina! I would like to organise an evening where the family remembers old times. Will you join in?",
      "uk": "Привіт, Ніно! Я хочу організувати вечір, коли родина згадуватиме давні часи. Приєднаєшся?",
      "ru": "Привет, Нина! Я хочу организовать вечер, когда семья будет вспоминать старые времена. Присоединишься?"
    },
    "a": {
      "de": "<r>Klingt super, machen wir so.</r><br><r>Wir könnten doch</r> am Sonntag alle einladen.<br><r>Was denkst du?</r>",
      "en": "<r>Sounds great, let's do that.</r><br><r>We could</r> invite everyone on Sunday.<br><r>What do you think?</r>",
      "uk": "<r>Звучить чудово, зробімо так.</r><br><r>Ми могли б</r> запросити всіх у неділю.<br><r>Що ти думаєш?</r>",
      "ru": "<r>Звучит отлично, так и сделаем.</r><br><r>Мы могли бы</r> пригласить всех в воскресенье.<br><r>Что ты думаешь?</r>"
    },
    "q1": {
      "de": "<r>Das klingt gut, aber</r> <g>als</g> meine Großmutter ankam, war alles neu für sie, das wäre eine schöne Geschichte.<br><r>Ich hätte einen Vorschlag:</r> Wir bitten sie, davon zu erzählen.<br><r>Wie findest du das?</r>",
      "en": "<r>That sounds good, but</r> <g>when</g> my grandmother arrived, everything was new to her, that would be a nice story.<br><r>I have a suggestion:</r> we ask her to tell us about it.<br><r>How do you like that?</r>",
      "uk": "<r>Це звучить непогано, але</r> коли моя бабуся приїхала, для неї все було новим, це була б гарна історія.<br><r>У мене є пропозиція:</r> попросимо її про це розповісти.<br><r>Як тобі така ідея?</r>",
      "ru": "<r>Это звучит неплохо, но</r> когда моя бабушка приехала, для неё всё было новым, это была бы хорошая история.<br><r>У меня есть предложение:</r> попросим её об этом рассказать.<br><r>Как тебе такая идея?</r>"
    },
    "a1": {
      "de": "<r>Einverstanden, das passt gut.</r><br><r>Mein Vorschlag wäre, dass</r> wir auch fragen, was sie immer gemacht haben, <g>wenn</g> sie als Kinder zusammen waren.<br><r>Bist du damit einverstanden?</r>",
      "en": "<r>Agreed, that works well.</r><br><r>My suggestion would be that</r> we also ask what they always did <g>whenever</g> they were together as children.<br><r>Are you okay with that?</r>",
      "uk": "<r>Домовились, це підходить.</r><br><r>Моя пропозиція —</r> ще запитати, що вони завжди робили, коли були разом дітьми.<br><r>Ти згодна з цим?</r>",
      "ru": "<r>Договорились, это подходит.</r><br><r>Моё предложение —</r> ещё спросить, что они всегда делали, когда были вместе детьми.<br><r>Ты согласна с этим?</r>"
    },
    "q2": {
      "de": "<r>Perfekt, so machen wir es.</r><br><r>Wir könnten es doch so machen:</r> Wir fangen <g>schon</g> um vier Uhr an, damit wir genug Zeit haben.<br><r>Passt dir das so?</r>",
      "en": "<r>Perfect, that's how we'll do it.</r><br><r>We could do it like this:</r> we start <g>already</g> at four o'clock, so that we have enough time.<br><r>Does that work for you?</r>",
      "uk": "<r>Чудово, так і зробимо.</r><br><r>Можна зробити так:</r> почнемо вже о четвертій, щоб мати достатньо часу.<br><r>Тобі так підходить?</r>",
  ...
  {
    "id": "dlg_056",
    "cat": "Einen Besuch bei den Großeltern planen",
    "type": "Gemeinsam etwas planen",
    "task": {
      "de": "Sie möchten mit Ihrer Schwester Ihre Großeltern besuchen, die schon in Rente sind.<br><br>Planen Sie zusammen mit Ihrer Gesprächspartnerin oder Ihrem Gesprächspartner, wie Sie das machen möchten.<br><br>Diese Punkte helfen Ihnen:<br>Wann?<br>Worüber sprechen wir?<br>Nehmen wir die Kinder mit?",
      "en": "You would like to visit your grandparents, who are already retired, together with your sister.<br><br>Plan together with your conversation partner how you would like to do this.<br><br>These points will help you:<br>When?<br>What do we talk about?<br>Do we bring the children?",
      "uk": "Ви хочете разом із сестрою відвідати бабусю й дідуся, які вже на пенсії.<br><br>Сплануйте разом зі своїм співрозмовником або співрозмовницею, як ви це зробите.<br><br>Ці пункти допоможуть вам:<br>Коли?<br>Про що ми говоритимемо?<br>Чи візьмемо дітей?",
      "ru": "Вы хотите вместе с сестрой навестить бабушку и дедушку, которые уже на пенсии.<br><br>Спланируйте вместе со своим собеседником или собеседницей, как вы это сделаете.<br><br>Эти пункты помогут вам:<br>Когда?<br>О чём мы поговорим?<br>Возьмём ли мы детей?"
    },
    "name_q": "de_w_anna",
    "name_a": "de_w_julia",
    "q": {
      "de": "Hallo Julia! Wollen wir unsere Großeltern besuchen? Sie freuen sich bestimmt über die Enkelkinder.",
      "en": "Hi Julia! Shall we visit our grandparents? They'll definitely be happy about the grandchildren.",
      "uk": "Привіт, Юліє! Відвідаємо наших бабусю й дідуся? Вони точно будуть раді онукам.",
      "ru": "Привет, Юлия! Навестим наших бабушку и дедушку? Они точно будут рады внукам."
    },
    "a": {
      "de": "<r>Klingt super, machen wir so.</r><br><r>Wir könnten doch</r> am Samstag hinfahren.<br><r>Was denkst du?</r>",
      "en": "<r>Sounds great, let's do that.</r><br><r>We could</r> go there on Saturday.<br><r>What do you think?</r>",
      "uk": "<r>Звучить чудово, зробімо так.</r><br><r>Ми могли б</r> поїхати туди в суботу.<br><r>Що ти думаєш?</r>",
      "ru": "<r>Звучит отлично, так и сделаем.</r><br><r>Мы могли бы</r> поехать туда в субботу.<br><r>Что ты думаешь?</r>"
    },
    "q1": {
      "de": "<r>Das klingt gut, aber</r> wir sollten auch etwas zum Reden vorbereiten, zum Beispiel über die Nachbarschaft.<br><r>Ich hätte einen Vorschlag:</r> Wir fragen sie nach ihrem Leben früher.<br><r>Wie findest du das?</r>",
      "en": "<r>That sounds good, but</r> we should also prepare something to talk about, for example the neighborhood.<br><r>I have a suggestion:</r> we ask them about their life in the past.<br><r>How do you like that?</r>",
      "uk": "<r>Це звучить непогано, але</r> нам варто ще підготувати теми для розмови, наприклад про сусідство.<br><r>У мене є пропозиція:</r> запитаємо їх про їхнє минуле життя.<br><r>Як тобі така ідея?</r>",
      "ru": "<r>Это звучит неплохо, но</r> нам стоит ещё подготовить темы для разговора, например о соседях.<br><r>У меня есть предложение:</r> спросим их об их прошлой жизни.<br><r>Как тебе такая идея?</r>"
    },
    "a1": {
      "de": "<r>Einverstanden, das passt gut.</r><br><r>Mein Vorschlag wäre, dass</r> wir die Kinder mitnehmen, damit sie ihre Enkelkinder sehen können.<br><r>Bist du damit einverstanden?</r>",
      "en": "<r>Agreed, that works well.</r><br><r>My suggestion would be that</r> we bring the children, so they can see their grandchildren.<br><r>Are you okay with that?</r>",
      "uk": "<r>Домовились, це підходить.</r><br><r>Моя пропозиція —</r> взяти дітей, щоб вони побачили своїх онуків.<br><r>Ти згодна з цим?</r>",
      "ru": "<r>Договорились, это подходит.</r><br><r>Моё предложение —</r> взять детей, чтобы они увидели своих внуков.<br><r>Ты согласна с этим?</r>"
    },
    "q2": {
      "de": "<r>Perfekt, so machen wir es.</r><br><r>Wir könnten es doch so machen:</r> Wir kommen um zwei Uhr an und bleiben bis zum Abend.<br><r>Passt dir das so?</r>",
      "en": "<r>Perfect, that's how we'll do it.</r><br><r>We could do it like this:</r> we arrive at two o'clock and stay until the evening.<br><r>Does that work for you?</r>",
      "uk": "<r>Чудово, так і зробимо.</r><br><r>Можна зробити так:</r> приїдемо о другій і залишимось до вечора.<br><r>Тобі так підходить?</r>",
  ...
  {
    "id": "dlg_057",
    "cat": "Picknick oder Wanderung planen",
    "type": "Gemeinsam etwas planen",
    "task": {
      "de": "Sie und ein Freund / eine Freundin wollen am Wochenende einen Ausflug machen.<br><br>Planen Sie zusammen mit Ihrer Gesprächspartnerin oder Ihrem Gesprächspartner, wie Sie das machen möchten.<br><br>Diese Punkte helfen Ihnen:<br>Picknick oder Wanderung?<br>Was, wenn es regnet?<br>Was nehmen wir mit?",
      "en": "You and a friend want to go on a trip at the weekend.<br><br>Plan together with your conversation partner how you would like to do this.<br><br>These points will help you:<br>Picnic or hike?<br>What if it rains?<br>What do we take with us?",
      "uk": "Ви й друг / подруга хочете на вихідних поїхати на екскурсію.<br><br>Сплануйте разом зі своїм співрозмовником або співрозмовницею, як ви це зробите.<br><br>Ці пункти допоможуть вам:<br>Пікнік чи похід?<br>Що робити, якщо піде дощ?<br>Що ми візьмемо з собою?",
      "ru": "Вы и друг / подруга хотите на выходных поехать на экскурсию.<br><br>Спланируйте вместе со своим собеседником или собеседницей, как вы это сделаете.<br><br>Эти пункты помогут вам:<br>Пикник или поход?<br>Что делать, если пойдёт дождь?<br>Что мы возьмём с собой?"
    },
    "name_q": "de_m_mark",
    "name_a": "de_w_julia",
    "q": {
      "de": "Hallo Julia! Am Wochenende wollen wir doch einen Ausflug machen. Hast du schon eine Idee?",
      "en": "Hi Julia! We wanted to go on a trip this weekend. Do you already have an idea?",
      "uk": "Привіт, Юліє! На вихідних ми ж хотіли поїхати на екскурсію. У тебе вже є ідея?",
      "ru": "Привет, Юлия! На выходных мы же хотели поехать на экскурсию. У тебя уже есть идея?"
    },
    "a": {
      "de": "<r>Klingt super, machen wir so.</r><br><r>Wir könnten doch</r> ein Picknick im Park machen.<br><r>Was denkst du?</r>",
      "en": "<r>Sounds great, let's do that.</r><br><r>We could</r> have a picnic in the park.<br><r>What do you think?</r>",
      "uk": "<r>Звучить чудово, зробімо так.</r><br><r>Ми могли б</r> влаштувати пікнік у парку.<br><r>Що ти думаєш?</r>",
      "ru": "<r>Звучит отлично, так и сделаем.</r><br><r>Мы могли бы</r> устроить пикник в парке.<br><r>Что ты думаешь?</r>"
    },
    "q1": {
      "de": "<r>Das klingt gut, aber</r> <g>wenn</g> es regnet, <g>wird</g> das schwierig.<br><r>Ich hätte einen Vorschlag:</r> Wir schauen vorher auf die Wettervorhersage.<br><r>Wie findest du das?</r>",
      "en": "<r>That sounds good, but</r> <g>if</g> it rains, that <g>would be</g> difficult.<br><r>I have a suggestion:</r> we check the weather forecast beforehand.<br><r>How do you like that?</r>",
      "uk": "<r>Це звучить непогано, але</r> якщо піде дощ, це буде складно.<br><r>У мене є пропозиція:</r> подивимось спочатку прогноз погоди.<br><r>Як тобі така ідея?</r>",
      "ru": "<r>Это звучит неплохо, но</r> если пойдёт дождь, это будет сложно.<br><r>У меня есть предложение:</r> посмотрим сначала прогноз погоды.<br><r>Как тебе такая идея?</r>"
    },
    "a1": {
      "de": "<r>Einverstanden, das passt gut.</r><br><r>Mein Vorschlag wäre, dass</r> wir einen Wanderweg wählen, <g>wenn</g> die Sonne <g>scheint</g>.<br><r>Bist du damit einverstanden?</r>",
      "en": "<r>Agreed, that works well.</r><br><r>My suggestion would be that</r> we choose a hiking trail <g>if</g> the sun <g>shines</g>.<br><r>Are you okay with that?</r>",
      "uk": "<r>Домовились, це підходить.</r><br><r>Моя пропозиція —</r> обрати туристичну стежку, якщо світитиме сонце.<br><r>Ти згодна з цим?</r>",
      "ru": "<r>Договорились, это подходит.</r><br><r>Моё предложение —</r> выбрать туристическую тропу, если будет светить солнце.<br><r>Ты согласна с этим?</r>"
    },
    "q2": {
      "de": "<r>Perfekt, so machen wir es.</r><br><r>Wir könnten es doch so machen:</r> Ich nehme sicherheitshalber einen Regenschirm mit.<br><r>Passt dir das so?</r>",
      "en": "<r>Perfect, that's how we'll do it.</r><br><r>We could do it like this:</r> I bring an umbrella just in case.<br><r>Does that work for you?</r>",
      "uk": "<r>Чудово, так і зробимо.</r><br><r>Можна зробити так:</r> я про всяк випадок візьму парасольку.<br><r>Тобі так підходить?</r>",
  ...
  {
    "id": "dlg_058",
    "cat": "Ein Ausflugsziel auswählen",
    "type": "Gemeinsam etwas planen",
    "task": {
      "de": "Sie haben zwei Ideen für einen Ausflug: den Zoo oder das Museum. Sie möchten sich mit einem Freund / einer Freundin entscheiden.<br><br>Planen Sie zusammen mit Ihrer Gesprächspartnerin oder Ihrem Gesprächspartner, wie Sie das machen möchten.<br><br>Diese Punkte helfen Ihnen:<br>Zoo oder Museum?<br>Wie ist das Wetter?<br>Wann treffen wir uns?",
      "en": "You have two ideas for a trip: the zoo or the museum. You would like to decide together with a friend.<br><br>Plan together with your conversation partner how you would like to do this.<br><br>These points will help you:<br>Zoo or museum?<br>What's the weather like?<br>When do we meet?",
      "uk": "У вас є дві ідеї для екскурсії: зоопарк або музей. Ви хочете вирішити разом із другом / подругою.<br><br>Сплануйте разом зі своїм співрозмовником або співрозмовницею, як ви це зробите.<br><br>Ці пункти допоможуть вам:<br>Зоопарк чи музей?<br>Яка погода?<br>Коли зустрінемося?",
      "ru": "У вас есть две идеи для экскурсии: зоопарк или музей. Вы хотите решить вместе с другом / подругой.<br><br>Спланируйте вместе со своим собеседником или собеседницей, как вы это сделаете.<br><br>Эти пункты помогут вам:<br>Зоопарк или музей?<br>Какая погода?<br>Когда встретимся?"
    },
    "name_q": "de_w_nina",
    "name_a": "de_m_mark",
    "q": {
      "de": "Hallo Mark! Ich habe zwei Ideen für unseren Ausflug: den Zoo oder das Museum. Was meinst du?",
      "en": "Hi Mark! I have two ideas for our trip: the zoo or the museum. What do you think?",
      "uk": "Привіт, Марку! У мене є дві ідеї для нашої екскурсії: зоопарк або музей. Що думаєш?",
      "ru": "Привет, Марк! У меня есть две идеи для нашей экскурсии: зоопарк или музей. Что думаешь?"
    },
    "a": {
      "de": "<r>Klingt super, machen wir so.</r><br><r>Wir könnten doch</r> <g>diesen</g> Zoo besuchen, der soll sehr interessant sein.<br><r>Was denkst du?</r>",
      "en": "<r>Sounds great, let's do that.</r><br><r>We could</r> visit <g>this</g> zoo, it's supposed to be very interesting.<br><r>What do you think?</r>",
      "uk": "<r>Звучить чудово, зробімо так.</r><br><r>Ми могли б</r> відвідати цей зоопарк, кажуть, він дуже цікавий.<br><r>Що ти думаєш?</r>",
      "ru": "<r>Звучит отлично, так и сделаем.</r><br><r>Мы могли бы</r> посетить этот зоопарк, говорят, он очень интересный.<br><r>Что ты думаешь?</r>"
    },
    "q1": {
      "de": "<r>Das klingt gut, aber</r> <g>diese</g> Wettervorhersage sagt ein Gewitter voraus, das wäre schlecht für den Zoo.<br><r>Ich hätte einen Vorschlag:</r> Wir gehen stattdessen ins Museum.<br><r>Wie findest du das?</r>",
      "en": "<r>That sounds good, but</r> <g>this</g> weather forecast predicts a thunderstorm, that would be bad for the zoo.<br><r>I have a suggestion:</r> we go to the museum instead.<br><r>How do you like that?</r>",
      "uk": "<r>Це звучить непогано, але</r> цей прогноз погоди обіцяє грозу, це було б погано для зоопарку.<br><r>У мене є пропозиція:</r> підемо натомість у музей.<br><r>Як тобі така ідея?</r>",
      "ru": "<r>Это звучит неплохо, но</r> этот прогноз погоды обещает грозу, это было бы плохо для зоопарка.<br><r>У меня есть предложение:</r> пойдём вместо этого в музей.<br><r>Как тебе такая идея?</r>"
    },
    "a1": {
      "de": "<r>Einverstanden, das passt gut.</r><br><r>Mein Vorschlag wäre, dass</r> wir uns <g>dieses</g> neue Museum ansehen, es soll sehr spannend sein.<br><r>Bist du damit einverstanden?</r>",
      "en": "<r>Agreed, that works well.</r><br><r>My suggestion would be that</r> we visit <g>this</g> new museum, it's supposed to be very exciting.<br><r>Are you okay with that?</r>",
      "uk": "<r>Домовились, це підходить.</r><br><r>Моя пропозиція —</r> оглянути цей новий музей, кажуть, він дуже захопливий.<br><r>Ти згоден з цим?</r>",
      "ru": "<r>Договорились, это подходит.</r><br><r>Моё предложение —</r> осмотреть этот новый музей, говорят, он очень захватывающий.<br><r>Ты согласен с этим?</r>"
    },
    "q2": {
      "de": "<r>Perfekt, so machen wir es.</r><br><r>Wir könnten es doch so machen:</r> Wir treffen uns um elf Uhr vor dem Eingang.<br><r>Passt dir das so?</r>",
      "en": "<r>Perfect, that's how we'll do it.</r><br><r>We could do it like this:</r> we meet at eleven o'clock in front of the entrance.<br><r>Does that work for you?</r>",
      "uk": "<r>Чудово, так і зробимо.</r><br><r>Можна зробити так:</r> зустрінемося об одинадцятій перед входом.<br><r>Тобі так підходить?</r>",
  ...
  {
    "id": "dlg_059",
    "cat": "Einen Betriebsausflug planen",
    "type": "Gemeinsam etwas planen",
    "task": {
      "de": "Sie müssen den Betriebsausflug für dieses Jahr planen. Letztes Jahr war das Wetter nicht so gut.<br><br>Planen Sie zusammen mit Ihrer Gesprächspartnerin oder Ihrem Gesprächspartner, wie Sie das machen möchten.<br><br>Diese Punkte helfen Ihnen:<br>Wohin?<br>Was, wenn es kalt wird?<br>Wann?",
      "en": "You need to plan this year's company outing. Last year the weather wasn't very good.<br><br>Plan together with your conversation partner how you would like to do this.<br><br>These points will help you:<br>Where to?<br>What if it gets cold?<br>When?",
      "uk": "Вам потрібно спланувати корпоративну поїздку на цей рік. Минулого року погода була не дуже.<br><br>Сплануйте разом зі своїм співрозмовником або співрозмовницею, як ви це зробите.<br><br>Ці пункти допоможуть вам:<br>Куди?<br>Що робити, якщо стане холодно?<br>Коли?",
      "ru": "Вам нужно спланировать корпоративную поездку на этот год. В прошлом году погода была не очень.<br><br>Спланируйте вместе со своим собеседником или собеседницей, как вы это сделаете.<br><br>Эти пункты помогут вам:<br>Куда?<br>Что делать, если станет холодно?<br>Когда?"
    },
    "name_q": "de_m_david",
    "name_a": "de_w_nina",
    "q": {
      "de": "Hallo Nina! Wir müssen den Betriebsausflug für dieses Jahr planen. Hast du eine Idee?",
      "en": "Hi Nina! We need to plan this year's company outing. Do you have an idea?",
      "uk": "Привіт, Ніно! Нам треба спланувати корпоративну поїздку на цей рік. У тебе є ідея?",
      "ru": "Привет, Нина! Нам нужно спланировать корпоративную поездку на этот год. У тебя есть идея?"
    },
    "a": {
    ...
    "q1": {
      ...
      "en": "<r>That sounds good, but</r> last year the weather <g>was</g> really cold, that <g>was</g> not so nice.<br><r>I have a suggestion:</r> we choose an indoor place this time.<br><r>How do you like that?</r>",
      "uk": "<r>Це звучить непогано, але</r> минулого року погода була дуже холодна, це було не дуже приємно.<br><r>У мене є пропозиція:</r> цього разу оберемо місце в приміщенні.<br><r>Як тобі така ідея?</r>",
      "ru": "<r>Это звучит неплохо, но</r> в прошлом году погода была очень холодная, это было не очень приятно.<br><r>У меня есть предложение:</r> в этот раз выберем место в помещении.<br><r>Как тебе такая идея?</r>"
    },
    "a1": {
      "de": "<r>Einverstanden, das passt gut.</r><br><r>Mein Vorschlag wäre, dass</r> wir dieses Mal einen Plan B haben, weil wir letztes Mal keinen <g>hatten</g>.<br><r>Bist du damit einverstanden?</r>",
      "en": "<r>Agreed, that works well.</r><br><r>My suggestion would be that</r> we have a plan B this time, because we <g>had</g> none last time.<br><r>Are you okay with that?</r>",
      "uk": "<r>Домовились, це підходить.</r><br><r>Моя пропозиція —</r> цього разу мати план Б, бо минулого разу в нас його не було.<br><r>Ти згодна з цим?</r>",
      "ru": "<r>Договорились, это подходит.</r><br><r>Моё предложение —</r> в этот раз иметь план Б, потому что в прошлый раз его у нас не было.<br><r>Ты согласна с этим?</r>"
    },
    "q2": {
  ...
  {
    "id": "dlg_060",
    "cat": "Ein Zeltlager planen",
    "type": "Gemeinsam etwas planen",
    "task": {
      "de": "Sie möchten am Wochenende mit einem Freund / einer Freundin zelten gehen.<br><br>Planen Sie zusammen mit Ihrer Gesprächspartnerin oder Ihrem Gesprächspartner, wie Sie das machen möchten.<br><br>Diese Punkte helfen Ihnen:<br>Wo übernachten wir?<br>Welche Aktivitäten planen wir?<br>Wann kommen wir zurück?",
      "en": "You would like to go camping with a friend at the weekend.<br><br>Plan together with your conversation partner how you would like to do this.<br><br>These points will help you:<br>Where do we stay overnight?<br>What activities do we plan?<br>When do we come back?",
      "uk": "Ви хочете на вихідних піти в намети з другом / подругою.<br><br>Сплануйте разом зі своїм співрозмовником або співрозмовницею, як ви це зробите.<br><br>Ці пункти допоможуть вам:<br>Де ми ночуємо?<br>Які активності плануємо?<br>Коли повертаємось?",
      "ru": "Вы хотите на выходных пойти в поход с палатками с другом / подругой.<br><br>Спланируйте вместе со своим собеседником или собеседницей, как вы это сделаете.<br><br>Эти пункты помогут вам:<br>Где мы ночуем?<br>Какие активности планируем?<br>Когда возвращаемся?"
    },
    "name_q": "de_m_alex",
    "name_a": "de_w_anna",
    "q": {
      "de": "Hallo Anna! Wollen wir am Wochenende zusammen zelten gehen?",
      "en": "Hi Anna! Shall we go camping together at the weekend?",
      "uk": "Привіт, Анно! Підемо разом у намети на вихідних?",
      "ru": "Привет, Анна! Пойдём вместе в поход с палатками на выходных?"
    },
    "a": {
    ...
    "a1": {
      ...
      "en": "<r>Agreed, that works well.</r><br><r>My suggestion would be that</r> we make a campfire in the evening and sing together.<br><r>Are you okay with that?</r>",
      "uk": "<r>Домовились, це підходить.</r><br><r>Моя пропозиція —</r> увечері розпалити багаття і разом поспівати.<br><r>Ти згоден з цим?</r>",
      "ru": "<r>Договорились, это подходит.</r><br><r>Моё предложение —</r> вечером развести костёр и вместе попеть.<br><r>Ты согласен с этим?</r>"
    },
    "q2": {
      "de": "<r>Perfekt, so machen wir es.</r><br><r>Wir könnten es doch so machen:</r> Wir kommen am Sonntagabend zurück.<br><r>Passt dir das so?</r>",
      "en": "<r>Perfect, that's how we'll do it.</r><br><r>We could do it like this:</r> we come back on Sunday evening.<br><r>Does that work for you?</r>",
      "uk": "<r>Чудово, так і зробимо.</r><br><r>Можна зробити так:</r> повернемося в неділю ввечері.<br><r>Тобі так підходить?</r>",
  ...
  {
    "id": "dlg_061",
    "cat": "Eine Reise nach Berlin planen",
    "type": "Gemeinsam etwas planen",
    "task": {
      "de": "Sie möchten nächsten Monat mit einem Freund / einer Freundin nach Berlin fahren.<br><br>Planen Sie zusammen mit Ihrer Gesprächspartnerin oder Ihrem Gesprächspartner, wie Sie das machen möchten.<br><br>Diese Punkte helfen Ihnen:<br>Welche Wahrzeichen besuchen wir?<br>Was machen wir noch im Stadtzentrum?<br>Wann buchen wir die Tickets?",
      "en": "You would like to go to Berlin next month with a friend.<br><br>Plan together with your conversation partner how you would like to do this.<br><br>These points will help you:<br>Which landmarks do we visit?<br>What else do we do in the city center?<br>When do we book the tickets?",
      "uk": "Наступного місяця ви хочете поїхати до Берліна з другом / подругою.<br><br>Сплануйте разом зі своїм співрозмовником або співрозмовницею, як ви це зробите.<br><br>Ці пункти допоможуть вам:<br>Які пам'ятки ми відвідаємо?<br>Що ще ми зробимо в центрі міста?<br>Коли забронюємо квитки?",
      "ru": "В следующем месяце вы хотите поехать в Берлин с другом / подругой.<br><br>Спланируйте вместе со своим собеседником или собеседницей, как вы это сделаете.<br><br>Эти пункты помогут вам:<br>Какие достопримечательности мы посетим?<br>Что ещё мы сделаем в центре города?<br>Когда забронируем билеты?"
    },
    "name_q": "de_m_mark",
    "name_a": "de_w_anna",
    "q": {
      "de": "Hallo Anna! Wollen wir nächsten Monat nach Berlin fahren? Die Hauptstadt soll toll sein.",
      "en": "Hi Anna! Shall we go to Berlin next month? The capital is supposed to be great.",
      "uk": "Привіт, Анно! Поїдемо наступного місяця до Берліна? Кажуть, столиця чудова.",
      "ru": "Привет, Анна! Поедем в следующем месяце в Берлин? Говорят, столица классная."
    },
    "a": {
      "de": "<r>Klingt super, machen wir so.</r><br><r>Wir könnten doch</r> zuerst <g>zum</g> Brandenburger Tor gehen.<br><r>Was denkst du?</r>",
      "en": "<r>Sounds great, let's do that.</r><br><r>We could</r> go to the Brandenburg Gate first.<br><r>What do you think?</r>",
      "uk": "<r>Звучить чудово, зробімо так.</r><br><r>Ми могли б</r> спочатку піти до Бранденбурзьких воріт.<br><r>Що ти думаєш?</r>",
      "ru": "<r>Звучит отлично, так и сделаем.</r><br><r>Мы могли бы</r> сначала пойти к Бранденбургским воротам.<br><r>Что ты думаешь?</r>"
    },
    "q1": {
      "de": "<r>Das klingt gut, aber</r> ich möchte auch gerne <g>an der</g> Spree spazieren gehen.<br><r>Ich hätte einen Vorschlag:</r> Wir gehen über die Brücke zum Wahrzeichen.<br><r>Wie findest du das?</r>",
      "en": "<r>That sounds good, but</r> I would also like to take a walk <g>by the</g> Spree.<br><r>I have a suggestion:</r> we walk over the bridge to the landmark.<br><r>How do you like that?</r>",
      "uk": "<r>Це звучить непогано, але</r> я також хотів би прогулятися вздовж Шпреє.<br><r>У мене є пропозиція:</r> перейдемо міст до пам'ятки.<br><r>Як тобі така ідея?</r>",
      "ru": "<r>Это звучит неплохо, но</r> я тоже хотел бы прогуляться вдоль Шпрее.<br><r>У меня есть предложение:</r> перейдём мост к достопримечательности.<br><r>Как тебе такая идея?</r>"
    },
    "a1": {
    ...
    "q2": {
      ...
      "en": "<r>Perfect, that's how we'll do it.</r><br><r>We could do it like this:</r> we book the train tickets <g>to</g> Berlin today already.<br><r>Does that work for you?</r>",
      "uk": "<r>Чудово, так і зробимо.</r><br><r>Можна зробити так:</r> забронюємо квитки на потяг до Берліна вже сьогодні.<br><r>Тобі так підходить?</r>",
  ...
  {
    "id": "dlg_062",
    "cat": "Eine Fußgängertour durch Berlin planen",
    "type": "Gemeinsam etwas planen",
    "task": {
      "de": "Sie haben eine Route für einen Spaziergang durch Berlin geplant und möchten das mit einem Freund / einer Freundin besprechen.<br><br>Planen Sie zusammen mit Ihrer Gesprächspartnerin oder Ihrem Gesprächspartner, wie Sie das machen möchten.<br><br>Diese Punkte helfen Ihnen:<br>Wo starten wir?<br>Was besuchen wir?<br>Wo machen wir eine Pause?",
      "en": "You have planned a route for a walk through Berlin and would like to discuss it with a friend.<br><br>Plan together with your conversation partner how you would like to do this.<br><br>These points will help you:<br>Where do we start?<br>What do we visit?<br>Where do we take a break?",
      "uk": "Ви спланували маршрут прогулянки Берліном і хочете обговорити це з другом / подругою.<br><br>Сплануйте разом зі своїм співрозмовником або співрозмовницею, як ви це зробите.<br><br>Ці пункти допоможуть вам:<br>Де ми стартуємо?<br>Що ми відвідаємо?<br>Де зробимо перерву?",
      "ru": "Вы спланировали маршрут прогулки по Берлину и хотите обсудить это с другом / подругой.<br><br>Спланируйте вместе со своим собеседником или собеседницей, как вы это сделаете.<br><br>Эти пункты помогут вам:<br>Где мы стартуем?<br>Что мы посетим?<br>Где сделаем перерыв?"
    },
    "name_q": "de_m_alex",
    "name_a": "de_w_nina",
    "q": {
      "de": "Hallo Nina! Ich habe eine Route für unseren Spaziergang durch Berlin geplant. Willst du sie dir ansehen?",
      "en": "Hi Nina! I've planned a route for our walk through Berlin. Do you want to take a look at it?",
      "uk": "Привіт, Ніно! Я спланував маршрут для нашої прогулянки Берліном. Хочеш поглянути?",
      "ru": "Привет, Нина! Я спланировал маршрут для нашей прогулки по Берлину. Хочешь взглянуть?"
    },
    "a": {
    ...
    "q1": {
      ...
      "en": "<r>That sounds good, but</r> the museum is <g>across from</g> the town hall, we should visit that too.<br><r>I have a suggestion:</r> we go to the museum first, then the town hall.<br><r>How do you like that?</r>",
      "uk": "<r>Це звучить непогано, але</r> музей розташований навпроти ратуші, туди теж варто зайти.<br><r>У мене є пропозиція:</r> спочатку йдемо в музей, потім до ратуші.<br><r>Як тобі така ідея?</r>",
      "ru": "<r>Это звучит неплохо, но</r> музей находится напротив ратуши, туда тоже стоит зайти.<br><r>У меня есть предложение:</r> сначала идём в музей, потом в ратушу.<br><r>Как тебе такая идея?</r>"
    },
    "a1": {
      "de": "<r>Einverstanden, das passt gut.</r><br><r>Mein Vorschlag wäre, dass</r> wir danach in dem Café <g>neben</g> dem Museum eine Pause machen.<br><r>Bist du damit einverstanden?</r>",
      "en": "<r>Agreed, that works well.</r><br><r>My suggestion would be that</r> we then take a break in the café <g>next to</g> the museum.<br><r>Are you okay with that?</r>",
      "uk": "<r>Домовились, це підходить.</r><br><r>Моя пропозиція —</r> потім зробити перерву в кафе поруч із музеєм.<br><r>Ти згодна з цим?</r>",
      "ru": "<r>Договорились, это подходит.</r><br><r>Моё предложение —</r> потом сделать перерыв в кафе рядом с музеем.<br><r>Ты согласна с этим?</r>"
    },
    "q2": {
      "de": "<r>Perfekt, so machen wir es.</r><br><r>Wir könnten es doch so machen:</r> Wir treffen uns <g>zwischen</g> der Bushaltestelle und dem Museum.<br><r>Passt dir das so?</r>",
      "en": "<r>Perfect, that's how we'll do it.</r><br><r>We could do it like this:</r> we meet <g>between</g> the bus stop and the museum.<br><r>Does that work for you?</r>",
      "uk": "<r>Чудово, так і зробимо.</r><br><r>Можна зробити так:</r> зустрінемося між автобусною зупинкою і музеєм.<br><r>Тобі так підходить?</r>",
  ...
  {
    "id": "dlg_063",
    "cat": "Eine Stadtbesichtigung nach unseren Interessen planen",
    "type": "Gemeinsam etwas planen",
    "task": {
      "de": "Sie sind ein großer Fan von Geschichte und möchten mit einem Freund / einer Freundin eine Stadtbesichtigung planen.<br><br>Planen Sie zusammen mit Ihrer Gesprächspartnerin oder Ihrem Gesprächspartner, wie Sie das machen möchten.<br><br>Diese Punkte helfen Ihnen:<br>Was besuchen wir?<br>Wo essen wir?<br>Womit hören wir auf?",
      "en": "You are a big fan of history and would like to plan a city tour with a friend.<br><br>Plan together with your conversation partner how you would like to do this.<br><br>These points will help you:<br>What do we visit?<br>Where do we eat?<br>What do we finish with?",
      "uk": "Ви великий фанат історії й хочете спланувати огляд міста з другом / подругою.<br><br>Сплануйте разом зі своїм співрозмовником або співрозмовницею, як ви це зробите.<br><br>Ці пункти допоможуть вам:<br>Що ми відвідаємо?<br>Де поїмо?<br>Чим завершимо?",
      "ru": "Вы большой фанат истории и хотите спланировать осмотр города с другом / подругой.<br><br>Спланируйте вместе со своим собеседником или собеседницей, как вы это сделаете.<br><br>Эти пункты помогут вам:<br>Что мы посетим?<br>Где поедим?<br>Чем закончим?"
    },
    "name_q": "de_w_julia",
    "name_a": "de_m_david",
    "q": {
      "de": "Hallo David! Ich bin ein großer Fan von Geschichte. Können wir eine Stadtbesichtigung planen?",
      "en": "Hi David! I'm a big fan of history. Can we plan a city tour?",
      "uk": "Привіт, Девіде! Я великий фанат історії. Можемо спланувати огляд міста?",
      "ru": "Привет, Дэвид! Я большой фанат истории. Можем спланировать осмотр города?"
    },
    "a": {
      "de": "<r>Klingt super, machen wir so.</r><br><r>Wir könnten doch</r> ein <g>historisches</g> Gebäude besuchen.<br><r>Was denkst du?</r>",
      "en": "<r>Sounds great, let's do that.</r><br><r>We could</r> visit a <g>historical</g> building.<br><r>What do you think?</r>",
      "uk": "<r>Звучить чудово, зробімо так.</r><br><r>Ми могли б</r> відвідати історичну будівлю.<br><r>Що ти думаєш?</r>",
      "ru": "<r>Звучит отлично, так и сделаем.</r><br><r>Мы могли бы</r> посетить историческое здание.<br><r>Что ты думаешь?</r>"
    },
    "q1": {
      "de": "<r>Das klingt gut, aber</r> ich würde auch gerne den <g>berühmten</g> Platz in der Nähe sehen.<br><r>Ich hätte einen Vorschlag:</r> Wir gehen zuerst dorthin und dann zum Gebäude.<br><r>Wie findest du das?</r>",
      "en": "<r>That sounds good, but</r> I would also like to see the <g>famous</g> square nearby.<br><r>I have a suggestion:</r> we go there first and then to the building.<br><r>How do you like that?</r>",
      "uk": "<r>Це звучить непогано, але</r> я також хотіла б побачити відому площу поблизу.<br><r>У мене є пропозиція:</r> спочатку туди, а потім до будівлі.<br><r>Як тобі така ідея?</r>",
      "ru": "<r>Это звучит неплохо, но</r> я тоже хотела бы увидеть знаменитую площадь поблизости.<br><r>У меня есть предложение:</r> сначала туда, а потом к зданию.<br><r>Как тебе такая идея?</r>"
    },
    "a1": {
      "de": "<r>Einverstanden, das passt gut.</r><br><r>Mein Vorschlag wäre, dass</r> wir in einem <g>typischen</g> Restaurant essen, wenn wir fertig sind.<br><r>Bist du damit einverstanden?</r>",
      "en": "<r>Agreed, that works well.</r><br><r>My suggestion would be that</r> we eat in a <g>typical</g> restaurant when we're done.<br><r>Are you okay with that?</r>",
      "uk": "<r>Домовились, це підходить.</r><br><r>Моя пропозиція —</r> поїсти в типовому ресторані, коли закінчимо.<br><r>Ти згоден з цим?</r>",
      "ru": "<r>Договорились, это подходит.</r><br><r>Моё предложение —</r> поесть в типичном ресторане, когда закончим.<br><r>Ты согласен с этим?</r>"
    },
    "q2": {
  ...
  {
    "id": "dlg_064",
    "cat": "Die Bewerbung für ein Praktikum vorbereiten",
    "type": "Gemeinsam etwas planen",
    "task": {
      "de": "Sie möchten sich für ein Praktikum bewerben und brauchen Hilfe bei der Vorbereitung.<br><br>Planen Sie zusammen mit Ihrer Gesprächspartnerin oder Ihrem Gesprächspartner, wie Sie das machen möchten.<br><br>Diese Punkte helfen Ihnen:<br>Was üben wir zuerst?<br>Was schreiben wir in die Bewerbung?<br>Wann treffen wir uns?",
      "en": "You would like to apply for an internship and need help preparing.<br><br>Plan together with your conversation partner how you would like to do this.<br><br>These points will help you:<br>What do we practise first?<br>What do we write in the application?<br>When do we meet?",
      "uk": "Ви хочете подати заявку на стажування і потребуєте допомоги з підготовкою.<br><br>Сплануйте разом зі своїм співрозмовником або співрозмовницею, як ви це зробите.<br><br>Ці пункти допоможуть вам:<br>Що ми потренуємо спочатку?<br>Що напишемо в заявці?<br>Коли зустрінемося?",
      "ru": "Вы хотите подать заявку на стажировку и нуждаетесь в помощи с подготовкой.<br><br>Спланируйте вместе со своим собеседником или собеседницей, как вы это сделаете.<br><br>Эти пункты помогут вам:<br>Что мы потренируем сначала?<br>Что напишем в заявке?<br>Когда встретимся?"
    },
    "name_q": "de_w_nina",
    "name_a": "de_w_julia",
    "q": {
      "de": "Hallo Julia! Ich möchte mich für ein Praktikum bewerben. Kannst du mir helfen, mich vorzubereiten?",
      "en": "Hi Julia! I would like to apply for an internship. Can you help me prepare?",
      "uk": "Привіт, Юліє! Я хочу подати заявку на стажування. Можеш допомогти мені підготуватися?",
      "ru": "Привет, Юлия! Я хочу подать заявку на стажировку. Можешь помочь мне подготовиться?"
    },
    "a": {
      "de": "<r>Klingt super, machen wir so.</r><br><r>Wir könnten doch</r> zuerst für die Prüfung üben.<br><r>Was denkst du?</r>",
      "en": "<r>Sounds great, let's do that.</r><br><r>We could</r> practise for the exam first.<br><r>What do you think?</r>",
      "uk": "<r>Звучить чудово, зробімо так.</r><br><r>Ми могли б</r> спочатку потренуватися перед іспитом.<br><r>Що ти думаєш?</r>",
      "ru": "<r>Звучит отлично, так и сделаем.</r><br><r>Мы могли бы</r> сначала потренироваться перед экзаменом.<br><r>Что ты думаешь?</r>"
    },
    "q1": {
  ...
  {
    "id": "dlg_065",
    "cat": "Den Schulalltag des Kindes organisieren",
    "type": "Gemeinsam etwas planen",
    "task": {
      "de": "Ihr Kind hat morgen eine Klassenarbeit. Sie möchten mit Ihrem Partner / Ihrer Partnerin den Nachmittag planen.<br><br>Planen Sie zusammen mit Ihrer Gesprächspartnerin oder Ihrem Gesprächspartner, wie Sie das machen möchten.<br><br>Diese Punkte helfen Ihnen:<br>Wer hilft bei den Hausaufgaben?<br>Wer holt das Kind ab?<br>Was üben wir noch?",
      "en": "Your child has a class test tomorrow. You would like to plan the afternoon with your partner.<br><br>Plan together with your conversation partner how you would like to do this.<br><br>These points will help you:<br>Who helps with the homework?<br>Who picks up the child?<br>What else do we practise?",
      "uk": "У вашої дитини завтра контрольна робота. Ви хочете спланувати вечір зі своїм партнером / партнеркою.<br><br>Сплануйте разом зі своїм співрозмовником або співрозмовницею, як ви це зробите.<br><br>Ці пункти допоможуть вам:<br>Хто допомагає з домашнім завданням?<br>Хто забирає дитину?<br>Що ще потренуємо?",
      "ru": "У вашего ребёнка завтра контрольная работа. Вы хотите спланировать вечер со своим партнёром / партнёршей.<br><br>Спланируйте вместе со своим собеседником или собеседницей, как вы это сделаете.<br><br>Эти пункты помогут вам:<br>Кто помогает с домашним заданием?<br>Кто забирает ребёнка?<br>Что ещё потренируем?"
    },
    "name_q": "de_m_mark",
    "name_a": "de_w_anna",
    "q": {
      "de": "Hallo Anna! Wir müssen den Nachmittag für unser Kind planen. Es hat morgen eine Klassenarbeit.",
      "en": "Hi Anna! We need to plan the afternoon for our child. They have a class test tomorrow.",
      "uk": "Привіт, Анно! Нам треба спланувати вечір для нашої дитини. Завтра в неї контрольна робота.",
      "ru": "Привет, Анна! Нам нужно спланировать вечер для нашего ребёнка. Завтра у него контрольная работа."
    },
    "a": {
      "de": "<r>Klingt super, machen wir so.</r><br><r>Wir könnten doch</r> zuerst die Hausaufgaben zusammen machen.<br><r>Was denkst du?</r>",
      "en": "<r>Sounds great, let's do that.</r><br><r>We could</r> do the homework together first.<br><r>What do you think?</r>",
      "uk": "<r>Звучить чудово, зробімо так.</r><br><r>Ми могли б</r> спочатку разом зробити домашнє завдання.<br><r>Що ти думаєш?</r>",
      "ru": "<r>Звучит отлично, так и сделаем.</r><br><r>Мы могли бы</r> сначала вместе сделать домашнее задание.<br><r>Что ты думаешь?</r>"
    },
    "q1": {
      "de": "<r>Das klingt gut, aber</r> es <g>hat</g> letztes Mal eine schlechte Note <g>bekommen</g>, wir sollten extra üben.<br><r>Ich hätte einen Vorschlag:</r> Wir üben die Themen aus dem letzten Zeugnis.<br><r>Wie findest du das?</r>",
      "en": "<r>That sounds good, but</r> they <g>got</g> a bad grade last time, we should practise extra.<br><r>I have a suggestion:</r> we practise the topics from the last report.<br><r>How do you like that?</r>",
      "uk": "<r>Це звучить непогано, але</r> минулого разу він отримав погану оцінку, нам варто потренуватися додатково.<br><r>У мене є пропозиція:</r> потренуємо теми з останнього табеля.<br><r>Як тобі така ідея?</r>",
      "ru": "<r>Это звучит неплохо, но</r> в прошлый раз он получил плохую оценку, нам стоит потренироваться дополнительно.<br><r>У меня есть предложение:</r> потренируем темы из последнего табеля.<br><r>Как тебе такая идея?</r>"
    },
    "a1": {
    ...
    "q2": {
      ...
      "en": "<r>Perfect, that's how we'll do it.</r><br><r>We could do it like this:</r> we <g>have</g> already <g>achieved</g> a lot today, now we go through the timetable once more.<br><r>Does that work for you?</r>",
      "uk": "<r>Чудово, так і зробимо.</r><br><r>Можна зробити так:</r> ми вже сьогодні багато встигли, тепер ще раз переглянемо розклад уроків.<br><r>Тобі так підходить?</r>",
  ...
  {
    "id": "dlg_066",
    "cat": "Sich auf den Elternsprechtag vorbereiten",
    "type": "Gemeinsam etwas planen",
    "task": {
      "de": "Morgen ist der Elternsprechtag Ihres Kindes. Sie möchten sich mit Ihrem Partner / Ihrer Partnerin vorbereiten.<br><br>Planen Sie zusammen mit Ihrer Gesprächspartnerin oder Ihrem Gesprächspartner, wie Sie das machen möchten.<br><br>Diese Punkte helfen Ihnen:<br>Worüber sprechen wir?<br>Was fragen wir die Lehrerin?<br>Wann bereiten wir uns vor?",
      "en": "Tomorrow is your child's parent-teacher conference. You would like to prepare with your partner.<br><br>Plan together with your conversation partner how you would like to do this.<br><br>These points will help you:<br>What do we talk about?<br>What do we ask the teacher?<br>When do we prepare?",
      "uk": "Завтра батьківські збори у вашої дитини. Ви хочете підготуватися зі своїм партнером / партнеркою.<br><br>Сплануйте разом зі своїм співрозмовником або співрозмовницею, як ви це зробите.<br><br>Ці пункти допоможуть вам:<br>Про що ми говоримо?<br>Що ми запитаємо вчительку?<br>Коли ми готуємося?",
      "ru": "Завтра родительское собрание у вашего ребёнка. Вы хотите подготовиться со своим партнёром / партнёршей.<br><br>Спланируйте вместе со своим собеседником или собеседницей, как вы это сделаете.<br><br>Эти пункты помогут вам:<br>О чём мы говорим?<br>Что мы спросим у учительницы?<br>Когда мы готовимся?"
    },
    "name_q": "de_m_alex",
    "name_a": "de_w_julia",
    "q": {
      "de": "Hallo Julia! Morgen ist der Elternsprechtag. Wollen wir uns kurz vorbereiten?",
      "en": "Hi Julia! Tomorrow is the parent-teacher conference. Shall we prepare briefly?",
      "uk": "Привіт, Юліє! Завтра батьківські збори. Підготуємось трохи?",
      "ru": "Привет, Юлия! Завтра родительское собрание. Подготовимся немного?"
    },
    "a": {
    ...
    "q1": {
      ...
      "en": "<r>That sounds good, but</r> I <g>am annoyed</g> <g>about</g> the noise in the classroom, we should bring that up.<br><r>I have a suggestion:</r> we ask the teacher about it.<br><r>How do you like that?</r>",
      "uk": "<r>Це звучить непогано, але</r> мене дратує шум у класі, це нам варто підняти.<br><r>У мене є пропозиція:</r> запитаємо про це вчительку.<br><r>Як тобі така ідея?</r>",
      "ru": "<r>Это звучит неплохо, но</r> меня раздражает шум в классе, это нам стоит поднять.<br><r>У меня есть предложение:</r> спросим об этом учительницу.<br><r>Как тебе такая идея?</r>"
    },
    "a1": {
      "de": "<r>Einverstanden, das passt gut.</r><br><r>Mein Vorschlag wäre, dass</r> wir uns auch <g>auf</g> die guten Nachrichten <g>freuen</g>, unser Kind interessiert sich sehr für Mathe.<br><r>Bist du damit einverstanden?</r>",
      "en": "<r>Agreed, that works well.</r><br><r>My suggestion would be that</r> we also <g>look forward</g> <g>to</g> the good news, our child is very interested in maths.<br><r>Are you okay with that?</r>",
      "uk": "<r>Домовились, це підходить.</r><br><r>Моя пропозиція —</r> також радіти хорошим новинам, наша дитина дуже цікавиться математикою.<br><r>Ти згоден з цим?</r>",
      "ru": "<r>Договорились, это подходит.</r><br><r>Моё предложение —</r> тоже радоваться хорошим новостям, наш ребёнок очень интересуется математикой.<br><r>Ты согласен с этим?</r>"
    },
    "q2": {
      "de": "<r>Perfekt, so machen wir es.</r><br><r>Wir könnten es doch so machen:</r> Wir bereiten uns heute Abend zusammen <g>auf</g> das Gespräch <g>vor</g>.<br><r>Passt dir das so?</r>",
      "en": "<r>Perfect, that's how we'll do it.</r><br><r>We could do it like this:</r> we <g>prepare</g> together <g>for</g> the conversation tonight.<br><r>Does that work for you?</r>",
      "uk": "<r>Чудово, так і зробимо.</r><br><r>Можна зробити так:</r> сьогодні ввечері разом підготуємося до розмови.<br><r>Тобі так підходить?</r>",
  ...
  {
    "id": "dlg_067",
    "cat": "Eine Lernzeit vor dem Test planen",
    "type": "Gemeinsam etwas planen",
    "task": {
      "de": "Die Kinder haben nächste Woche einen wichtigen Test. Sie möchten mit Ihrem Partner / Ihrer Partnerin eine Lernzeit einplanen.<br><br>Planen Sie zusammen mit Ihrer Gesprächspartnerin oder Ihrem Gesprächspartner, wie Sie das machen möchten.<br><br>Diese Punkte helfen Ihnen:<br>Wie lange lernen wir jeden Tag?<br>Wie oft machen wir Pausen?<br>Wo lernen wir?",
      "en": "The children have an important test next week. You would like to plan a study time with your partner.<br><br>Plan together with your conversation partner how you would like to do this.<br><br>These points will help you:<br>How long do we study each day?<br>How often do we take breaks?<br>Where do we study?",
      "uk": "У дітей наступного тижня важливий тест. Ви хочете спланувати час для навчання зі своїм партнером / партнеркою.<br><br>Сплануйте разом зі своїм співрозмовником або співрозмовницею, як ви це зробите.<br><br>Ці пункти допоможуть вам:<br>Скільки часу вчимося щодня?<br>Як часто робимо перерви?<br>Де вчимося?",
      "ru": "У детей на следующей неделе важный тест. Вы хотите спланировать время для учёбы со своим партнёром / партнёршей.<br><br>Спланируйте вместе со своим собеседником или собеседницей, как вы это сделаете.<br><br>Эти пункты помогут вам:<br>Сколько времени учимся каждый день?<br>Как часто делаем перерывы?<br>Где учимся?"
    },
    "name_q": "de_m_mark",
    "name_a": "de_m_david",
    "q": {
      "de": "Hallo David! Die Kinder haben nächste Woche einen wichtigen Test. Sollen wir eine Lernzeit einplanen?",
      "en": "Hi David! The children have an important test next week. Shall we plan a study time?",
      "uk": "Привіт, Девіде! У дітей наступного тижня важливий тест. Спланюємо час для навчання?",
      "ru": "Привет, Дэвид! У детей на следующей неделе важный тест. Спланируем время для учёбы?"
    },
    "a": {
      "de": "<r>Klingt super, machen wir so.</r><br><r>Wir könnten doch</r> jeden Tag eine Stunde zusammen lernen.<br><r>Was denkst du?</r>",
      "en": "<r>Sounds great, let's do that.</r><br><r>We could</r> study together for an hour every day.<br><r>What do you think?</r>",
      "uk": "<r>Звучить чудово, зробімо так.</r><br><r>Ми могли б</r> щодня годину вчитися разом.<br><r>Що ти думаєш?</r>",
      "ru": "<r>Звучит отлично, так и сделаем.</r><br><r>Мы могли бы</r> каждый день по часу учиться вместе.<br><r>Что ты думаешь?</r>"
    },
    "q1": {
  ...
  {
    "id": "dlg_068",
    "cat": "Sich um ein Förderprogramm bewerben",
    "type": "Gemeinsam etwas planen",
    "task": {
      "de": "Ihr Kind ist sehr begabt in Mathe. Sie möchten mit Ihrem Partner / Ihrer Partnerin die Bewerbung für ein Förderprogramm planen.<br><br>Planen Sie zusammen mit Ihrer Gesprächspartnerin oder Ihrem Gesprächspartner, wie Sie das machen möchten.<br><br>Diese Punkte helfen Ihnen:<br>Mit wem sprechen wir zuerst?<br>Was müssen wir vorbereiten?<br>Bis wann bewerben wir uns?",
      "en": "Your child is very talented in maths. You would like to plan the application for a gifted program with your partner.<br><br>Plan together with your conversation partner how you would like to do this.<br><br>These points will help you:<br>Who do we talk to first?<br>What do we need to prepare?<br>By when do we apply?",
      "uk": "Ваша дитина дуже обдарована в математиці. Ви хочете спланувати заявку на програму для обдарованих зі своїм партнером / партнеркою.<br><br>Сплануйте разом зі своїм співрозмовником або співрозмовницею, як ви це зробите.<br><br>Ці пункти допоможуть вам:<br>З ким ми поговоримо спочатку?<br>Що нам треба підготувати?<br>До коли подаємо заявку?",
      "ru": "Ваш ребёнок очень одарён в математике. Вы хотите спланировать заявку на программу для одарённых со своим партнёром / партнёршей.<br><br>Спланируйте вместе со своим собеседником или собеседницей, как вы это сделаете.<br><br>Эти пункты помогут вам:<br>С кем мы поговорим сначала?<br>Что нам нужно подготовить?<br>До какого числа подаём заявку?"
    },
    "name_q": "de_w_anna",
    "name_a": "de_w_julia",
    "q": {
      "de": "Hallo Julia! Unser Kind ist wirklich begabt in Mathe. Sollen wir es für das Förderprogramm anmelden?",
      "en": "Hi Julia! Our child is really talented in maths. Shall we sign them up for the gifted program?",
      "uk": "Привіт, Юліє! Наша дитина справді обдарована в математиці. Запишемо її на програму для обдарованих?",
      "ru": "Привет, Юлия! Наш ребёнок действительно одарён в математике. Запишем его на программу для одарённых?"
    },
    "a": {
      "de": "<r>Klingt super, machen wir so.</r><br><r>Wir könnten doch</r> zuerst mit der Klassenlehrerin sprechen.<br><r>Was denkst du?</r>",
      "en": "<r>Sounds great, let's do that.</r><br><r>We could</r> talk to the homeroom teacher first.<br><r>What do you think?</r>",
      "uk": "<r>Звучить чудово, зробімо так.</r><br><r>Ми могли б</r> спочатку поговорити з класною керівницею.<br><r>Що ти думаєш?</r>",
      "ru": "<r>Звучит отлично, так и сделаем.</r><br><r>Мы могли бы</r> сначала поговорить с классным руководителем.<br><r>Что ты думаешь?</r>"
    },
    "q1": {
    ...
    "q2": {
      ...
      "en": "<r>Perfect, that's how we'll do it.</r><br><r>We could do it like this:</r> we call the school tomorrow and arrange an appointment.<br><r>Does that work for you?</r>",
      "uk": "<r>Чудово, так і зробимо.</r><br><r>Можна зробити так:</r> завтра зателефонуємо в школу і домовимося про зустріч.<br><r>Тобі так підходить?</r>",
  ...
  {
    "id": "dlg_069",
    "cat": "Ein Gespräch zur Konfliktlösung planen",
    "type": "Gemeinsam etwas planen",
    "task": {
      "de": "Sie und Ihr Mitbewohner / Ihre Mitbewohnerin streiten sich in letzter Zeit oft. Sie möchten ein ruhiges Gespräch planen.<br><br>Planen Sie zusammen mit Ihrer Gesprächspartnerin oder Ihrem Gesprächspartner, wie Sie das machen möchten.<br><br>Diese Punkte helfen Ihnen:<br>Wann reden wir?<br>Wo reden wir?<br>Was schreiben wir vorher auf?",
      "en": "You and your flatmate have been arguing a lot lately. You would like to plan a calm conversation.<br><br>Plan together with your conversation partner how you would like to do this.<br><br>These points will help you:<br>When do we talk?<br>Where do we talk?<br>What do we write down beforehand?",
      "uk": "Ви й ваш співмешканець / співмешканка останнім часом часто сваритеся. Ви хочете спланувати спокійну розмову.<br><br>Сплануйте разом зі своїм співрозмовником або співрозмовницею, як ви це зробите.<br><br>Ці пункти допоможуть вам:<br>Коли розмовляємо?<br>Де розмовляємо?<br>Що записуємо заздалегідь?",
      "ru": "Вы и ваш сосед / соседка по квартире в последнее время часто ссоритесь. Вы хотите спланировать спокойный разговор.<br><br>Спланируйте вместе со своим собеседником или собеседницей, как вы это сделаете.<br><br>Эти пункты помогут вам:<br>Когда разговариваем?<br>Где разговариваем?<br>Что записываем заранее?"
    },
    "name_q": "de_m_mark",
    "name_a": "de_w_julia",
    "q": {
      "de": "Hallo Julia! Wir streiten uns in letzter Zeit oft. Sollen wir mal in Ruhe darüber reden?",
      "en": "Hi Julia! We've been arguing a lot lately. Shall we talk about it calmly sometime?",
      "uk": "Привіт, Юліє! Останнім часом ми часто сваримося. Може, поговоримо про це спокійно?",
      "ru": "Привет, Юлия! В последнее время мы часто ссоримся. Может, поговорим об этом спокойно?"
    },
    "a": {
      "de": "<r>Klingt super, machen wir so.</r><br><r>Wir könnten doch</r> heute Abend einen ruhigen Moment dafür finden.<br><r>Was denkst du?</r>",
      "en": "<r>Sounds great, let's do that.</r><br><r>We could</r> find a quiet moment for it tonight.<br><r>What do you think?</r>",
      "uk": "<r>Звучить чудово, зробімо так.</r><br><r>Ми могли б</r> знайти для цього спокійну хвилину сьогодні ввечері.<br><r>Що ти думаєш?</r>",
      "ru": "<r>Звучит отлично, так и сделаем.</r><br><r>Мы могли бы</r> найти для этого спокойную минуту сегодня вечером.<br><r>Что ты думаешь?</r>"
    },
    "q1": {
      "de": "<r>Das klingt gut, aber</r> ich bin manchmal noch wütend, <g>deshalb brauche</g> ich vielleicht noch etwas Zeit.<br><r>Ich hätte einen Vorschlag:</r> Wir warten bis morgen früh, dann sind wir ruhiger.<br><r>Wie findest du das?</r>",
      "en": "<r>That sounds good, but</r> I'm still sometimes angry, <g>that's why I need</g> maybe a bit more time.<br><r>I have a suggestion:</r> we wait until tomorrow morning, then we'll be calmer.<br><r>How do you like that?</r>",
      "uk": "<r>Це звучить непогано, але</r> я іноді ще злий, тому мені, можливо, потрібен ще трохи час.<br><r>У мене є пропозиція:</r> зачекаємо до завтрашнього ранку, тоді будемо спокійніші.<br><r>Як тобі така ідея?</r>",
      "ru": "<r>Это звучит неплохо, но</r> я иногда ещё злюсь, поэтому мне, возможно, нужно ещё немного времени.<br><r>У меня есть предложение:</r> подождём до завтрашнего утра, тогда будем спокойнее.<br><r>Как тебе такая идея?</r>"
    },
    "a1": {
      "de": "<r>Einverstanden, das passt gut.</r><br><r>Mein Vorschlag wäre, dass</r> ich mir vorher Notizen mache, <g>deshalb vergesse</g> ich nichts Wichtiges.<br><r>Bist du damit einverstanden?</r>",
      "en": "<r>Agreed, that works well.</r><br><r>My suggestion would be that</r> I take notes beforehand, <g>that's why I won't forget</g> anything important.<br><r>Are you okay with that?</r>",
      "uk": "<r>Домовились, це підходить.</r><br><r>Моя пропозиція —</r> я заздалегідь зроблю нотатки, тому нічого важливого не забуду.<br><r>Ти згоден з цим?</r>",
      "ru": "<r>Договорились, это подходит.</r><br><r>Моё предложение —</r> я заранее сделаю заметки, поэтому ничего важного не забуду.<br><r>Ты согласен с этим?</r>"
    },
    "q2": {
      "de": "<r>Perfekt, so machen wir es.</r><br><r>Wir könnten es doch so machen:</r> Wir setzen uns morgen früh in die Küche und sprechen in Ruhe.<br><r>Passt dir das so?</r>",
      "en": "<r>Perfect, that's how we'll do it.</r><br><r>We could do it like this:</r> we sit down in the kitchen tomorrow morning and talk calmly.<br><r>Does that work for you?</r>",
      "uk": "<r>Чудово, так і зробимо.</r><br><r>Можна зробити так:</r> завтра вранці сядемо на кухні й спокійно поговоримо.<br><r>Тобі так підходить?</r>",
  ...
  {
    "id": "dlg_070",
    "cat": "Um einen Gefallen bitten",
    "type": "Gemeinsam etwas planen",
    "task": {
      "de": "Sie möchten sich für morgen ein Auto von einem Freund / einer Freundin ausleihen.<br><br>Planen Sie zusammen mit Ihrer Gesprächspartnerin oder Ihrem Gesprächspartner, wie Sie das machen möchten.<br><br>Diese Punkte helfen Ihnen:<br>Wie fragen wir höflich?<br>Worauf sollten wir achten?<br>Wann geben wir das Auto zurück?",
      "en": "You would like to borrow a car from a friend for tomorrow.<br><br>Plan together with your conversation partner how you would like to do this.<br><br>These points will help you:<br>How do we ask politely?<br>What should we pay attention to?<br>When do we return the car?",
      "uk": "Ви хочете позичити авто в друга / подруги на завтра.<br><br>Сплануйте разом зі своїм співрозмовником або співрозмовницею, як ви це зробите.<br><br>Ці пункти допоможуть вам:<br>Як ми ввічливо запитаємо?<br>На що нам варто зважати?<br>Коли повернемо авто?",
      "ru": "Вы хотите одолжить машину у друга / подруги на завтра.<br><br>Спланируйте вместе со своим собеседником или собеседницей, как вы это сделаете.<br><br>Эти пункты помогут вам:<br>Как мы вежливо спросим?<br>На что нам стоит обратить внимание?<br>Когда вернём машину?"
    },
    "name_q": "de_w_nina",
    "name_a": "de_m_david",
    "q": {
      "de": "Hallo David! Ich muss dich um einen Gefallen bitten. Kannst du mir kurz zuhören?",
      "en": "Hi David! I need to ask you for a favour. Can you listen to me for a moment?",
      "uk": "Привіт, Девіде! Мені треба попросити тебе про послугу. Можеш мене трохи послухати?",
      "ru": "Привет, Дэвид! Мне нужно попросить тебя об услуге. Можешь меня немного послушать?"
    },
    "a": {
      "de": "<r>Klingt super, machen wir so.</r><br><r>Wir könnten doch</r> gleich jetzt darüber sprechen.<br><r>Was denkst du?</r>",
      "en": "<r>Sounds great, let's do that.</r><br><r>We could</r> talk about it right now.<br><r>What do you think?</r>",
      "uk": "<r>Звучить чудово, зробімо так.</r><br><r>Ми могли б</r> поговорити про це прямо зараз.<br><r>Що ти думаєш?</r>",
      "ru": "<r>Звучит отлично, так и сделаем.</r><br><r>Мы могли бы</r> поговорить об этом прямо сейчас.<br><r>Что ты думаешь?</r>"
    },
    "q1": {
      "de": "<r>Das klingt gut, aber</r> ich wollte erst höflich fragen: <g>Könntest</g> du mir dein Auto für morgen ausleihen?<br><r>Ich hätte einen Vorschlag:</r> Ich bringe es dir am Abend mit vollem Tank zurück.<br><r>Wie findest du das?</r>",
      "en": "<r>That sounds good, but</r> I wanted to ask politely first: <g>Could</g> you lend me your car for tomorrow?<br><r>I have a suggestion:</r> I'll bring it back to you in the evening with a full tank.<br><r>How do you like that?</r>",
      "uk": "<r>Це звучить непогано, але</r> я спершу хотіла ввічливо запитати: чи не міг би ти позичити мені свою машину на завтра?<br><r>У мене є пропозиція:</r> я поверну її тобі ввечері з повним баком.<br><r>Як тобі така ідея?</r>",
      "ru": "<r>Это звучит неплохо, но</r> я сначала хотела вежливо спросить: не мог бы ты одолжить мне свою машину на завтра?<br><r>У меня есть предложение:</r> я верну её тебе вечером с полным баком.<br><r>Как тебе такая идея?</r>"
    },
    "a1": {
      "de": "<r>Einverstanden, das passt gut.</r><br><r>Mein Vorschlag wäre, dass</r> du vorsichtig fährst, du <g>solltest</g> bei Regen besonders aufpassen.<br><r>Bist du damit einverstanden?</r>",
      "en": "<r>Agreed, that works well.</r><br><r>My suggestion would be that</r> you drive carefully, you <g>should</g> be especially careful in the rain.<br><r>Are you okay with that?</r>",
      "uk": "<r>Домовились, це підходить.</r><br><r>Моя пропозиція —</r> їдь обережно, тобі варто бути особливо уважною під час дощу.<br><r>Ти згодна з цим?</r>",
      "ru": "<r>Договорились, это подходит.</r><br><r>Моё предложение —</r> езжай осторожно, тебе стоит быть особенно внимательной в дождь.<br><r>Ты согласна с этим?</r>"
    },
    "q2": {
      "de": "<r>Perfekt, so machen wir es.</r><br><r>Wir könnten es doch so machen:</r> Ich hole die Schlüssel morgen früh bei dir ab.<br><r>Passt dir das so?</r>",
      "en": "<r>Perfect, that's how we'll do it.</r><br><r>We could do it like this:</r> I pick up the keys from you tomorrow morning.<br><r>Does that work for you?</r>",
      "uk": "<r>Чудово, так і зробимо.</r><br><r>Можна зробити так:</r> я заберу ключі в тебе завтра вранці.<br><r>Тобі так підходить?</r>",
  ...
  {
    "id": "dlg_071",
    "cat": "Ein Teambuilding-Event planen",
    "type": "Gemeinsam etwas planen",
    "task": {
      "de": "Im Team gab es zuletzt einige Missverständnisse. Sie möchten mit einem Kollegen / einer Kollegin ein Teambuilding-Event planen.<br><br>Planen Sie zusammen mit Ihrer Gesprächspartnerin oder Ihrem Gesprächspartner, wie Sie das machen möchten.<br><br>Diese Punkte helfen Ihnen:<br>Was machen wir?<br>Worüber sprechen wir?<br>Wann findet es statt?",
      "en": "There have been some misunderstandings in the team recently. You would like to plan a team-building event with a colleague.<br><br>Plan together with your conversation partner how you would like to do this.<br><br>These points will help you:<br>What do we do?<br>What do we talk about?<br>When does it take place?",
      "uk": "Останнім часом у команді сталося кілька непорозумінь. Ви хочете спланувати тімбілдинг-захід з колегою.<br><br>Сплануйте разом зі своїм співрозмовником або співрозмовницею, як ви це зробите.<br><br>Ці пункти допоможуть вам:<br>Що ми робимо?<br>Про що ми говоримо?<br>Коли це відбувається?",
      "ru": "В последнее время в команде было несколько недоразумений. Вы хотите спланировать тимбилдинг-мероприятие с коллегой.<br><br>Спланируйте вместе со своим собеседником или собеседницей, как вы это сделаете.<br><br>Эти пункты помогут вам:<br>Что мы делаем?<br>О чём мы говорим?<br>Когда это состоится?"
    },
    "name_q": "de_m_alex",
    "name_a": "de_w_anna",
    "q": {
      "de": "Hallo Anna! Im Team gab es zuletzt einige Missverständnisse. Sollen wir ein Teambuilding-Event planen?",
      "en": "Hi Anna! There have been some misunderstandings in the team recently. Shall we plan a team-building event?",
      "uk": "Привіт, Анно! Останнім часом у команді сталося кілька непорозумінь. Спланюємо тімбілдинг-захід?",
      "ru": "Привет, Анна! В последнее время в команде было несколько недоразумений. Спланируем тимбилдинг-мероприятие?"
    },
    "a": {
      "de": "<r>Klingt super, machen wir so.</r><br><r>Wir könnten doch</r> ein gemeinsames Kochevent organisieren.<br><r>Was denkst du?</r>",
      "en": "<r>Sounds great, let's do that.</r><br><r>We could</r> organise a joint cooking event.<br><r>What do you think?</r>",
      "uk": "<r>Звучить чудово, зробімо так.</r><br><r>Ми могли б</r> організувати спільний кулінарний захід.<br><r>Що ти думаєш?</r>",
      "ru": "<r>Звучит отлично, так и сделаем.</r><br><r>Мы могли бы</r> организовать совместное кулинарное мероприятие.<br><r>Что ты думаешь?</r>"
    },
    "q1": {
      "de": "<r>Das klingt gut, aber</r> wir sollten auch über Toleranz und Kritik sprechen.<br><r>Ich hätte einen Vorschlag:</r> Wir machen zuerst eine kurze Übung dazu.<br><r>Wie findest du das?</r>",
      "en": "<r>That sounds good, but</r> we should also talk about tolerance and criticism.<br><r>I have a suggestion:</r> we do a short exercise about it first.<br><r>How do you like that?</r>",
      "uk": "<r>Це звучить непогано, але</r> нам варто ще поговорити про толерантність і критику.<br><r>У мене є пропозиція:</r> спочатку зробимо коротку вправу на цю тему.<br><r>Як тобі така ідея?</r>",
      "ru": "<r>Это звучит неплохо, но</r> нам стоит ещё поговорить о толерантности и критике.<br><r>У меня есть предложение:</r> сначала сделаем короткое упражнение на эту тему.<br><r>Как тебе такая идея?</r>"
    },
    "a1": {
      "de": "<r>Einverstanden, das passt gut.</r><br><r>Mein Vorschlag wäre, dass</r> wir uns gegenseitig zeigen, wie hilfsbereit und teamfähig wir sind.<br><r>Bist du damit einverstanden?</r>",
      "en": "<r>Agreed, that works well.</r><br><r>My suggestion would be that</r> we show each other how helpful and team-oriented we are.<br><r>Are you okay with that?</r>",
      "uk": "<r>Домовились, це підходить.</r><br><r>Моя пропозиція —</r> показати одне одному, які ми чуйні й здатні до командної роботи.<br><r>Ти згодна з цим?</r>",
      "ru": "<r>Договорились, это подходит.</r><br><r>Моё предложение —</r> показать друг другу, какие мы отзывчивые и способные к командной работе.<br><r>Ты согласна с этим?</r>"
    },
    "q2": {
      "de": "<r>Perfekt, so machen wir es.</r><br><r>Wir könnten es doch so machen:</r> Wir planen das Event für nächsten Freitagnachmittag.<br><r>Passt dir das so?</r>",
      "en": "<r>Perfect, that's how we'll do it.</r><br><r>We could do it like this:</r> we plan the event for next Friday afternoon.<br><r>Does that work for you?</r>",
      "uk": "<r>Чудово, так і зробимо.</r><br><r>Можна зробити так:</r> заплануємо захід на наступну п'ятницю після обіду.<br><r>Тобі так підходить?</r>",
